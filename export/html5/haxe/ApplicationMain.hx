...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("zombie-killer", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("zombie-killer", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "zombie-killer";
		app.meta["name"] = "zombie-killer";
