...
HX_DECLARE_STACK_FRAME(_hx_pos_e7a48f0077bf9f0a_35_new)
...
class HXCPP_CLASS_ATTRIBUTES GenericCell_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< GenericCell_obj > __new( ::Dynamic elt, ::haxe::ds::GenericCell next) {
			hx::ObjectPtr< GenericCell_obj > __this = new GenericCell_obj();
			__this->__construct(elt,next);
			return __this;
		}

		static hx::ObjectPtr< GenericCell_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic elt, ::haxe::ds::GenericCell next) {
...
{
            	HX_STACKFRAME(&_hx_pos_e7a48f0077bf9f0a_35_new)
HXDLIN(  35)		( ( ::haxe::ds::GenericCell)(__this) )->elt = elt;
HXDLIN(  35)		( ( ::haxe::ds::GenericCell)(__this) )->next = next;
            	}
