...
HX_DECLARE_STACK_FRAME(_hx_pos_a547912459d988d9_236_new)
			...
			*(void **)__this = TreeNode_obj::_hx_vtable;
{
            	...
            	HX_STACKFRAME(&_hx_pos_a547912459d988d9_236_new)
HXLINE( 237)		( ( ::haxe::ds::TreeNode)(__this) )->left = l;
HXLINE( 238)		( ( ::haxe::ds::TreeNode)(__this) )->key = k;
HXLINE( 239)		( ( ::haxe::ds::TreeNode)(__this) )->value = v;
HXLINE( 240)		( ( ::haxe::ds::TreeNode)(__this) )->right = r;
HXLINE( 241)		if ((h == -1)) {
HXLINE( 242)			int _hx_tmp;
HXDLIN( 242)			 ::haxe::ds::TreeNode _this = ( ( ::haxe::ds::TreeNode)(__this) )->left;
HXDLIN( 242)			int _hx_tmp1;
HXDLIN( 242)			if (hx::IsNull( _this )) {
HXLINE( 242)				_hx_tmp1 = 0;
            			}
            			else {
HXLINE( 242)				_hx_tmp1 = _this->_height;
            			}
HXDLIN( 242)			 ::haxe::ds::TreeNode _this1 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
HXDLIN( 242)			int _hx_tmp2;
HXDLIN( 242)			if (hx::IsNull( _this1 )) {
HXLINE( 242)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE( 242)				_hx_tmp2 = _this1->_height;
            			}
HXDLIN( 242)			if ((_hx_tmp1 > _hx_tmp2)) {
HXLINE( 242)				 ::haxe::ds::TreeNode _this2 = ( ( ::haxe::ds::TreeNode)(__this) )->left;
HXDLIN( 242)				if (hx::IsNull( _this2 )) {
HXLINE( 242)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 242)					_hx_tmp = _this2->_height;
            				}
            			}
            			else {
HXLINE( 242)				 ::haxe::ds::TreeNode _this3 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
HXDLIN( 242)				if (hx::IsNull( _this3 )) {
HXLINE( 242)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 242)					_hx_tmp = _this3->_height;
            				}
            			}
HXDLIN( 242)			( ( ::haxe::ds::TreeNode)(__this) )->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 244)			( ( ::haxe::ds::TreeNode)(__this) )->_height = h;
            		}
            	}
