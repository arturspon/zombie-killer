...
HXLINE( 224)		return this->attributeMap->get_string(att);
            	}
...
HXDLIN(  88)		ProcessingInstruction = 5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_61da4a8008b80acb_92_boot)
HXDLIN(  92)		Document = 6;
            	}
}
