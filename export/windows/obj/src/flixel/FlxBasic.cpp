...
HXLINE( 128)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this)->init(1,_this1)->init(2,_this2)->init(3,_this3));
            	}
...
HXDLIN( 162)			_hx_tmp = (this->_cameras->length == 0);
            		}
            		else {
HXDLIN( 162)			_hx_tmp = true;
            		}
HXDLIN( 162)		if (_hx_tmp) {
HXDLIN( 162)			return ::flixel::FlxCamera_obj::defaultCameras->__get(0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXDLIN( 162)			return this->_cameras->__get(0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HXLINE( 171)			this->_cameras[0] = Value;
            		}
