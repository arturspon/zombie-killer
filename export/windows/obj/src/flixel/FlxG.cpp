...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_455_addChildBelowMouse,"flixel.FlxG","addChildBelowMouse",0x6d0fae56,"flixel.FlxG.addChildBelowMouse","flixel/FlxG.hx",455,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_471_removeChild,"flixel.FlxG","removeChild",0x8b26d2d1,"flixel.FlxG.removeChild","flixel/FlxG.hx",471,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_500_addPostProcess,"flixel.FlxG","addPostProcess",0x527e22d5,"flixel.FlxG.addPostProcess","flixel/FlxG.hx",500,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_504_removePostProcess,"flixel.FlxG","removePostProcess",0x4ea610e4,"flixel.FlxG.removePostProcess","flixel/FlxG.hx",504,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_541_openURL,"flixel.FlxG","openURL",0xce3ec95e,"flixel.FlxG.openURL","flixel/FlxG.hx",541,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_554_init,"flixel.FlxG","init",0x1141e5d7,"flixel.FlxG.init","flixel/FlxG.hx",554,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_602_initRenderMethod,"flixel.FlxG","initRenderMethod",0x7472134e,"flixel.FlxG.initRenderMethod","flixel/FlxG.hx",602,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_650_reset,"flixel.FlxG","reset",0x31170d28,"flixel.FlxG.reset","flixel/FlxG.hx",650,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_668_set_scaleMode,"flixel.FlxG","set_scaleMode",0xb374d549,"flixel.FlxG.set_scaleMode","flixel/FlxG.hx",668,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_676_set_mouse,"flixel.FlxG","set_mouse",0x1e754261,"flixel.FlxG.set_mouse","flixel/FlxG.hx",676,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_695_set_updateFramerate,"flixel.FlxG","set_updateFramerate",0x52770580,"flixel.FlxG.set_updateFramerate","flixel/FlxG.hx",695,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_712_set_drawFramerate,"flixel.FlxG","set_drawFramerate",0x3e23c125,"flixel.FlxG.set_drawFramerate","flixel/FlxG.hx",712,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_732_get_fullscreen,"flixel.FlxG","get_fullscreen",0xfece4c0b,"flixel.FlxG.get_fullscreen","flixel/FlxG.hx",732,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_737_set_fullscreen,"flixel.FlxG","set_fullscreen",0x1eee347f,"flixel.FlxG.set_fullscreen","flixel/FlxG.hx",737,0x8e176836)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_749_get_state,"flixel.FlxG","get_state",0xb2cab641,"flixel.FlxG.get_state","flixel/FlxG.hx",749,0x8e176836)
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_754_get_onMobile,"flixel.FlxG","get_onMobile",0x5f27a0b1,"flixel.FlxG.get_onMobile","flixel/FlxG.hx",754,0x8e176836)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxG_obj,collide,return )
 ...
 ::Dynamic FlxG_obj::addChildBelowMouse( ::Dynamic Child,hx::Null< int >  __o_IndexModifier){
            	...
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_455_addChildBelowMouse)
HXLINE( 456)		int index = ::flixel::FlxG_obj::game->getChildIndex(::flixel::FlxG_obj::game->_inputContainer);
HXLINE( 457)		int max = ::flixel::FlxG_obj::game->get_numChildren();
HXLINE( 459)		index = ::flixel::math::FlxMath_obj::maxAdd(index,IndexModifier,max,null());
HXLINE( 460)		::flixel::FlxG_obj::game->addChildAt(( ( ::openfl::display::DisplayObject)(Child) ),index);
HXLINE( 461)		return Child;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxG_obj,addChildBelowMouse,return )
 ...
 ::Dynamic FlxG_obj::removeChild( ::Dynamic Child){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_471_removeChild)
HXLINE( 472)		if (::flixel::FlxG_obj::game->contains(( ( ::openfl::display::DisplayObject)(Child) ))) {
HXLINE( 473)			::flixel::FlxG_obj::game->removeChild(( ( ::openfl::display::DisplayObject)(Child) ));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,removeChild,return )
 ...
 ::flixel::effects::postprocess::PostProcess FlxG_obj::addPostProcess( ::flixel::effects::postprocess::PostProcess postProcess){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_500_addPostProcess)
HXDLIN( 500)		return postProcess;
            	}
...
void FlxG_obj::removePostProcess( ::flixel::effects::postprocess::PostProcess postProcess){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_504_removePostProcess)
            	}
...
void FlxG_obj::openURL(::String URL,::String __o_Target){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_541_openURL)
HXLINE( 542)		::String prefix = HX_("",00,00,00,00);
HXLINE( 544)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(URL))) {
HXLINE( 545)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXLINE( 546)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + URL)),Target);
            	}
...
void FlxG_obj::init( ::flixel::FlxGame Game,int Width,int Height,Float Zoom){
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_554_init)
HXLINE( 555)		::flixel::FlxG_obj::game = Game;
HXLINE( 556)		::flixel::FlxG_obj::width = ::Std_obj::_hx_int(::Math_obj::abs(( (Float)(Width) )));
HXLINE( 557)		::flixel::FlxG_obj::height = ::Std_obj::_hx_int(::Math_obj::abs(( (Float)(Height) )));
HXLINE( 559)		::flixel::FlxG_obj::initRenderMethod();
HXLINE( 561)		::flixel::FlxG_obj::initialWidth = ::flixel::FlxG_obj::width;
HXLINE( 562)		::flixel::FlxG_obj::initialHeight = ::flixel::FlxG_obj::height;
HXLINE( 563)		::flixel::FlxG_obj::initialZoom = (::flixel::FlxCamera_obj::defaultZoom = Zoom);
HXLINE( 565)		{
HXLINE( 565)			int Width1 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 565)			int Height1 = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXDLIN( 565)			::flixel::FlxG_obj::scaleMode->onMeasure(Width1,Height1);
            		}
HXLINE( 569)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp = ::flixel::FlxG_obj::inputs;
HXDLIN( 569)		::flixel::FlxG_obj::keys = _hx_tmp->add_flixel_input_keyboard_FlxKeyboard( ::flixel::input::keyboard::FlxKeyboard_obj::__alloc( HX_CTX ));
HXLINE( 573)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::inputs;
HXDLIN( 573)		::flixel::FlxG_obj::set_mouse(_hx_tmp1->add_flixel_input_mouse_FlxMouse( ::flixel::input::mouse::FlxMouse_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::game->_inputContainer)));
HXLINE( 581)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 581)		::flixel::FlxG_obj::gamepads = _hx_tmp2->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
HXLINE( 591)		::flixel::FlxG_obj::save->bind(HX_("flixel",5c,42,70,3d),null());
HXLINE( 593)		::flixel::FlxG_obj::plugins =  ::flixel::_hx_system::frontEnds::PluginFrontEnd_obj::__alloc( HX_CTX );
HXLINE( 594)		::flixel::FlxG_obj::vcr =  ::flixel::_hx_system::frontEnds::VCRFrontEnd_obj::__alloc( HX_CTX );
HXLINE( 597)		::flixel::FlxG_obj::sound =  ::flixel::_hx_system::frontEnds::SoundFrontEnd_obj::__alloc( HX_CTX );
            	}
...
void FlxG_obj::initRenderMethod(){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_602_initRenderMethod)
HXLINE( 603)		::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
HXLINE( 607)		 ::flixel::FlxRenderMethod _hx_tmp;
HXDLIN( 607)		::String _hx_switch_0 = ::openfl::Lib_obj::get_current()->stage->window->context->type;
            		if (  (_hx_switch_0==HX_("opengl",6f,64,94,21)) ||  (_hx_switch_0==HX_("opengles",9d,f6,c9,fa)) ||  (_hx_switch_0==HX_("webgl",b9,4b,bc,c7)) ){
HXLINE( 607)			_hx_tmp = ::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn();
HXDLIN( 607)			goto _hx_goto_14;
            		}
            		/* default */{
HXLINE( 607)			_hx_tmp = ::flixel::FlxRenderMethod_obj::BLITTING_dyn();
            		}
            		_hx_goto_14:;
HXDLIN( 607)		::flixel::FlxG_obj::renderMethod = _hx_tmp;
HXLINE( 639)		::flixel::FlxG_obj::renderBlit = hx::IsEq( ::flixel::FlxG_obj::renderMethod,::flixel::FlxRenderMethod_obj::BLITTING_dyn() );
HXLINE( 640)		::flixel::FlxG_obj::renderTile = hx::IsEq( ::flixel::FlxG_obj::renderMethod,::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn() );
HXLINE( 642)		::flixel::FlxObject_obj::defaultPixelPerfectPosition = ::flixel::FlxG_obj::renderBlit;
            	}
...
void FlxG_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_650_reset)
HXLINE( 651)		{
HXLINE( 651)			 ::flixel::math::FlxRandom _this = ::flixel::FlxG_obj::random;
HXDLIN( 651)			{
HXLINE( 651)				int Value = ::Std_obj::_hx_int((::Math_obj::random() * ( (Float)((int)2147483647) )));
HXDLIN( 651)				Float lowerBound;
HXDLIN( 651)				if ((Value < 1)) {
HXLINE( 651)					lowerBound = ( (Float)(1) );
            				}
            				else {
HXLINE( 651)					lowerBound = ( (Float)(Value) );
            				}
HXDLIN( 651)				Float NewSeed;
HXDLIN( 651)				if ((lowerBound > (int)2147483646)) {
HXLINE( 651)					NewSeed = ( (Float)((int)2147483646) );
            				}
            				else {
HXLINE( 651)					NewSeed = lowerBound;
            				}
HXDLIN( 651)				int NewSeed1 = ::Std_obj::_hx_int(NewSeed);
HXDLIN( 651)				Float lowerBound1;
HXDLIN( 651)				if ((NewSeed1 < 1)) {
HXLINE( 651)					lowerBound1 = ( (Float)(1) );
            				}
            				else {
HXLINE( 651)					lowerBound1 = ( (Float)(NewSeed1) );
            				}
HXDLIN( 651)				Float NewSeed2;
HXDLIN( 651)				if ((lowerBound1 > (int)2147483646)) {
HXLINE( 651)					NewSeed2 = ( (Float)((int)2147483646) );
            				}
            				else {
HXLINE( 651)					NewSeed2 = lowerBound1;
            				}
HXDLIN( 651)				int NewSeed3 = ::Std_obj::_hx_int(NewSeed2);
HXDLIN( 651)				Float lowerBound2;
HXDLIN( 651)				if ((NewSeed3 < 1)) {
HXLINE( 651)					lowerBound2 = ( (Float)(1) );
            				}
            				else {
HXLINE( 651)					lowerBound2 = ( (Float)(NewSeed3) );
            				}
HXDLIN( 651)				Float _hx_tmp;
HXDLIN( 651)				if ((lowerBound2 > (int)2147483646)) {
HXLINE( 651)					_hx_tmp = ( (Float)((int)2147483646) );
            				}
            				else {
HXLINE( 651)					_hx_tmp = lowerBound2;
            				}
HXDLIN( 651)				_this->initialSeed = ::Std_obj::_hx_int((_this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) )));
            			}
            		}
HXLINE( 653)		::flixel::FlxG_obj::bitmap->reset();
HXLINE( 654)		::flixel::FlxG_obj::inputs->reset();
HXLINE( 656)		::flixel::FlxG_obj::sound->destroy(true);
HXLINE( 658)		::flixel::FlxG_obj::autoPause = true;
HXLINE( 659)		::flixel::FlxG_obj::fixedTimestep = true;
HXLINE( 660)		::flixel::FlxG_obj::timeScale = ((Float)1.0);
HXLINE( 661)		::flixel::FlxG_obj::elapsed = ( (Float)(0) );
HXLINE( 662)		::flixel::FlxG_obj::maxElapsed = ((Float)0.1);
HXLINE( 663)		{
HXLINE( 663)			 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 663)			_this1->x = ( (Float)(-10) );
HXDLIN( 663)			_this1->y = ( (Float)(-10) );
HXDLIN( 663)			_this1->width = ( (Float)((::flixel::FlxG_obj::width + 20)) );
HXDLIN( 663)			_this1->height = ( (Float)((::flixel::FlxG_obj::height + 20)) );
            		}
HXLINE( 664)		::flixel::FlxG_obj::worldDivisions = 6;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxG_obj,reset,(void))
 ...
 ::flixel::_hx_system::scaleModes::BaseScaleMode FlxG_obj::set_scaleMode( ::flixel::_hx_system::scaleModes::BaseScaleMode ScaleMode){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_668_set_scaleMode)
HXLINE( 669)		::flixel::FlxG_obj::scaleMode = ScaleMode;
HXLINE( 670)		::flixel::FlxG_obj::game->onResize(null());
HXLINE( 671)		return ScaleMode;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,set_scaleMode,return )
 ...
 ::flixel::input::mouse::FlxMouse FlxG_obj::set_mouse( ::flixel::input::mouse::FlxMouse NewMouse){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_676_set_mouse)
HXLINE( 677)		if (hx::IsNull( ::flixel::FlxG_obj::mouse )) {
HXLINE( 679)			::flixel::FlxG_obj::mouse = ::flixel::FlxG_obj::inputs->add_flixel_input_mouse_FlxMouse(NewMouse);
HXLINE( 680)			return ::flixel::FlxG_obj::mouse;
            		}
HXLINE( 682)		 ::flixel::input::mouse::FlxMouse oldMouse = ::flixel::FlxG_obj::mouse;
HXLINE( 683)		 ::flixel::input::mouse::FlxMouse result = ::flixel::FlxG_obj::inputs->replace_flixel_input_mouse_FlxMouse(oldMouse,NewMouse);
HXLINE( 684)		if (hx::IsNotNull( result )) {
HXLINE( 686)			::flixel::FlxG_obj::mouse = result;
HXLINE( 687)			oldMouse->destroy();
HXLINE( 688)			return NewMouse;
            		}
HXLINE( 690)		return oldMouse;
            	}
...
int FlxG_obj::set_updateFramerate(int Framerate){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_695_set_updateFramerate)
HXLINE( 696)		if ((Framerate < ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 697)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.framerate: the game's framerate shouldn't be smaller than the flash framerate,",78,cb,ed,38) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
HXLINE( 700)		::flixel::FlxG_obj::updateFramerate = Framerate;
HXLINE( 702)		::flixel::FlxG_obj::game->_stepMS = ::Math_obj::abs((( (Float)(1000) ) / ( (Float)(Framerate) )));
HXLINE( 703)		::flixel::FlxG_obj::game->_stepSeconds = (::flixel::FlxG_obj::game->_stepMS / ( (Float)(1000) ));
HXLINE( 705)		if ((::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS)) {
HXLINE( 706)			::flixel::FlxG_obj::game->_maxAccumulation = ::flixel::FlxG_obj::game->_stepMS;
            		}
HXLINE( 708)		return Framerate;
            	}
...
int FlxG_obj::set_drawFramerate(int Framerate){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_712_set_drawFramerate)
HXLINE( 713)		if ((Framerate > ::flixel::FlxG_obj::updateFramerate)) {
HXLINE( 714)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.drawFramerate: the update framerate shouldn't be smaller than the draw framerate,",b9,9c,3b,de) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
HXLINE( 717)		::flixel::FlxG_obj::drawFramerate = ::Std_obj::_hx_int(::Math_obj::abs(( (Float)(Framerate) )));
HXLINE( 719)		if (hx::IsNotNull( ::flixel::FlxG_obj::game->stage )) {
HXLINE( 720)			::flixel::FlxG_obj::game->stage->set_frameRate(( (Float)(::flixel::FlxG_obj::drawFramerate) ));
            		}
HXLINE( 722)		::flixel::FlxG_obj::game->_maxAccumulation = ((( (Float)(2000) ) / ( (Float)(::flixel::FlxG_obj::drawFramerate) )) - ( (Float)(1) ));
HXLINE( 724)		if ((::flixel::FlxG_obj::game->_maxAccumulation < ::flixel::FlxG_obj::game->_stepMS)) {
HXLINE( 725)			::flixel::FlxG_obj::game->_maxAccumulation = ::flixel::FlxG_obj::game->_stepMS;
            		}
HXLINE( 727)		return Framerate;
            	}
...
bool FlxG_obj::get_fullscreen(){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_732_get_fullscreen)
HXDLIN( 732)		if (hx::IsNotEq( ::openfl::Lib_obj::get_current()->stage->get_displayState(),0 )) {
HXLINE( 733)			return hx::IsEq( ::openfl::Lib_obj::get_current()->stage->get_displayState(),1 );
            		}
            		else {
HXDLIN( 732)			return true;
            		}
HXDLIN( 732)		return false;
            	}
...
bool FlxG_obj::set_fullscreen(bool Value){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_737_set_fullscreen)
HXLINE( 738)		 ::Dynamic _hx_tmp;
HXDLIN( 738)		if (Value) {
HXLINE( 738)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 738)			_hx_tmp = 2;
            		}
HXDLIN( 738)		::openfl::Lib_obj::get_current()->stage->set_displayState(_hx_tmp);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxG_obj,get_stage,return )
 ...
 ::flixel::FlxState FlxG_obj::get_state(){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_749_get_state)
HXDLIN( 749)		return ::flixel::FlxG_obj::game->_state;
            	}
...
bool FlxG_obj::get_onMobile(){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_754_get_onMobile)
...
HXDLIN(  86)		worldDivisions = 6;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_97_boot)
HXDLIN(  97)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,4,6,1);
            	}
{
...
HXDLIN( 175)			_this->x = ( (Float)(0) );
HXDLIN( 175)			_this->y = ( (Float)(0) );
HXDLIN( 175)			_this->width = ( (Float)(0) );
HXDLIN( 175)			_this->height = ( (Float)(0) );
...
HXDLIN( 175)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_175_boot)
HXDLIN( 175)		worldBounds = ( ( ::flixel::math::FlxRect)( ::Dynamic(new _hx_Closure_0())()) );
            	}
{
...
HXDLIN( 291)		initialWidth = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_292_boot)
HXDLIN( 292)		initialHeight = 0;
            	}
{
