...
HXLINE(  84)		this->ticks = 0;
HXLINE(  52)		this->focusLostFramerate = 10;
...
HXLINE( 310)		this->stage->set_scaleMode(2);
HXLINE( 311)		this->stage->align = 6;
HXLINE( 312)		this->stage->set_frameRate(( (Float)(::flixel::FlxG_obj::drawFramerate) ));
HXLINE( 314)		this->addChild(this->_inputContainer);
HXLINE( 323)		int _hx_tmp1 = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXDLIN( 323)		this->debugger =  ::flixel::_hx_system::debug::FlxDebugger_obj::__alloc( HX_CTX ,( (Float)(_hx_tmp1) ),( (Float)(::openfl::Lib_obj::get_current()->stage->stageHeight) ));
...
HXLINE( 408)		this->stage->set_frameRate(( (Float)(::flixel::FlxG_obj::drawFramerate) ));
...
HXLINE( 443)		this->stage->set_frameRate(( (Float)(this->focusLostFramerate) ));
...
HXLINE( 474)		this->debugger->onResize(( (Float)(width) ),( (Float)(height) ));
...
HXLINE( 499)		this->_elapsedMS = ( (Float)((this->ticks - this->_total)) );
...
HXLINE( 548)			::flixel::FlxBasic_obj::visibleCount = 0;
...
HXLINE( 636)		this->debugger->console->registerObject(HX_("state",11,76,0b,84),this->_state);
...
HXDLIN( 659)				if (::Std_obj::is(this->_requestedState,hx::ClassOf< ::flixel::FlxSubState >())) {
HXLINE( 659)					HX_STACK_DO_THROW(HX_("You can't set FlxSubState class instance as the state for you game",f2,8e,2c,80));
            				}
...
HXLINE( 667)		::flixel::FlxBasic_obj::activeCount = 0;
HXLINE( 670)		this->update();
HXLINE( 673)		this->debugger->stats->activeObjects(::flixel::FlxBasic_obj::activeCount);
            	}
...
HXLINE( 720)		if (::flixel::FlxG_obj::debugger->visible) {
HXLINE( 721)			int _hx_tmp1 = ( (int)(this->getTimer()) );
HXDLIN( 721)			this->ticks = (_hx_tmp1 - this->_startTime);
            		}
...
HXLINE( 738)						_hx_tmp2 = plugin->active;
            					}
            					else {
...
HXDLIN( 742)					bool _hx_tmp4;
HXDLIN( 742)					if (hx::IsNotNull( camera )) {
HXLINE( 742)						_hx_tmp4 = camera->exists;
            					}
            					else {
HXLINE( 742)						_hx_tmp4 = false;
            					}
HXDLIN( 742)					if (_hx_tmp4) {
HXLINE( 742)						_hx_tmp3 = camera->active;
            					}
            					else {
...
HXLINE( 746)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = this->debugger->stats;
HXDLIN( 746)		int _hx_tmp6 = ( (int)(this->getTimer()) );
HXDLIN( 746)		_hx_tmp5->flixelUpdate(((_hx_tmp6 - this->_startTime) - this->ticks));
HXLINE( 750)		::flixel::util::FlxArrayUtil_obj::clearArray(::flixel::FlxG_obj::swipes,null());
HXLINE( 753)		::Array< ::Dynamic> _hx_tmp7;
HXDLIN( 753)		if (this->filtersEnabled) {
HXLINE( 753)			_hx_tmp7 = this->_filters;
            		}
            		else {
HXLINE( 753)			_hx_tmp7 = null();
            		}
HXDLIN( 753)		this->set_filters(_hx_tmp7);
            	}
...
HXLINE( 764)			::flixel::FlxG_obj::elapsed = (::flixel::FlxG_obj::timeScale * (this->_elapsedMS / ( (Float)(1000) )));
...
HXLINE( 841)		if (::flixel::FlxG_obj::debugger->visible) {
HXLINE( 842)			int _hx_tmp1 = ( (int)(this->getTimer()) );
HXDLIN( 842)			this->ticks = (_hx_tmp1 - this->_startTime);
            		}
HXLINE( 845)		::flixel::FlxG_obj::signals->preDraw->dispatch();
HXLINE( 847)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 848)			::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls = 0;
            		}
HXLINE( 855)		{
...
HXLINE( 855)						_hx_tmp3 = !(camera->exists);
            					}
            					else {
HXLINE( 855)						_hx_tmp3 = true;
            					}
HXDLIN( 855)					if (!(_hx_tmp3)) {
HXLINE( 855)						_hx_tmp2 = !(camera->visible);
            					}
            					else {
...
HXDLIN( 855)						camera->debugLayer->get_graphics()->clear();
            					}
HXDLIN( 855)					if (::flixel::FlxG_obj::renderBlit) {
...
HXLINE( 855)						camera->fill((camera->bgColor & 16777215),camera->useBgAlphaBlending,(( (Float)(((camera->bgColor >> 24) & 255)) ) / ( (Float)(255) )),null());
            					}
            				}
            			}
            		}
HXLINE( 857)		{
HXLINE( 857)			int _g2 = 0;
...
HXDLIN( 857)				_g2 = (_g2 + 1);
HXDLIN( 857)				bool _hx_tmp4;
HXDLIN( 857)				if (plugin->exists) {
HXLINE( 857)					_hx_tmp4 = plugin->visible;
            				}
            				else {
HXLINE( 857)					_hx_tmp4 = false;
            				}
...
HXDLIN( 863)					_g3 = (_g3 + 1);
HXDLIN( 863)					bool _hx_tmp5;
HXDLIN( 863)					bool _hx_tmp6;
HXDLIN( 863)					if (hx::IsNotNull( camera1 )) {
HXLINE( 863)						_hx_tmp6 = camera1->exists;
            					}
            					else {
HXLINE( 863)						_hx_tmp6 = false;
            					}
HXDLIN( 863)					if (_hx_tmp6) {
HXLINE( 863)						_hx_tmp5 = camera1->visible;
            					}
            					else {
...
HXLINE( 866)			this->debugger->stats->drawCalls(::flixel::graphics::tile::FlxDrawBaseItem_obj::drawCalls);
            		}
HXLINE( 870)		{
...
HXDLIN( 870)					bool _hx_tmp8;
HXDLIN( 870)					if (hx::IsNotNull( camera2 )) {
HXLINE( 870)						_hx_tmp8 = !(camera2->exists);
            					}
            					else {
HXLINE( 870)						_hx_tmp8 = true;
            					}
HXDLIN( 870)					if (!(_hx_tmp8)) {
HXLINE( 870)						_hx_tmp7 = !(camera2->visible);
            					}
            					else {
...
HXLINE( 875)		 ::flixel::_hx_system::debug::stats::Stats _hx_tmp9 = this->debugger->stats;
HXDLIN( 875)		int _hx_tmp10 = ( (int)(this->getTimer()) );
HXDLIN( 875)		_hx_tmp9->flixelDraw(((_hx_tmp10 - this->_startTime) - this->ticks));
            	}
