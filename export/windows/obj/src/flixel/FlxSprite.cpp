...
HXLINE( 184)		this->_facingVerticalMult = 1;
HXLINE( 182)		this->_facingHorizontalMult = 1;
HXLINE( 151)		this->useColorTransform = false;
HXLINE( 144)		this->color = 16777215;
HXLINE( 117)		this->flipY = false;
HXLINE( 113)		this->flipX = false;
HXLINE( 109)		this->facing = 16;
HXLINE( 104)		this->alpha = ((Float)1.0);
HXLINE( 100)		this->bakedRotationAngle = ((Float)0);
HXLINE(  90)		this->numFrames = 0;
HXLINE(  85)		this->frameHeight = 0;
HXLINE(  81)		this->frameWidth = 0;
...
HXLINE( 263)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 263)		point->_inPool = false;
HXDLIN( 263)		this->offset = point;
HXLINE( 264)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 264)		point1->_inPool = false;
HXDLIN( 264)		this->origin = point1;
HXLINE( 265)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(1,1);
HXDLIN( 265)		point2->_inPool = false;
HXDLIN( 265)		this->scale = point2;
HXLINE( 266)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 326)		if ((this->bakedRotationAngle > 0)) {
...
HXLINE( 421)			brush =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,brushSize,brushSize,true,0);
HXLINE( 422)			this->_flashRect->setTo(( (Float)((Frame * brushSize)) ),( (Float)(0) ),( (Float)(brushSize) ),( (Float)(brushSize) ));
...
HXLINE( 429)		 ::flixel::graphics::FlxGraphic tempGraph = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE( 437)			max = ::Std_obj::_hx_int((( (Float)(max) ) * ((Float)1.5)));
            		}
            		else {
HXLINE( 437)			max = max;
            		}
...
HXLINE( 443)			this->set_width(( (Float)(brush->width) ));
HXLINE( 444)			this->set_height(( (Float)(brush->height) ));
HXLINE( 445)			this->centerOffsets(null());
            		}
HXLINE( 448)		this->bakedRotationAngle = (( (Float)(360) ) / ( (Float)(Rotations) ));
...
HXDLIN( 471)			key = (key + (HX_(":",3a,00,00,00) + ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this1)->init(1,_this2)->init(2,_this3)->init(3,_this4))));
            		}
HXLINE( 473)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE( 477)		return this->loadRotatedGraphic(graphic,Rotations,-1,AntiAliasing,AutoBuffer,null());
            	}
...
HXLINE( 518)		this->_flashRect->x = ( (Float)(0) );
HXLINE( 519)		this->_flashRect->y = ( (Float)(0) );
HXLINE( 520)		this->_flashRect->width = ( (Float)(this->frameWidth) );
HXLINE( 521)		this->_flashRect->height = ( (Float)(this->frameHeight) );
            	}
...
HXLINE( 534)		this->_halfSize->set((((Float)0.5) * ( (Float)(this->frameWidth) )),(((Float)0.5) * ( (Float)(this->frameHeight) )));
HXLINE( 535)		{
HXLINE( 535)			this->_flashRect->x = ( (Float)(0) );
HXDLIN( 535)			this->_flashRect->y = ( (Float)(0) );
HXDLIN( 535)			this->_flashRect->width = ( (Float)(this->frameWidth) );
HXDLIN( 535)			this->_flashRect->height = ( (Float)(this->frameHeight) );
            		}
            	}
...
HXLINE( 543)		this->set_width(( (Float)(this->frameWidth) ));
HXLINE( 544)		this->set_height(( (Float)(this->frameHeight) ));
            	}
...
HXDLIN( 567)		if ((Width <= 0)) {
HXLINE( 567)			_hx_tmp = (Height <= 0);
            		}
            		else {
...
HXLINE( 574)		if ((Width <= 0)) {
HXLINE( 575)			this->scale->set_x(newScaleY);
            		}
            		else {
HXLINE( 576)			if ((Height <= 0)) {
...
HXLINE( 586)		this->set_width((::Math_obj::abs(this->scale->x) * ( (Float)(this->frameWidth) )));
HXLINE( 587)		this->set_height((::Math_obj::abs(this->scale->y) * ( (Float)(this->frameHeight) )));
HXLINE( 588)		 ::flixel::math::FlxPoint _hx_tmp = this->offset;
HXDLIN( 588)		Float _hx_tmp1 = this->get_width();
HXDLIN( 588)		Float _hx_tmp2 = (((Float)-0.5) * (_hx_tmp1 - ( (Float)(this->frameWidth) )));
HXDLIN( 588)		Float _hx_tmp3 = this->get_height();
HXDLIN( 588)		_hx_tmp->set(_hx_tmp2,(((Float)-0.5) * (_hx_tmp3 - ( (Float)(this->frameHeight) ))));
HXLINE( 589)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
            	}
...
HXDLIN( 598)			this->_halfSize->set((((Float)0.5) * ( (Float)(this->frameWidth) )),(((Float)0.5) * ( (Float)(this->frameHeight) )));
HXDLIN( 598)			{
HXLINE( 598)				this->_flashRect->x = ( (Float)(0) );
HXDLIN( 598)				this->_flashRect->y = ( (Float)(0) );
HXDLIN( 598)				this->_flashRect->width = ( (Float)(this->frameWidth) );
HXDLIN( 598)				this->_flashRect->height = ( (Float)(this->frameHeight) );
            			}
            		}
HXLINE( 599)		{
HXLINE( 599)			this->set_width(( (Float)(this->frameWidth) ));
HXDLIN( 599)			this->set_height(( (Float)(this->frameHeight) ));
            		}
HXLINE( 600)		this->_flashRect2->x = ( (Float)(0) );
HXLINE( 601)		this->_flashRect2->y = ( (Float)(0) );
HXLINE( 603)		if (hx::IsNotNull( this->graphic )) {
HXLINE( 605)			this->_flashRect2->width = ( (Float)(this->graphic->width) );
HXLINE( 606)			this->_flashRect2->height = ( (Float)(this->graphic->height) );
            		}
HXLINE( 609)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
...
HXDLIN( 646)		if ((this->alpha != 0)) {
HXLINE( 646)			_hx_tmp = (this->_frame->type == 2);
            		}
            		else {
...
HXDLIN( 679)			_this->set_x(( (Float)(::Math_obj::floor(_this->x)) ));
HXDLIN( 679)			_this->set_y(( (Float)(::Math_obj::floor(_this->y)) ));
            		}
HXLINE( 681)		{
...
HXDLIN( 689)		this->_frame->prepareMatrix(this->_matrix,0,_hx_tmp,_hx_tmp1);
HXLINE( 690)		this->_matrix->translate(-(this->origin->x),-(this->origin->y));
HXLINE( 691)		this->_matrix->scale(this->scale->x,this->scale->y);
HXLINE( 693)		if ((this->bakedRotationAngle <= 0)) {
HXLINE( 695)			if (this->_angleChanged) {
HXLINE( 695)				Float radians = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
...
HXDLIN( 698)				Float a1 = ((_this->a * cos) - (_this->b * sin));
HXDLIN( 698)				_this->b = ((_this->a * sin) + (_this->b * cos));
HXDLIN( 698)				_this->a = a1;
HXDLIN( 698)				Float c1 = ((_this->c * cos) - (_this->d * sin));
HXDLIN( 698)				_this->d = ((_this->c * sin) + (_this->d * cos));
HXDLIN( 698)				_this->c = c1;
HXDLIN( 698)				Float tx1 = ((_this->tx * cos) - (_this->ty * sin));
HXDLIN( 698)				_this->ty = ((_this->tx * sin) + (_this->ty * cos));
...
HXLINE( 706)			this->_matrix->tx = ( (Float)(::Math_obj::floor(this->_matrix->tx)) );
HXLINE( 707)			this->_matrix->ty = ( (Float)(::Math_obj::floor(this->_matrix->ty)) );
            		}
...
HXLINE( 734)			this->_flashRect2->width = ( (Float)(bitmapData->width) );
HXLINE( 735)			this->_flashRect2->height = ( (Float)(bitmapData->height) );
HXLINE( 736)			this->graphic->bitmap->copyPixels(bitmapData,this->_flashRect2,this->_flashPoint,null(),null(),true);
HXLINE( 737)			this->_flashRect2->width = ( (Float)(this->graphic->bitmap->width) );
HXLINE( 738)			this->_flashRect2->height = ( (Float)(this->graphic->bitmap->height) );
            		}
            		else {
...
HXLINE( 745)			if ((Brush->angle != 0)) {
HXLINE( 747)				this->_matrix->rotate((Brush->angle * (::Math_obj::PI / ( (Float)(180) ))));
            			}
HXLINE( 749)			this->_matrix->translate(((X + this->frame->frame->x) + Brush->origin->x),((Y + this->frame->frame->y) + Brush->origin->y));
...
HXDLIN( 791)		_hx_tmp->set_x(((( (Float)(_hx_tmp1) ) - this->get_width()) * ((Float)0.5)));
HXLINE( 792)		 ::flixel::math::FlxPoint _hx_tmp2 = this->offset;
HXDLIN( 792)		int _hx_tmp3 = this->frameHeight;
HXDLIN( 792)		_hx_tmp2->set_y(((( (Float)(_hx_tmp3) ) - this->get_height()) * ((Float)0.5)));
...
HXDLIN( 806)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
            	}
...
HXLINE( 842)		Float Alpha = ( (Float)(1) );
HXDLIN( 842)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 842)		{
HXLINE( 842)			int Value = ::Math_obj::round((redMultiplier * ( (Float)(255) )));
HXDLIN( 842)			color = (color & -16711681);
HXDLIN( 842)			int color1;
HXDLIN( 842)			if ((Value > 255)) {
HXLINE( 842)				color1 = 255;
            			}
            			else {
HXLINE( 842)				if ((Value < 0)) {
HXLINE( 842)					color1 = 0;
            				}
            				else {
...
HXDLIN( 842)			color = (color | (color1 << 16));
            		}
HXDLIN( 842)		{
HXLINE( 842)			int Value1 = ::Math_obj::round((greenMultiplier * ( (Float)(255) )));
HXDLIN( 842)			color = (color & -65281);
HXDLIN( 842)			int color2;
HXDLIN( 842)			if ((Value1 > 255)) {
HXLINE( 842)				color2 = 255;
            			}
            			else {
HXLINE( 842)				if ((Value1 < 0)) {
HXLINE( 842)					color2 = 0;
            				}
            				else {
...
HXDLIN( 842)			color = (color | (color2 << 8));
            		}
HXDLIN( 842)		{
HXLINE( 842)			int Value2 = ::Math_obj::round((blueMultiplier * ( (Float)(255) )));
HXDLIN( 842)			color = (color & -256);
HXDLIN( 842)			int color3;
HXDLIN( 842)			if ((Value2 > 255)) {
HXLINE( 842)				color3 = 255;
            			}
            			else {
HXLINE( 842)				if ((Value2 < 0)) {
HXLINE( 842)					color3 = 0;
            				}
            				else {
...
HXDLIN( 842)			color = (color | color3);
            		}
HXDLIN( 842)		{
HXLINE( 842)			int Value3 = ::Math_obj::round((Alpha * ( (Float)(255) )));
HXDLIN( 842)			color = (color & 16777215);
HXDLIN( 842)			int color4;
HXDLIN( 842)			if ((Value3 > 255)) {
HXLINE( 842)				color4 = 255;
            			}
            			else {
HXLINE( 842)				if ((Value3 < 0)) {
HXLINE( 842)					color4 = 0;
            				}
            				else {
...
HXDLIN( 842)			color = (color | (color4 << 24));
            		}
HXDLIN( 842)		this->set_color((color & 16777215));
...
HXDLIN( 848)		if ((this->alpha == 1)) {
HXLINE( 848)			_hx_tmp1 = (this->color != 16777215);
            		}
            		else {
...
HXDLIN( 857)		if ((this->alpha == 1)) {
HXLINE( 857)			_hx_tmp = (this->color != 16777215);
            		}
            		else {
...
HXLINE( 859)			::flixel::util::FlxColorTransformUtil_obj::setMultipliers(this->colorTransform,(( (Float)(((this->color >> 16) & 255)) ) / ( (Float)(255) )),(( (Float)(((this->color >> 8) & 255)) ) / ( (Float)(255) )),(( (Float)((this->color & 255)) ) / ( (Float)(255) )),this->alpha);
            		}
            		else {
HXLINE( 861)			::flixel::util::FlxColorTransformUtil_obj::setMultipliers(this->colorTransform,( (Float)(1) ),( (Float)(1) ),( (Float)(1) ),( (Float)(1) ));
            		}
...
HXDLIN( 888)		if (!((this->_flashPoint->x < 0))) {
...
HXLINE( 888)			_hx_tmp1 = (this->_flashPoint->y < 0);
            		}
            		else {
...
HXLINE( 896)			return ((( (Float)(((pixelColor1 >> 24) & 255)) ) * this->alpha) >= Mask);
            		}
...
HXLINE( 935)			_hx_tmp2 = (this->_frame->type == 0);
            		}
            		else {
...
HXLINE( 941)			this->framePixels = this->_frame->paintRotatedAndFlipped(this->framePixels,this->_flashPointZero,0,doFlipX1,doFlipY1,false,true);
            		}
...
HXLINE( 972)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 972)			point1->_inPool = false;
HXDLIN( 972)			point = point1;
            		}
HXLINE( 973)		return point->set((this->x + (( (Float)(this->frameWidth) ) * ((Float)0.5))),(this->y + (( (Float)(this->frameHeight) ) * ((Float)0.5))));
            	}
...
HXLINE( 988)		Float minX = ((this->x - this->offset->x) - (Camera->scroll->x * this->scrollFactor->x));
HXLINE( 989)		Float minY = ((this->y - this->offset->y) - (Camera->scroll->y * this->scrollFactor->y));
HXLINE( 991)		bool _hx_tmp;
HXDLIN( 991)		bool _hx_tmp1;
HXDLIN( 991)		bool _hx_tmp2;
HXDLIN( 991)		if ((this->angle != 0)) {
HXLINE( 991)			_hx_tmp2 = (this->bakedRotationAngle > 0);
            		}
            		else {
HXLINE( 991)			_hx_tmp2 = true;
            		}
HXDLIN( 991)		if (_hx_tmp2) {
HXLINE( 991)			_hx_tmp1 = (this->scale->x == 1);
            		}
            		else {
HXLINE( 991)			_hx_tmp1 = false;
            		}
HXDLIN( 991)		if (_hx_tmp1) {
HXLINE( 991)			_hx_tmp = (this->scale->y == 1);
            		}
            		else {
...
HXLINE(1004)			Float x2 = ::Math_obj::abs((( (Float)(this->frameWidth) ) - ox));
...
HXLINE(1012)			Float y2 = ::Math_obj::abs((( (Float)(this->frameHeight) ) - oy));
...
HXLINE(1021)		minX = (minX + (ox - radius));
HXLINE(1022)		minY = (minY + (oy - radius));
HXLINE(1024)		Float doubleRadius = (( (Float)(2) ) * radius);
...
HXDLIN(1052)		if ((this->angle != 0)) {
HXLINE(1052)			result3 = (this->bakedRotationAngle > 0);
            		}
            		else {
HXLINE(1052)			result3 = true;
            		}
HXDLIN(1052)		if (result3) {
HXLINE(1052)			result2 = (this->scale->x == 1);
            		}
            		else {
HXLINE(1052)			result2 = false;
            		}
HXDLIN(1052)		if (result2) {
HXLINE(1052)			result1 = (this->scale->y == 1);
            		}
            		else {
...
HXLINE(1054)				result = ( (bool)(this->pixelPerfectRender) );
            			}
            		}
            		else {
...
HXLINE(1134)			this->set_graphic(( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) ));
            		}
...
HXDLIN(1147)				this->_halfSize->set((((Float)0.5) * ( (Float)(this->frameWidth) )),(((Float)0.5) * ( (Float)(this->frameHeight) )));
HXDLIN(1147)				{
HXLINE(1147)					this->_flashRect->x = ( (Float)(0) );
HXDLIN(1147)					this->_flashRect->y = ( (Float)(0) );
HXDLIN(1147)					this->_flashRect->width = ( (Float)(this->frameWidth) );
HXDLIN(1147)					this->_flashRect->height = ( (Float)(this->frameHeight) );
            				}
            			}
...
HXLINE(1150)				_hx_tmp1 = hx::IsNotNull( this->frames->frames );
            			}
            			else {
HXLINE(1150)				_hx_tmp1 = false;
            			}
HXDLIN(1150)			if (_hx_tmp1) {
HXLINE(1150)				_hx_tmp = (this->numFrames > 0);
            			}
            			else {
HXLINE(1150)				_hx_tmp = false;
            			}
HXDLIN(1150)			if (_hx_tmp) {
HXLINE(1152)				this->frame = this->frames->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN(1197)		if ((Alpha < 0)) {
HXLINE(1197)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE(1197)			lowerBound = Alpha;
            		}
HXDLIN(1197)		Float _hx_tmp;
HXDLIN(1197)		if ((lowerBound > 1)) {
HXLINE(1197)			_hx_tmp = ( (Float)(1) );
            		}
            		else {
...
HXLINE(1222)			this->animation->update(( (Float)(0) ));
            		}
...
HXLINE(1232)			Float radians = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
...
HXDLIN(1256)			_g->set_useCount((_g->get_useCount() + 1));
            		}
...
HXLINE(1261)			 ::flixel::graphics::FlxGraphic _g1 = oldGraphic;
HXDLIN(1261)			_g1->set_useCount((_g1->get_useCount() - 1));
            		}
...
HXLINE(1271)			rect->x = ( (Float)(::Math_obj::round(rect->x)) );
HXDLIN(1271)			rect->y = ( (Float)(::Math_obj::round(rect->y)) );
HXDLIN(1271)			rect->width = ( (Float)(::Math_obj::round(rect->width)) );
HXDLIN(1271)			rect->height = ( (Float)(::Math_obj::round(rect->height)) );
...
HXLINE(1300)			this->set_frame(this->frames->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >());
HXLINE(1301)			this->numFrames = this->frames->frames->length;
HXLINE(1302)			this->resetHelpers();
HXLINE(1303)			this->bakedRotationAngle = ( (Float)(0) );
HXLINE(1304)			this->animation->set_frameIndex(0);
