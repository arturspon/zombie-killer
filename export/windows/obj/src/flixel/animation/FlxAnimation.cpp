...
HXLINE( 219)			this->delay = (((Float)1.0) / ( (Float)(value) ));
            		}
...
static hx::StorageInfo FlxAnimation_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(FlxAnimation_obj,frameRate),HX_("frameRate",ad,11,25,39)},
	{hx::fsInt,(int)offsetof(FlxAnimation_obj,curFrame),HX_("curFrame",8d,72,31,4e)},
	{hx::fsInt,(int)offsetof(FlxAnimation_obj,numFrames),HX_("numFrames",8c,fa,86,5d)},
