...
HXLINE( 273)			if ((indices->length > 0)) {
...
HXLINE( 291)		 ::flixel::animation::FlxAnimation anim = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 326)			if ((frameIndices->length > 0)) {
...
HXLINE( 347)		 ::flixel::animation::FlxAnimation anim = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 382)			if ((frameIndices->length > 0)) {
...
HXLINE( 404)		 ::flixel::animation::FlxAnimation anim = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 433)					 ::Dynamic index = ::Std_obj::parseInt(name.substring(Prefix.length,(name.length - Postfix.length)));
...
HXLINE( 488)		 ::flixel::animation::FlxAnimation anim = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
...
HXLINE( 500)			if ((animFrames->length > 0)) {
...
HXLINE( 529)			_hx_tmp = hx::IsNull( this->_animations->get(AnimName) );
            		}
            		else {
...
HXLINE( 544)		this->_curAnim = ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(AnimName)) );
...
HXDLIN( 624)		return ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(Name)) );
            	}
...
HXLINE( 638)		this->set_frameIndex(::flixel::FlxG_obj::random->_hx_int(0,(this->_sprite->numFrames - 1),null()));
            	}
...
HXLINE( 666)				 ::flixel::graphics::frames::FlxFrame frameToAdd = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(frameName)) );
...
HXLINE( 679)				 ::flixel::graphics::frames::FlxFrame frameToAdd = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(name)) );
...
HXLINE( 699)		::String name = AnimFrames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 700)		int postIndex = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
HXLINE( 701)		int postFix;
HXDLIN( 701)		if ((postIndex == -1)) {
...
HXLINE( 723)			_hx_tmp = (this->_sprite->numFrames > 0);
            		}
            		else {
...
HXLINE( 726)			this->_sprite->set_frame(this->_sprite->frames->frames->__get(Frame).StaticCast<  ::flixel::graphics::frames::FlxFrame >());
...
HXLINE( 749)			 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(this->_sprite->frames->framesHash->get(Value)) );
...
static hx::StorageInfo FlxAnimationController_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(FlxAnimationController_obj,frames),HX_("frames",a6,af,85,ac)},
