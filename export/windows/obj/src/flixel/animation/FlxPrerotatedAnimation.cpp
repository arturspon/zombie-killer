...
HXLINE(  19)		this->rotations = ::Math_obj::round((( (Float)(360) ) / Baked));
            	}
...
HXLINE(  30)		int angleHelper = ::Math_obj::floor(hx::Mod(Value,360));
HXLINE(  32)		while((angleHelper < 0)){
HXLINE(  34)			angleHelper = (angleHelper + 360);
            		}
HXLINE(  37)		int newIndex = ::Math_obj::floor(((( (Float)(angleHelper) ) / this->baked) + ((Float)0.5)));
HXLINE(  38)		newIndex = ::Std_obj::_hx_int(( (Float)(hx::Mod(newIndex,this->rotations)) ));
