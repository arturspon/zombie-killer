...
HXDLIN( 145)		this->timer = _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),::Std_obj::_hx_int((this->duration / this->interval)));
            	}
...
HXDLIN( 179)		if ((Timer->loops > 0)) {
HXLINE( 179)			_hx_tmp = ((Timer->loops - Timer->_loopsCounter) == 0);
            		}
            		else {
...
HXLINE(  49)				return ( ( ::flixel::effects::FlxFlicker)(::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object)) );
            			}
            		}
HXLINE(  53)		if ((Interval <= 0)) {
...
HXLINE(  80)		 ::flixel::effects::FlxFlicker boundFlicker = ( ( ::flixel::effects::FlxFlicker)(::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object)) );
