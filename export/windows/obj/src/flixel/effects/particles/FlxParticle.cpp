...
HXLINE(  83)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  83)		point->_inPool = false;
HXDLIN(  83)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  83)		point1->_inPool = false;
HXDLIN(  83)		this->velocityRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point,point1);
HXLINE(  84)		this->angularVelocityRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,0,null());
HXLINE(  85)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(1,1);
HXDLIN(  85)		point2->_inPool = false;
HXDLIN(  85)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(1,1);
HXDLIN(  85)		point3->_inPool = false;
HXDLIN(  85)		this->scaleRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point2,point3);
HXLINE(  86)		this->alphaRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,1,1);
HXLINE(  87)		this->colorRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,-1,null());
HXLINE(  88)		 ::flixel::math::FlxPoint point4 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  88)		point4->_inPool = false;
HXDLIN(  88)		 ::flixel::math::FlxPoint point5 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  88)		point5->_inPool = false;
HXDLIN(  88)		this->dragRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point4,point5);
HXLINE(  89)		 ::flixel::math::FlxPoint point6 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  89)		point6->_inPool = false;
HXDLIN(  89)		 ::flixel::math::FlxPoint point7 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  89)		point7->_inPool = false;
HXDLIN(  89)		this->accelerationRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,point6,point7);
HXLINE(  90)		this->elasticityRange =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,0,null());
...
HXLINE( 102)			this->velocityRange->start = ::flixel::util::FlxDestroyUtil_obj::put(this->velocityRange->start);
HXLINE( 103)			this->velocityRange->end = ::flixel::util::FlxDestroyUtil_obj::put(this->velocityRange->end);
HXLINE( 104)			this->velocityRange = null();
            		}
HXLINE( 106)		if (hx::IsNotNull( this->scaleRange )) {
HXLINE( 108)			this->scaleRange->start = ::flixel::util::FlxDestroyUtil_obj::put(this->scaleRange->start);
HXLINE( 109)			this->scaleRange->end = ::flixel::util::FlxDestroyUtil_obj::put(this->scaleRange->end);
HXLINE( 110)			this->scaleRange = null();
            		}
HXLINE( 112)		if (hx::IsNotNull( this->dragRange )) {
HXLINE( 114)			this->dragRange->start = ::flixel::util::FlxDestroyUtil_obj::put(this->dragRange->start);
HXLINE( 115)			this->dragRange->end = ::flixel::util::FlxDestroyUtil_obj::put(this->dragRange->end);
HXLINE( 116)			this->dragRange = null();
            		}
HXLINE( 118)		if (hx::IsNotNull( this->accelerationRange )) {
HXLINE( 120)			this->accelerationRange->start = ::flixel::util::FlxDestroyUtil_obj::put(this->accelerationRange->start);
HXLINE( 121)			this->accelerationRange->end = ::flixel::util::FlxDestroyUtil_obj::put(this->accelerationRange->end);
...
HXLINE( 141)			_hx_tmp1 = (this->lifespan != 0);
            		}
            		else {
...
HXLINE( 147)			this->_delta = (elapsed / this->lifespan);
HXLINE( 148)			this->percent = (this->age / this->lifespan);
HXLINE( 150)			if (this->velocityRange->active) {
HXLINE( 152)				{
HXLINE( 152)					 ::flixel::math::FlxPoint _g = this->velocity;
HXDLIN( 152)					_g->set_x((_g->x + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->x) * this->_delta)));
            				}
HXLINE( 153)				{
HXLINE( 153)					 ::flixel::math::FlxPoint _g1 = this->velocity;
HXDLIN( 153)					_g1->set_y((_g1->y + ((( ( ::flixel::math::FlxPoint)(this->velocityRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->velocityRange->start) )->y) * this->_delta)));
            				}
            			}
...
HXLINE( 163)				{
HXLINE( 163)					 ::flixel::math::FlxPoint _g2 = this->scale;
HXDLIN( 163)					_g2->set_x((_g2->x + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->x) * this->_delta)));
            				}
HXLINE( 164)				{
HXLINE( 164)					 ::flixel::math::FlxPoint _g3 = this->scale;
HXDLIN( 164)					_g3->set_y((_g3->y + ((( ( ::flixel::math::FlxPoint)(this->scaleRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->scaleRange->start) )->y) * this->_delta)));
            				}
...
HXLINE( 170)				 ::flixel::effects::particles::FlxParticle _g4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 170)				_g4->set_alpha((_g4->alpha + ((( (Float)(this->alphaRange->end) ) - ( (Float)(this->alphaRange->start) )) * this->_delta)));
            			}
...
HXDLIN( 175)				int r = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 16) & 255) - ((Color1 >> 16) & 255))) ) * Factor) + ((Color1 >> 16) & 255)));
HXDLIN( 175)				int g = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 8) & 255) - ((Color1 >> 8) & 255))) ) * Factor) + ((Color1 >> 8) & 255)));
HXDLIN( 175)				int b = ::Std_obj::_hx_int(((( (Float)(((Color2 & 255) - (Color1 & 255))) ) * Factor) + (Color1 & 255)));
HXDLIN( 175)				int a = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 24) & 255) - ((Color1 >> 24) & 255))) ) * Factor) + ((Color1 >> 24) & 255)));
...
HXDLIN( 175)					color = (color | (color4 << 24));
            				}
HXDLIN( 175)				this->set_color(color);
            			}
HXLINE( 178)			if (this->dragRange->active) {
HXLINE( 180)				{
HXLINE( 180)					 ::flixel::math::FlxPoint _g5 = this->drag;
HXDLIN( 180)					_g5->set_x((_g5->x + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->x) * this->_delta)));
            				}
HXLINE( 181)				{
HXLINE( 181)					 ::flixel::math::FlxPoint _g6 = this->drag;
HXDLIN( 181)					_g6->set_y((_g6->y + ((( ( ::flixel::math::FlxPoint)(this->dragRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->dragRange->start) )->y) * this->_delta)));
            				}
            			}
HXLINE( 184)			if (this->accelerationRange->active) {
HXLINE( 186)				{
HXLINE( 186)					 ::flixel::math::FlxPoint _g7 = this->acceleration;
HXDLIN( 186)					_g7->set_x((_g7->x + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->x - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->x) * this->_delta)));
            				}
HXLINE( 187)				{
HXLINE( 187)					 ::flixel::math::FlxPoint _g8 = this->acceleration;
HXDLIN( 187)					_g8->set_y((_g8->y + ((( ( ::flixel::math::FlxPoint)(this->accelerationRange->end) )->y - ( ( ::flixel::math::FlxPoint)(this->accelerationRange->start) )->y) * this->_delta)));
            				}
            			}
