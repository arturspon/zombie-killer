...
HXLINE( 570)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
            		}
            		else {
...
HXDLIN( 605)		if (Value) {
HXLINE( 605)			_hx_tmp2 = (this->_useCount <= 0);
            		}
            		else {
...
HXLINE( 614)			Float Width = ( (Float)(this->bitmap->width) );
HXDLIN( 614)			Float Height = ( (Float)(this->bitmap->height) );
HXDLIN( 614)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 614)			_this->x = ( (Float)(0) );
HXDLIN( 614)			_this->y = ( (Float)(0) );
...
HXLINE(  54)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE(  81)		if (!(Cache)) {
HXLINE(  83)			bitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Source,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
...
HXLINE(  89)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
HXLINE(  90)		if (hx::IsNotNull( graphic )) {
HXLINE(  91)			return graphic;
            		}
HXLINE(  93)		bitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Source,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
...
HXLINE( 128)		graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXDLIN( 153)			key = ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_this1)->init(1,_this2)->init(2,_this3)->init(3,_this4));
            		}
HXLINE( 154)		key = ((Source->parent->key + HX_(":",3a,00,00,00)) + key);
HXLINE( 155)		key = ::flixel::FlxG_obj::bitmap->generateKey(key,Key,Unique);
HXLINE( 156)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE( 163)		image->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name = Source->name;
...
HXLINE( 203)		::flixel::FlxG_obj::bitmap->_cache->set(graphic->key,graphic);
...
HXLINE( 221)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::flixel::FlxG_obj::bitmap->_cache->get(key)) );
...
HXLINE( 261)			::flixel::FlxG_obj::bitmap->_cache->set(graphic->key,graphic);
            		}
            		else {
...
static hx::StorageInfo FlxGraphic_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::flixel::graphics::frames::FlxAtlasFrames */ ,(int)offsetof(FlxGraphic_obj,atlasFrames),HX_("atlasFrames",51,fb,38,2f)},
