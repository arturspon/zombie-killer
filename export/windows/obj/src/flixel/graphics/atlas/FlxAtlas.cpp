...
HXLINE( 101)		this->maxHeight = 1024;
HXLINE(  97)		this->maxWidth = 1024;
HXLINE(  92)		this->minHeight = 128;
...
HXLINE( 159)			rootWidth = this->getNextPowerOfTwo(( (Float)(rootWidth) ));
HXLINE( 160)			rootHeight = this->getNextPowerOfTwo(( (Float)(rootHeight) ));
            		}
HXLINE( 163)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 163)		_this->x = ( (Float)(0) );
HXDLIN( 163)		_this->y = ( (Float)(0) );
HXDLIN( 163)		_this->width = ( (Float)(rootWidth) );
HXDLIN( 163)		_this->height = ( (Float)(rootHeight) );
...
HXLINE( 188)			return ( ( ::flixel::graphics::atlas::FlxNode)(this->nodes->get(key)) );
            		}
...
HXLINE( 220)		Float Width = ( (Float)(::Std_obj::_hx_int(temp->rect->width)) );
HXDLIN( 220)		Float Height = ( (Float)(::Std_obj::_hx_int(temp->rect->height)) );
HXDLIN( 220)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 220)		_this->x = ( (Float)(0) );
HXDLIN( 220)		_this->y = ( (Float)(0) );
...
HXLINE( 281)				Float X = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->x)) );
HXDLIN( 281)				Float Y = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->y)) );
HXDLIN( 281)				Float Height = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->height)) );
HXDLIN( 281)				 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 281)				_this->x = X;
HXDLIN( 281)				_this->y = Y;
HXDLIN( 281)				_this->width = ( (Float)(insertWidth) );
...
HXLINE( 302)				Float X4 = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->x)) );
HXDLIN( 302)				Float Y4 = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->y)) );
HXDLIN( 302)				Float Width1 = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->width)) );
...
HXDLIN( 302)				_this4->height = ( (Float)(insertHeight) );
...
HXLINE( 305)				if (((::Std_obj::_hx_int(nodeToDivide->rect->height) - insertHeight) > 0)) {
HXLINE( 307)					Float X5 = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->x)) );
HXDLIN( 307)					Float Y5 = ( (Float)((::Std_obj::_hx_int(nodeToDivide->rect->y) + insertHeight)) );
HXDLIN( 307)					Float Width2 = ( (Float)(::Std_obj::_hx_int(nodeToDivide->rect->width)) );
HXDLIN( 307)					Float Height3 = ( (Float)((::Std_obj::_hx_int(nodeToDivide->rect->height) - insertHeight)) );
...
HXLINE( 311)				Float X6 = ( (Float)(::Std_obj::_hx_int(firstChild->rect->x)) );
HXDLIN( 311)				Float Y6 = ( (Float)(::Std_obj::_hx_int(firstChild->rect->y)) );
HXDLIN( 311)				 ::flixel::math::FlxRect _this6 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 311)				_this6->x = X6;
HXDLIN( 311)				_this6->y = Y6;
HXDLIN( 311)				_this6->width = ( (Float)(insertWidth) );
HXDLIN( 311)				_this6->height = ( (Float)(insertHeight) );
...
HXLINE( 314)				if (((::Std_obj::_hx_int(firstChild->rect->width) - insertWidth) > 0)) {
HXLINE( 316)					Float X7 = ( (Float)((::Std_obj::_hx_int(firstChild->rect->x) + insertWidth)) );
HXDLIN( 316)					Float Y7 = ( (Float)(::Std_obj::_hx_int(firstChild->rect->y)) );
HXDLIN( 316)					Float Width3 = ( (Float)((::Std_obj::_hx_int(firstChild->rect->width) - insertWidth)) );
...
HXDLIN( 316)					_this7->height = ( (Float)(insertHeight) );
...
HXLINE( 335)					::flixel::graphics::atlas::FlxAtlas_obj::matrix->rotate((::Math_obj::PI / ( (Float)(2) )));
HXLINE( 336)					 ::openfl::geom::Matrix _hx_tmp1 = ::flixel::graphics::atlas::FlxAtlas_obj::matrix;
HXDLIN( 336)					int firstGrandChildData1 = firstGrandChildData->height;
HXDLIN( 336)					int _hx_tmp2 = (firstGrandChildData1 + ::Std_obj::_hx_int(firstGrandChild->rect->x));
HXDLIN( 336)					_hx_tmp1->translate(( (Float)(_hx_tmp2) ),( (Float)(::Std_obj::_hx_int(firstGrandChild->rect->y)) ));
HXLINE( 337)					this->bitmapData->draw(firstGrandChildData,::flixel::graphics::atlas::FlxAtlas_obj::matrix,null(),null(),null(),null());
            				}
            				else {
HXLINE( 341)					 ::openfl::geom::Point _hx_tmp3 = ::flixel::graphics::atlas::FlxAtlas_obj::point;
HXDLIN( 341)					int _hx_tmp4 = ::Std_obj::_hx_int(firstGrandChild->rect->x);
HXDLIN( 341)					_hx_tmp3->setTo(( (Float)(_hx_tmp4) ),( (Float)(::Std_obj::_hx_int(firstGrandChild->rect->y)) ));
...
HXLINE( 367)				rootWidth = this->getNextPowerOfTwo(( (Float)(rootWidth) ));
HXLINE( 368)				rootHeight = this->getNextPowerOfTwo(( (Float)(rootHeight) ));
            			}
...
HXLINE( 376)				rootWidth = this->getNextPowerOfTwo(( (Float)(rootWidth) ));
HXLINE( 377)				rootHeight = this->getNextPowerOfTwo(( (Float)(rootHeight) ));
            			}
HXLINE( 380)			bool _hx_tmp;
HXDLIN( 380)			bool _hx_tmp1;
HXDLIN( 380)			if ((this->maxWidth > 0)) {
...
HXLINE( 380)				if ((this->maxHeight > 0)) {
...
HXLINE( 409)			int addRightHeight = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(::Std_obj::_hx_int(this->root->rect->height)) ),( (Float)(insertHeight) )));
HXLINE( 411)			int addBottomWidth = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(::Std_obj::_hx_int(this->root->rect->width)) ),( (Float)(insertWidth) )));
...
HXLINE( 423)				addRightHeightRotate = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(::Std_obj::_hx_int(this->root->rect->height)) ),( (Float)(insertWidth) )));
HXLINE( 425)				addBottomWidthRotate = ::Std_obj::_hx_int(::Math_obj::max(( (Float)(::Std_obj::_hx_int(this->root->rect->width)) ),( (Float)(insertHeight) )));
HXLINE( 426)				addBottomHeightRotate = (::Std_obj::_hx_int(this->root->rect->height) + insertWidth);
            			}
HXLINE( 429)			if (this->powerOfTwo) {
HXLINE( 431)				addRightWidth = this->getNextPowerOfTwo(( (Float)(addRightWidth) ));
HXDLIN( 431)				addRightWidthRotate = addRightWidth;
HXLINE( 432)				addRightHeight = this->getNextPowerOfTwo(( (Float)(addRightHeight) ));
HXDLIN( 432)				addRightHeightRotate = addRightHeight;
HXLINE( 433)				addBottomWidth = this->getNextPowerOfTwo(( (Float)(addBottomWidth) ));
HXDLIN( 433)				addBottomWidthRotate = addBottomWidth;
HXLINE( 434)				addBottomHeight = this->getNextPowerOfTwo(( (Float)(addBottomHeight) ));
HXDLIN( 434)				addBottomHeightRotate = addBottomHeight;
HXLINE( 436)				if (this->allowRotation) {
HXLINE( 438)					addRightWidthRotate = this->getNextPowerOfTwo(( (Float)(addRightWidthRotate) ));
HXLINE( 439)					addRightHeightRotate = this->getNextPowerOfTwo(( (Float)(addRightHeightRotate) ));
HXLINE( 440)					addBottomWidthRotate = this->getNextPowerOfTwo(( (Float)(addBottomWidthRotate) ));
HXLINE( 441)					addBottomHeightRotate = this->getNextPowerOfTwo(( (Float)(addBottomHeightRotate) ));
            				}
            			}
...
HXLINE( 452)				if ((this->maxHeight > 0)) {
...
HXLINE( 455)				if ((this->maxHeight > 0)) {
...
HXLINE( 458)				if ((this->maxHeight > 0)) {
...
HXLINE( 461)				if ((this->maxHeight > 0)) {
...
HXLINE( 508)				addRightArea = (addBottomArea + 1);
...
HXLINE( 513)					addBottomArea = (addRightArea + 1);
...
HXDLIN( 531)				this->expandRoot(( (Float)(_hx_tmp20) ),::Math_obj::max(( (Float)(::Std_obj::_hx_int(temp->rect->height)) ),( (Float)(insertNodeHeight) )),true,null());
HXLINE( 532)				dataNode = this->divideNode(this->root->right,insertNodeWidth,insertNodeHeight,true,data,key,rotateRight);
HXLINE( 533)				this->expandRoot(( (Float)(addRightWidth) ),( (Float)(addRightHeight) ),false,true);
            			}
            			else {
...
HXLINE( 543)				Float _hx_tmp21 = ::Math_obj::max(( (Float)(::Std_obj::_hx_int(temp->rect->width)) ),( (Float)(insertNodeWidth) ));
HXDLIN( 543)				this->expandRoot(_hx_tmp21,( (Float)((::Std_obj::_hx_int(temp->rect->height) + insertNodeHeight)) ),false,null());
HXLINE( 544)				dataNode = this->divideNode(this->root->right,insertNodeWidth,insertNodeHeight,true,data,key,rotateBottom);
HXLINE( 545)				this->expandRoot(( (Float)(addBottomWidth) ),( (Float)(addBottomHeight) ),false,true);
            			}
...
HXDLIN( 576)		 ::openfl::display::BitmapData newBitmapData1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newBitmapData,::Std_obj::_hx_int(this->root->rect->height),true,0);
HXLINE( 577)		if (hx::IsNotNull( this->bitmapData )) {
HXLINE( 579)			::flixel::graphics::atlas::FlxAtlas_obj::point->setTo(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 593)		int result = 1;
HXLINE( 594)		while((result < n)){
HXLINE( 594)			result = (result << 1);
            		}
...
HXLINE( 628)			return ( ( ::flixel::graphics::atlas::FlxNode)(this->nodes->get(key)) )->getTileFrames(tileSize,tileSpacing,tileBorder);
            		}
...
HXLINE( 654)			Float Y = (( (Float)(2) ) * tileBorder->y);
HXDLIN( 654)			{
HXLINE( 654)				 ::flixel::math::FlxPoint _g = tileSize;
HXDLIN( 654)				_g->set_x((_g->x + (( (Float)(2) ) * tileBorder->x)));
            			}
HXDLIN( 654)			{
...
HXLINE( 690)			Float X = ( (Float)(::Std_obj::_hx_int(node->rect->x)) );
HXDLIN( 690)			Float Y = ( (Float)(::Std_obj::_hx_int(node->rect->y)) );
HXDLIN( 690)			int Width = ::Std_obj::_hx_int(node->rect->width);
HXDLIN( 690)			Float Width1 = ( (Float)((Width - this->border)) );
HXDLIN( 690)			int Height = ::Std_obj::_hx_int(node->rect->height);
HXDLIN( 690)			Float Height1 = ( (Float)((Height - this->border)) );
...
HXDLIN( 692)				Float X2 = ( (Float)((X1 - this->border)) );
HXDLIN( 692)				int Y1 = ::Std_obj::_hx_int(node->rect->width);
HXDLIN( 692)				Float Y2 = ( (Float)((Y1 - this->border)) );
...
HXDLIN( 693)				Float X4 = ( (Float)((X3 - this->border)) );
HXDLIN( 693)				int Y3 = ::Std_obj::_hx_int(node->rect->height);
HXDLIN( 693)				Float Y4 = ( (Float)((Y3 - this->border)) );
...
HXLINE( 694)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
...
HXDLIN( 719)		return ( ( ::flixel::graphics::atlas::FlxNode)(this->nodes->get(key)) );
            	}
...
HXDLIN( 823)				_hx_tmp = (this->_graphic->get_useCount() <= 0);
            			}
            			else {
...
HXLINE( 920)		int minArea = ((this->maxWidth * this->maxHeight) + 1);
...
HXLINE(1036)				value = this->getNextPowerOfTwo(( (Float)(value) ));
            			}
...
HXDLIN(1042)					this->expandRoot(( (Float)(value) ),( (Float)(_hx_tmp1) ),this->needToDivideHorizontally(_hx_tmp2,_hx_tmp3,::Std_obj::_hx_int(this->root->rect->height)),null());
            				}
            			}
            		}
...
HXLINE(1062)				value = this->getNextPowerOfTwo(( (Float)(value) ));
            			}
...
HXDLIN(1068)					this->expandRoot(( (Float)(_hx_tmp1) ),( (Float)(value) ),this->needToDivideHorizontally(_hx_tmp2,_hx_tmp3,::Std_obj::_hx_int(this->root->rect->height)),null());
            				}
            			}
            		}
...
HXLINE(1096)			int nextWidth = this->getNextPowerOfTwo(( (Float)(::Std_obj::_hx_int(this->root->rect->width)) ));
HXLINE(1097)			int nextHeight = this->getNextPowerOfTwo(( (Float)(::Std_obj::_hx_int(this->root->rect->height)) ));
...
HXDLIN(1101)				if ((this->maxWidth > 0)) {
...
HXLINE(1101)					if ((this->maxHeight > 0)) {
...
HXDLIN(1111)				_this->x = ( (Float)(0) );
HXDLIN(1111)				_this->y = ( (Float)(0) );
HXDLIN(1111)				_this->width = ( (Float)(nextWidth) );
HXDLIN(1111)				_this->height = ( (Float)(nextHeight) );
...
static hx::StorageInfo FlxAtlas_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::flixel::graphics::FlxGraphic */ ,(int)offsetof(FlxAtlas_obj,graphic),HX_("graphic",a8,5a,07,74)},
