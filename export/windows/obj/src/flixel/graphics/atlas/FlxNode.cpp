...
HXDLIN( 114)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesHash->get(this->key)) );
...
HXDLIN( 135)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(_this->framesHash->get(this->key)) );
...
HXLINE( 165)		this->rect->width = ( (Float)(value) );
...
HXLINE( 176)		this->rect->height = ( (Float)(value) );
...
static hx::StorageInfo FlxNode_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(FlxNode_obj,x),HX_("x",78,00,00,00)},
	{hx::fsInt,(int)offsetof(FlxNode_obj,y),HX_("y",79,00,00,00)},
	{hx::fsBool,(int)offsetof(FlxNode_obj,isEmpty),HX_("isEmpty",43,de,5f,0c)},
