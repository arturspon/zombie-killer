...
HXLINE( 421)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 163)		{
HXLINE( 163)			int _g = 0;
HXDLIN( 163)			int _g1 = numImages;
HXDLIN( 163)			while((_g < _g1)){
HXLINE( 163)				_g = (_g + 1);
HXDLIN( 163)				int i = (_g - 1);
HXLINE( 165)				int curIndex = (i * numElementsPerImage);
HXLINE( 167)				curIndex = (curIndex + 1);
HXDLIN( 167)				::String name = lines->__get((curIndex - 1));
HXLINE( 168)				curIndex = (curIndex + 1);
HXDLIN( 168)				bool rotated = (lines->__get((curIndex - 1)).indexOf(HX_("true",4e,a7,03,4d),null()) >= 0);
HXLINE( 169)				int angle = 0;
HXLINE( 171)				curIndex = (curIndex + 1);
HXDLIN( 171)				::String tempString = lines->__get((curIndex - 1));
HXLINE( 172)				::Array< int > size1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::getDimensions(tempString,size);
HXLINE( 174)				int imageX = size1->__get(0);
HXLINE( 175)				int imageY = size1->__get(1);
HXLINE( 177)				curIndex = (curIndex + 1);
HXDLIN( 177)				tempString = lines->__get((curIndex - 1));
HXLINE( 178)				size1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::getDimensions(tempString,size1);
HXLINE( 180)				int imageWidth = size1->__get(0);
HXLINE( 181)				int imageHeight = size1->__get(1);
...
HXDLIN( 186)					_this->x = ( (Float)(imageX) );
HXDLIN( 186)					_this->y = ( (Float)(imageY) );
HXDLIN( 186)					_this->width = ( (Float)(imageHeight) );
HXDLIN( 186)					_this->height = ( (Float)(imageWidth) );
...
HXDLIN( 191)					_this1->x = ( (Float)(imageX) );
HXDLIN( 191)					_this1->y = ( (Float)(imageY) );
HXDLIN( 191)					_this1->width = ( (Float)(imageWidth) );
HXDLIN( 191)					_this1->height = ( (Float)(imageHeight) );
...
HXDLIN( 197)				 ::flixel::math::FlxPoint point1 = point->set(size1->__get(0),size1->__get(1));
HXDLIN( 197)				point1->_inPool = false;
HXDLIN( 197)				 ::flixel::math::FlxPoint sourceSize = point1;
HXLINE( 199)				curIndex = (curIndex + 1);
HXDLIN( 199)				tempString = lines->__get((curIndex - 1));
HXLINE( 200)				size1 = ::flixel::graphics::frames::FlxAtlasFrames_obj::getDimensions(tempString,size1);
HXLINE( 206)				Float Y = ((sourceSize->y - ( (Float)(size1->__get(1)) )) - ( (Float)(imageHeight) ));
HXDLIN( 206)				 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get();
HXDLIN( 206)				 ::flixel::math::FlxPoint point3 = point2->set(size1->__get(0),Y);
...
HXLINE( 225)		size[0] = ( (int)(::Std_obj::parseInt(line.substring((colonPosition + 1),comaPosition))) );
HXLINE( 226)		size[1] = ( (int)(::Std_obj::parseInt(line.substring((comaPosition + 1),line.length))) );
...
HXLINE( 260)		 ::Xml x = ::Xml_obj::parse(Description)->firstElement();
HXDLIN( 260)		bool _hx_tmp1;
HXDLIN( 260)		if ((x->nodeType != ::Xml_obj::Document)) {
HXLINE( 260)			_hx_tmp1 = (x->nodeType != ::Xml_obj::Element);
            		}
            		else {
HXLINE( 260)			_hx_tmp1 = false;
            		}
HXDLIN( 260)		if (_hx_tmp1) {
HXLINE( 260)			HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + x->nodeType));
            		}
HXDLIN( 260)		 ::Xml this1 = x;
HXDLIN( 260)		 ::Xml data = this1;
HXLINE( 262)		{
HXLINE( 262)			int _g = 0;
HXDLIN( 262)			::Array< ::Dynamic> _g1 = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(data,HX_("SubTexture",5b,7b,fb,11));
HXDLIN( 262)			while((_g < _g1->length)){
HXLINE( 262)				 ::Xml texture = _g1->__get(_g).StaticCast<  ::Xml >();
HXDLIN( 262)				_g = (_g + 1);
HXLINE( 264)				::String name = ::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("name",4b,72,ff,48));
HXLINE( 265)				bool trimmed = ::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac));
HXLINE( 266)				bool rotated;
HXDLIN( 266)				if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("rotated",a9,49,1d,f1))) {
HXLINE( 266)					rotated = (::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("rotated",a9,49,1d,f1)) == HX_("true",4e,a7,03,4d));
            				}
            				else {
HXLINE( 266)					rotated = false;
            				}
HXLINE( 267)				bool flipX;
HXDLIN( 267)				if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("flipX",0b,45,92,02))) {
HXLINE( 267)					flipX = (::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("flipX",0b,45,92,02)) == HX_("true",4e,a7,03,4d));
            				}
            				else {
HXLINE( 267)					flipX = false;
            				}
HXLINE( 268)				bool flipY;
HXDLIN( 268)				if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(texture,HX_("flipY",0c,45,92,02))) {
HXLINE( 268)					flipY = (::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("flipY",0c,45,92,02)) == HX_("true",4e,a7,03,4d));
            				}
            				else {
HXLINE( 268)					flipY = false;
            				}
HXLINE( 270)				Float X = ::Std_obj::parseFloat(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("x",78,00,00,00)));
HXDLIN( 270)				Float Y = ::Std_obj::parseFloat(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("y",79,00,00,00)));
HXDLIN( 270)				Float Width = ::Std_obj::parseFloat(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("width",06,b6,62,ca)));
HXDLIN( 270)				Float Height = ::Std_obj::parseFloat(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("height",e7,07,4c,02)));
...
HXLINE( 275)					 ::Dynamic size1 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac)));
HXDLIN( 275)					 ::Dynamic size2 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameY",8c,af,85,ac)));
HXLINE( 276)					 ::Dynamic size3 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameWidth",99,ea,88,ad)));
HXLINE( 273)					size =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,size1,size2,size3,::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameHeight",f4,d3,93,e0))));
            				}
            				else {
HXLINE( 273)					size =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,rect1->width,rect1->height);
            				}
...
HXLINE( 333)				 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
HXDLIN( 333)				point->_inPool = false;
HXDLIN( 333)				 ::flixel::math::FlxPoint offset = point;
HXLINE( 334)				Float X = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("x",78,00,00,00)))) );
HXDLIN( 334)				Float Y = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("y",79,00,00,00)))) );
HXDLIN( 334)				Float Width = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("w",77,00,00,00)))) );
HXDLIN( 334)				Float Height = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("h",68,00,00,00)))) );
...
HXLINE( 381)		{
HXLINE( 381)			int _g = 0;
HXDLIN( 381)			int _g1 = lines->length;
HXDLIN( 381)			while((_g < _g1)){
HXLINE( 381)				_g = (_g + 1);
HXDLIN( 381)				int i = (_g - 1);
HXLINE( 383)				::Array< ::String > currImageData = lines->__get(i).split(HX_("=",3d,00,00,00));
HXLINE( 384)				::String name = ::StringTools_obj::trim(currImageData->__get(0));
HXLINE( 385)				::Array< ::String > currImageRegion = ::StringTools_obj::trim(currImageData->__get(1)).split(HX_(" ",20,00,00,00));
HXLINE( 387)				Float X = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(0))) );
HXDLIN( 387)				Float Y = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(1))) );
HXDLIN( 387)				Float Width = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(2))) );
HXDLIN( 387)				Float Height = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(3))) );
...
HXLINE( 390)				 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 390)				point1->_inPool = false;
HXDLIN( 390)				 ::flixel::math::FlxPoint offset = point1;
HXLINE( 392)				frames->addAtlasFrame(rect1,sourceSize,offset,name,0,null(),null());
            			}
            		}
...
HXLINE( 408)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 410)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(graphic->frameCollections->get(type)) );
HXDLIN( 410)		if (hx::IsNull( collections )) {
HXLINE( 410)			collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 410)			graphic->frameCollections->set(type,collections);
            		}
