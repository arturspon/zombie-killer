...
HXLINE( 104)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 104)		point->_inPool = false;
HXDLIN( 104)		this->sourceSize = point;
HXLINE( 105)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 105)		point1->_inPool = false;
HXDLIN( 105)		this->offset = point1;
HXLINE( 107)		::Array< Float > this1 = ::Array_obj< Float >::__new(6);
HXDLIN( 107)		this->blitMatrix = this1;
HXLINE( 108)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 109)			::Array< Float > this2 = ::Array_obj< Float >::__new(6);
...
HXDLIN( 116)			if ((this->angle == 90)) {
HXLINE( 116)				mat->setTo(-(mat->b),mat->a,-(mat->d),mat->c,-(mat->ty),mat->tx);
HXDLIN( 116)				mat->translate(this->frame->height,( (Float)(0) ));
            			}
            			else {
HXLINE( 116)				if ((this->angle == -90)) {
HXLINE( 116)					mat->setTo(mat->b,-(mat->a),mat->d,-(mat->c),mat->ty,-(mat->tx));
HXDLIN( 116)					mat->translate(( (Float)(0) ),this->frame->width);
            				}
            			}
HXDLIN( 116)			mat->translate(this->offset->x,this->offset->y);
            		}
HXLINE( 117)		this->blitMatrix->__unsafe_set(0,this->matrix->a);
HXLINE( 118)		this->blitMatrix->__unsafe_set(1,this->matrix->b);
HXLINE( 119)		this->blitMatrix->__unsafe_set(2,this->matrix->c);
HXLINE( 120)		this->blitMatrix->__unsafe_set(3,this->matrix->d);
HXLINE( 121)		this->blitMatrix->__unsafe_set(4,this->matrix->tx);
HXLINE( 122)		this->blitMatrix->__unsafe_set(5,this->matrix->ty);
HXLINE( 124)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 126)			{
HXLINE( 126)				 ::flixel::math::FlxMatrix mat1 = this->matrix;
HXDLIN( 126)				mat1->identity();
HXDLIN( 126)				if ((this->angle == 90)) {
HXLINE( 126)					mat1->setTo(-(mat1->b),mat1->a,-(mat1->d),mat1->c,-(mat1->ty),mat1->tx);
HXDLIN( 126)					mat1->translate(this->frame->height,( (Float)(0) ));
            				}
            				else {
HXLINE( 126)					if ((this->angle == -90)) {
HXLINE( 126)						mat1->setTo(mat1->b,-(mat1->a),mat1->d,-(mat1->c),mat1->ty,-(mat1->tx));
HXDLIN( 126)						mat1->translate(( (Float)(0) ),this->frame->width);
            					}
            				}
HXDLIN( 126)				mat1->translate(this->offset->x,this->offset->y);
            			}
HXLINE( 127)			this->tileMatrix->__unsafe_set(0,this->matrix->a);
HXLINE( 128)			this->tileMatrix->__unsafe_set(1,this->matrix->b);
HXLINE( 129)			this->tileMatrix->__unsafe_set(2,this->matrix->c);
HXLINE( 130)			this->tileMatrix->__unsafe_set(3,this->matrix->d);
HXLINE( 131)			this->tileMatrix->__unsafe_set(4,this->matrix->tx);
HXLINE( 132)			this->tileMatrix->__unsafe_set(5,this->matrix->ty);
            		}
            	}
...
HXLINE( 151)		if ((this->angle == 90)) {
HXLINE( 153)			mat->setTo(-(mat->b),mat->a,-(mat->d),mat->c,-(mat->ty),mat->tx);
HXLINE( 154)			mat->translate(this->frame->height,( (Float)(0) ));
            		}
            		else {
HXLINE( 156)			if ((this->angle == -90)) {
HXLINE( 158)				mat->setTo(mat->b,-(mat->a),mat->d,-(mat->c),mat->ty,-(mat->tx));
HXLINE( 159)				mat->translate(( (Float)(0) ),this->frame->width);
            			}
            		}
...
HXLINE( 229)		mat->a = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,0)) );
HXDLIN( 229)		mat->b = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,1)) );
HXDLIN( 229)		mat->c = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,2)) );
HXDLIN( 229)		mat->d = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,3)) );
HXDLIN( 229)		mat->tx = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,4)) );
HXDLIN( 229)		mat->ty = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,5)) );
HXDLIN( 229)		mat = mat;
HXLINE( 230)		int w = ::Std_obj::_hx_int(this->sourceSize->x);
HXDLIN( 230)		int h = ::Std_obj::_hx_int(this->sourceSize->y);
HXDLIN( 230)		if ((rotation != 0)) {
HXLINE( 230)			int t = w;
HXDLIN( 230)			w = h;
HXDLIN( 230)			h = t;
HXDLIN( 230)			if ((rotation == 90)) {
HXLINE( 230)				mat->setTo(-(mat->b),mat->a,-(mat->d),mat->c,-(mat->ty),mat->tx);
HXDLIN( 230)				mat->translate(this->sourceSize->y,( (Float)(0) ));
            			}
            			else {
HXLINE( 230)				bool _hx_tmp;
HXDLIN( 230)				if ((rotation != -90)) {
HXLINE( 230)					_hx_tmp = (rotation == -90);
            				}
            				else {
...
HXLINE( 230)					mat->setTo(mat->b,-(mat->a),mat->d,-(mat->c),mat->ty,-(mat->tx));
HXDLIN( 230)					mat->translate(( (Float)(0) ),this->sourceSize->x);
            				}
            			}
            		}
HXDLIN( 230)		if (flipX) {
HXLINE( 230)			mat->scale(( (Float)(-1) ),( (Float)(1) ));
HXDLIN( 230)			mat->translate(( (Float)(w) ),( (Float)(0) ));
            		}
HXDLIN( 230)		if (flipY) {
HXLINE( 230)			mat->scale(( (Float)(1) ),( (Float)(-1) ));
HXDLIN( 230)			mat->translate(( (Float)(0) ),( (Float)(h) ));
            		}
...
HXLINE( 251)		mat->a = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,0)) );
HXLINE( 252)		mat->b = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,1)) );
HXLINE( 253)		mat->c = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,2)) );
HXLINE( 254)		mat->d = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,3)) );
HXLINE( 255)		mat->tx = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,4)) );
HXLINE( 256)		mat->ty = ( (Float)(_hx_array_unsafe_get(this->tileMatrix,5)) );
...
HXDLIN( 264)		if ((rotation != 0)) {
HXLINE( 264)			int t = w;
HXDLIN( 264)			w = h;
HXDLIN( 264)			h = t;
HXDLIN( 264)			if ((rotation == 90)) {
HXLINE( 264)				mat->setTo(-(mat->b),mat->a,-(mat->d),mat->c,-(mat->ty),mat->tx);
HXDLIN( 264)				mat->translate(this->sourceSize->y,( (Float)(0) ));
            			}
            			else {
HXLINE( 264)				bool _hx_tmp2;
HXDLIN( 264)				if ((rotation != -90)) {
HXLINE( 264)					_hx_tmp2 = (rotation == -90);
            				}
            				else {
...
HXLINE( 264)					mat->setTo(mat->b,-(mat->a),mat->d,-(mat->c),mat->ty,-(mat->tx));
HXDLIN( 264)					mat->translate(( (Float)(0) ),this->sourceSize->x);
            				}
            			}
            		}
HXDLIN( 264)		if (doFlipX) {
HXLINE( 264)			mat->scale(( (Float)(-1) ),( (Float)(1) ));
HXDLIN( 264)			mat->translate(( (Float)(w) ),( (Float)(0) ));
            		}
HXDLIN( 264)		if (doFlipY) {
HXLINE( 264)			mat->scale(( (Float)(1) ),( (Float)(-1) ));
HXDLIN( 264)			mat->translate(( (Float)(0) ),( (Float)(h) ));
            		}
...
HXLINE( 269)		mat->a = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,0)) );
HXLINE( 270)		mat->b = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,1)) );
HXLINE( 271)		mat->c = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,2)) );
HXLINE( 272)		mat->d = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,3)) );
HXLINE( 273)		mat->tx = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,4)) );
HXLINE( 274)		mat->ty = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,5)) );
...
HXLINE( 296)			point->setTo(( (Float)(0) ),( (Float)(0) ));
            		}
...
HXDLIN( 299)		if (bmd2) {
HXLINE( 299)			bmd1 = ::flixel::util::FlxDestroyUtil_obj::disposeIfNotEqual(bmd1,( (Float)(w) ),( (Float)(h) ));
            		}
...
HXDLIN( 299)		if (bmd3) {
HXLINE( 299)			this->rect->setTo(point->x,point->y,( (Float)(w) ),( (Float)(h) ));
HXDLIN( 299)			bmd1->fillRect(this->rect,0);
            		}
            		else {
HXLINE( 299)			if (hx::IsNull( bmd1 )) {
HXLINE( 299)				bmd1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,0);
            			}
            		}
HXDLIN( 299)		bmd = bmd1;
HXLINE( 301)		if ((this->type == 2)) {
HXLINE( 302)			return bmd;
            		}
HXLINE( 304)		if ((this->angle == 0)) {
HXLINE( 306)			{
...
HXDLIN( 313)				mat->a = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,0)) );
HXDLIN( 313)				mat->b = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,1)) );
HXDLIN( 313)				mat->c = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,2)) );
HXDLIN( 313)				mat->d = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,3)) );
HXDLIN( 313)				mat->tx = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,4)) );
HXDLIN( 313)				mat->ty = ( (Float)(_hx_array_unsafe_get(this->blitMatrix,5)) );
            			}
...
HXDLIN( 315)			{
HXLINE( 315)				Float x1 = (((p1->x * mat1->a) + (p1->y * mat1->c)) + mat1->tx);
HXDLIN( 315)				Float y1 = (((p1->x * mat1->b) + (p1->y * mat1->d)) + mat1->ty);
HXDLIN( 315)				p1->set(x1,y1);
            			}
HXDLIN( 315)			{
HXLINE( 315)				Float x11 = (((p2->x * mat1->a) + (p2->y * mat1->c)) + mat1->tx);
HXDLIN( 315)				Float y11 = (((p2->x * mat1->b) + (p2->y * mat1->d)) + mat1->ty);
HXDLIN( 315)				p2->set(x11,y11);
            			}
HXDLIN( 315)			 ::flixel::math::FlxRect _this4 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 315)			_this4->x = ( (Float)(0) );
HXDLIN( 315)			_this4->y = ( (Float)(0) );
HXDLIN( 315)			_this4->width = ( (Float)(0) );
HXDLIN( 315)			_this4->height = ( (Float)(0) );
...
HXDLIN( 341)		if ((this->type == 2)) {
HXLINE( 341)			_hx_tmp = (rotation == 0);
            		}
            		else {
...
HXLINE( 347)			point->setTo(( (Float)(0) ),( (Float)(0) ));
            		}
...
HXDLIN( 350)		if (bmd2) {
HXLINE( 350)			bmd1 = ::flixel::util::FlxDestroyUtil_obj::disposeIfNotEqual(bmd1,( (Float)(w) ),( (Float)(h) ));
            		}
...
HXDLIN( 350)		if (bmd3) {
HXLINE( 350)			this->rect->setTo(point->x,point->y,( (Float)(w) ),( (Float)(h) ));
HXDLIN( 350)			bmd1->fillRect(this->rect,0);
            		}
            		else {
HXLINE( 350)			if (hx::IsNull( bmd1 )) {
HXLINE( 350)				bmd1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,0);
            			}
            		}
HXDLIN( 350)		bmd = bmd1;
HXLINE( 352)		if ((this->type == 2)) {
...
HXDLIN( 360)		{
HXLINE( 360)			Float x1 = (((p1->x * mat->a) + (p1->y * mat->c)) + mat->tx);
HXDLIN( 360)			Float y1 = (((p1->x * mat->b) + (p1->y * mat->d)) + mat->ty);
HXDLIN( 360)			p1->set(x1,y1);
            		}
HXDLIN( 360)		{
HXLINE( 360)			Float x11 = (((p2->x * mat->a) + (p2->y * mat->c)) + mat->tx);
HXDLIN( 360)			Float y11 = (((p2->x * mat->b) + (p2->y * mat->d)) + mat->ty);
HXDLIN( 360)			p2->set(x11,y11);
            		}
HXDLIN( 360)		 ::flixel::math::FlxRect _this2 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 360)		_this2->x = ( (Float)(0) );
HXDLIN( 360)		_this2->y = ( (Float)(0) );
HXDLIN( 360)		_this2->width = ( (Float)(0) );
HXDLIN( 360)		_this2->height = ( (Float)(0) );
...
HXLINE( 393)			bmd = ::flixel::util::FlxDestroyUtil_obj::disposeIfNotEqual(bmd,( (Float)(w) ),( (Float)(h) ));
            		}
...
HXLINE( 397)			this->rect->setTo(point->x,point->y,( (Float)(w) ),( (Float)(h) ));
HXLINE( 398)			bmd->fillRect(this->rect,0);
            		}
            		else {
HXLINE( 400)			if (hx::IsNull( bmd )) {
HXLINE( 402)				bmd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,w,h,true,0);
            			}
            		}
...
HXLINE( 420)		{
HXLINE( 420)			Float x1 = (((p1->x * mat->a) + (p1->y * mat->c)) + mat->tx);
HXDLIN( 420)			Float y1 = (((p1->x * mat->b) + (p1->y * mat->d)) + mat->ty);
HXDLIN( 420)			p1->set(x1,y1);
            		}
HXLINE( 421)		{
HXLINE( 421)			Float x11 = (((p2->x * mat->a) + (p2->y * mat->c)) + mat->tx);
HXDLIN( 421)			Float y11 = (((p2->x * mat->b) + (p2->y * mat->d)) + mat->ty);
HXDLIN( 421)			p2->set(x11,y11);
            		}
HXLINE( 423)		 ::flixel::math::FlxRect _this2 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 423)		_this2->x = ( (Float)(0) );
HXDLIN( 423)		_this2->y = ( (Float)(0) );
HXDLIN( 423)		_this2->width = ( (Float)(0) );
HXDLIN( 423)		_this2->height = ( (Float)(0) );
...
HXLINE( 452)		if ((this->type == 2)) {
HXLINE( 454)			frameToFill->type = 2;
HXLINE( 455)			frameToFill->offset->set(0,0);
HXLINE( 456)			return frameToFill;
            		}
HXLINE( 459)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 459)		_this->x = ( (Float)(0) );
HXDLIN( 459)		_this->y = ( (Float)(0) );
HXDLIN( 459)		_this->width = ( (Float)(0) );
HXDLIN( 459)		_this->height = ( (Float)(0) );
...
HXLINE( 460)		if ((this->angle != 0)) {
HXLINE( 462)			clippedRect->width = this->frame->height;
HXLINE( 463)			clippedRect->height = this->frame->width;
            		}
HXLINE( 466)		Float ox = ::Math_obj::max(this->offset->x,( (Float)(0) ));
HXLINE( 467)		Float oy = ::Math_obj::max(this->offset->y,( (Float)(0) ));
HXLINE( 469)		{
...
HXDLIN( 474)		if ((frameRect->width != 0)) {
HXLINE( 474)			_hx_tmp = (frameRect->height == 0);
            		}
            		else {
HXLINE( 474)			_hx_tmp = true;
            		}
HXDLIN( 474)		if (_hx_tmp) {
HXLINE( 476)			frameToFill->type = 2;
HXLINE( 477)			{
HXLINE( 477)				frameRect->x = ( (Float)(0) );
HXDLIN( 477)				frameRect->y = ( (Float)(0) );
HXDLIN( 477)				frameRect->width = ( (Float)(0) );
HXDLIN( 477)				frameRect->height = ( (Float)(0) );
            			}
HXLINE( 478)			frameToFill->set_frame(frameRect);
HXLINE( 479)			frameToFill->offset->set(0,0);
            		}
            		else {
HXLINE( 483)			frameToFill->type = 0;
...
HXLINE( 494)				this->matrix->translate(this->frame->width,( (Float)(0) ));
            			}
            			else {
HXLINE( 496)				if ((this->angle == 90)) {
HXLINE( 498)					{
...
HXLINE( 499)					this->matrix->translate(( (Float)(0) ),this->frame->height);
            				}
            			}
HXLINE( 502)			if ((this->angle != 0)) {
HXLINE( 504)				{
HXLINE( 504)					 ::openfl::geom::Matrix matrix = this->matrix;
HXDLIN( 504)					Float x1 = (((p1->x * matrix->a) + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 504)					Float y1 = (((p1->x * matrix->b) + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 504)					p1->set(x1,y1);
            				}
HXLINE( 505)				{
HXLINE( 505)					 ::openfl::geom::Matrix matrix1 = this->matrix;
HXDLIN( 505)					Float x11 = (((p2->x * matrix1->a) + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 505)					Float y11 = (((p2->x * matrix1->b) + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 505)					p2->set(x11,y11);
            				}
            			}
HXLINE( 508)			{
...
HXDLIN( 526)		Float Width = (this->sourceSize->x - (( (Float)(2) ) * border->x));
HXDLIN( 526)		Float Height = (this->sourceSize->y - (( (Float)(2) ) * border->y));
...
HXLINE( 558)		if ((this->type == 2)) {
HXLINE( 560)			clippedFrame->type = 2;
HXLINE( 561)			clippedFrame->offset->set(0,0);
HXLINE( 562)			return clippedFrame;
            		}
HXLINE( 565)		 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 565)		_this1->x = ( (Float)(0) );
HXDLIN( 565)		_this1->y = ( (Float)(0) );
HXDLIN( 565)		_this1->width = ( (Float)(0) );
HXDLIN( 565)		_this1->height = ( (Float)(0) );
...
HXDLIN( 576)		if ((frameRect->width != 0)) {
HXLINE( 576)			_hx_tmp = (frameRect->height == 0);
            		}
            		else {
HXLINE( 576)			_hx_tmp = true;
            		}
HXDLIN( 576)		if (_hx_tmp) {
HXLINE( 578)			clippedFrame->type = 2;
HXLINE( 579)			{
HXLINE( 579)				frameRect->x = ( (Float)(0) );
HXDLIN( 579)				frameRect->y = ( (Float)(0) );
HXDLIN( 579)				frameRect->width = ( (Float)(0) );
HXDLIN( 579)				frameRect->height = ( (Float)(0) );
            			}
HXLINE( 580)			clippedFrame->set_frame(frameRect);
HXLINE( 581)			clippedFrame->offset->set(0,0);
            		}
            		else {
HXLINE( 585)			clippedFrame->type = 0;
...
HXLINE( 596)				this->matrix->translate(this->frame->width,( (Float)(0) ));
            			}
            			else {
HXLINE( 598)				if ((this->angle == 90)) {
HXLINE( 600)					{
...
HXLINE( 601)					this->matrix->translate(( (Float)(0) ),this->frame->height);
            				}
            			}
HXLINE( 604)			if ((this->angle != 0)) {
HXLINE( 606)				{
HXLINE( 606)					 ::openfl::geom::Matrix matrix = this->matrix;
HXDLIN( 606)					Float x1 = (((p1->x * matrix->a) + (p1->y * matrix->c)) + matrix->tx);
HXDLIN( 606)					Float y1 = (((p1->x * matrix->b) + (p1->y * matrix->d)) + matrix->ty);
HXDLIN( 606)					p1->set(x1,y1);
            				}
HXLINE( 607)				{
HXLINE( 607)					 ::openfl::geom::Matrix matrix1 = this->matrix;
HXDLIN( 607)					Float x11 = (((p2->x * matrix1->a) + (p2->y * matrix1->c)) + matrix1->tx);
HXDLIN( 607)					Float y11 = (((p2->x * matrix1->b) + (p2->y * matrix1->d)) + matrix1->ty);
HXDLIN( 607)					p2->set(x11,y11);
            				}
            			}
HXLINE( 610)			{
...
HXDLIN( 643)		_this2->x = ( (Float)(0) );
HXDLIN( 643)		_this2->y = ( (Float)(0) );
HXDLIN( 643)		_this2->width = ( (Float)(0) );
HXDLIN( 643)		_this2->height = ( (Float)(0) );
