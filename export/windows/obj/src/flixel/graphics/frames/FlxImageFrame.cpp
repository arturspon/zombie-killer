...
HXLINE( 238)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
static hx::StorageInfo FlxImageFrame_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*  ::flixel::graphics::frames::FlxFrame */ ,(int)offsetof(FlxImageFrame_obj,frame),HX_("frame",2d,78,83,06)},
	{ hx::fsUnknown, 0, null()}
};
