...
HXLINE( 142)				i = (i + 1);
HXDLIN( 142)				basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 162)			i = (i + 1);
HXDLIN( 162)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 181)			i = (i + 1);
HXDLIN( 181)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 264)		if ((this->members->indexOf(object,null()) >= 0)) {
...
HXLINE( 332)				basic = ( ( ::flixel::FlxBasic)(this->members->__get(this->_marker++)) );
HXLINE( 334)				if ((this->_marker >= this->maxSize)) {
HXLINE( 335)					this->_marker = 0;
            				}
...
HXLINE( 386)		if ((index < 0)) {
HXLINE( 387)			return null();
            		}
HXLINE( 389)		if (Splice) {
HXLINE( 391)			this->members->splice(index,1);
...
HXLINE( 459)			i = (i + 1);
HXDLIN( 459)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 467)				return this->members->__get((i - 1));
            			}
            		}
...
HXLINE( 507)			i = (i + 1);
HXDLIN( 507)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 529)			i = (i + 1);
HXDLIN( 529)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 551)			i = (i + 1);
HXDLIN( 551)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 624)		if ((StartIndex < 0)) {
HXLINE( 625)			StartIndex = 0;
            		}
HXLINE( 626)		if ((Length <= 0)) {
...
HXLINE( 663)			i = (i + 1);
HXDLIN( 663)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 682)			i = (i + 1);
HXDLIN( 682)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 712)			i = (i + 1);
HXDLIN( 712)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 741)			i = (i + 1);
HXDLIN( 741)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 770)			i = (i + 1);
HXDLIN( 770)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 799)			i = (i + 1);
HXDLIN( 799)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 829)			i = (i + 1);
HXDLIN( 829)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
...
HXLINE( 849)		this->maxSize = ::Std_obj::_hx_int(::Math_obj::abs(( (Float)(Size) )));
HXLINE( 851)		if ((this->_marker >= this->maxSize)) {
HXLINE( 852)			this->_marker = 0;
            		}
HXLINE( 854)		bool _hx_tmp;
HXDLIN( 854)		bool _hx_tmp1;
HXDLIN( 854)		if ((this->maxSize != 0)) {
...
HXLINE( 864)			i = (i + 1);
HXDLIN( 864)			basic = ( ( ::flixel::FlxBasic)(this->members->__get((i - 1))) );
