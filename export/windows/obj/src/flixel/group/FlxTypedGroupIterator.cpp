...
HXDLIN( 922)			return this->_groupMembers->__get(this->_cursor++);
            		}
            		else {
...
HXLINE( 927)						_hx_tmp = !(( (bool)(this->_filter(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
