...
HXLINE( 201)		this->pressed = createKeyList(1,hx::ObjectPtr<OBJ_>(this));
HXLINE( 202)		this->justPressed = createKeyList(2,hx::ObjectPtr<OBJ_>(this));
HXLINE( 203)		this->justReleased = createKeyList(-1,hx::ObjectPtr<OBJ_>(this));
            	}
...
HXDLIN(  50)		return this->checkKeyArrayState(KeyArray,1);
            	}
...
HXDLIN(  61)		return this->checkKeyArrayState(KeyArray,2);
            	}
...
HXDLIN(  72)		return this->checkKeyArrayState(KeyArray,-1);
            	}
...
HXLINE(  84)					if ((key->current != 1)) {
HXLINE(  84)						_hx_tmp = (key->current == 2);
            					}
            					else {
...
HXLINE( 101)					_hx_tmp = (key->current == 2);
            				}
            				else {
...
HXLINE( 118)					_hx_tmp = (key->current == -1);
            				}
            				else {
...
HXLINE( 135)		 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );
...
HXLINE( 165)					if ((key->current != 1)) {
HXLINE( 165)						_hx_tmp = (key->current == 2);
            					}
            					else {
...
HXDLIN( 234)				_g = (_g + 1);
HXLINE( 236)				 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(code)) );
...
HXLINE( 260)			 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(c)) );
...
HXLINE( 274)			 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(c)) );
...
HXLINE( 280)		 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(keyCode)) );
...
HXLINE( 281)			_hx_tmp = (this->preventDefaultKeys->indexOf(key->ID,null()) != -1);
            		}
            		else {
...
HXLINE( 306)						_hx_tmp = hx::IsEq( key,-2 );
            					}
            					else {
...
HXLINE( 325)		 ::flixel::input::FlxInput key = ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );
...
HXDLIN( 352)		return ( ( ::flixel::input::FlxInput)(this->_keyListMap->get(KeyCode)) );
            	}
