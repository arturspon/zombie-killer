...
HXLINE(  62)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  62)			point1->_inPool = false;
HXDLIN(  62)			point = point1;
            		}
HXLINE(  65)		point->set_x((((( (Float)(this->_globalScreenX) ) - Camera->x) + ((((Float)0.5) * ( (Float)(Camera->width) )) * (Camera->zoom - Camera->initialZoom))) / Camera->zoom));
HXLINE(  66)		point->set_y((((( (Float)(this->_globalScreenY) ) - Camera->y) + ((((Float)0.5) * ( (Float)(Camera->height) )) * (Camera->zoom - Camera->initialZoom))) / Camera->zoom));
...
HXLINE(  85)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  85)			point1->_inPool = false;
HXDLIN(  85)			point = point1;
            		}
HXLINE(  87)		point->set_x((((( (Float)(this->_globalScreenX) ) - Camera->x) / Camera->zoom) + Camera->viewOffsetX));
HXLINE(  88)		point->set_y((((( (Float)(this->_globalScreenY) ) - Camera->y) / Camera->zoom) + Camera->viewOffsetY));
...
HXLINE(  99)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 133)			result[0] = _hx_tmp;
            		}
HXLINE( 136)		return result->__get(0);
            	}
...
HXLINE( 145)		this->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXLINE( 146)		this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
