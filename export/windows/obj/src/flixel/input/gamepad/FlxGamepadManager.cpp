...
HXLINE( 338)		{
HXLINE( 338)			int _g = 0;
HXDLIN( 338)			int _g1 = ::openfl::ui::GameInput_obj::numDevices;
...
HXLINE( 113)			{
HXLINE( 113)				int _g = 0;
HXDLIN( 113)				int _g1 = this->_activeGamepads->length;
...
HXDLIN( 222)		return this->anyHasState(buttonID,1);
            	}
...
HXDLIN( 230)		return this->anyHasState(buttonID,2);
            	}
...
HXDLIN( 238)		return this->anyHasState(buttonID,-1);
            	}
...
HXDLIN( 244)								switch((int)(state)){
            									case (int)-1: {
HXLINE( 244)										_hx_tmp = (value == -1);
            									}
            									break;
            									case (int)0: {
HXLINE( 244)										_hx_tmp = (value == 0);
            									}
            									break;
            									case (int)1: {
HXLINE( 244)										_hx_tmp = (value == 1);
...
HXLINE( 285)				if ((value != 0)) {
HXLINE( 286)					return value;
            				}
            			}
            		}
HXLINE( 289)		return ( (Float)(0) );
            	}
...
HXLINE( 359)		{
HXLINE( 359)			int _g = 0;
HXDLIN( 359)			int _g1 = ::openfl::ui::GameInput_obj::numDevices;
...
HXLINE( 401)		if ((name.indexOf(HX_("ouya",6e,e0,b7,49),null()) != -1)) {
HXLINE( 401)			return ::flixel::input::gamepad::FlxGamepadModel_obj::OUYA_dyn();
            		}
            		else {
HXLINE( 402)			bool _hx_tmp;
HXDLIN( 402)			if ((name.indexOf(HX_("wireless controller",5e,0b,31,72),null()) == -1)) {
HXLINE( 402)				_hx_tmp = (name.indexOf(HX_("ps4",d1,60,55,00),null()) != -1);
            			}
            			else {
...
HXLINE( 403)				if ((name.indexOf(HX_("logitech",3b,70,e5,19),null()) != -1)) {
HXLINE( 403)					return ::flixel::input::gamepad::FlxGamepadModel_obj::LOGITECH_dyn();
            				}
            				else {
HXLINE( 404)					bool _hx_tmp1;
HXDLIN( 404)					if ((name.indexOf(HX_("xbox",93,58,9c,4f),null()) != -1)) {
HXLINE( 404)						_hx_tmp1 = (name.indexOf(HX_("360",2d,e2,26,00),null()) != -1);
            					}
            					else {
...
HXLINE( 405)						if ((name.indexOf(HX_("xinput",92,10,f1,b8),null()) != -1)) {
HXLINE( 405)							return ::flixel::input::gamepad::FlxGamepadModel_obj::XINPUT_dyn();
            						}
            						else {
HXLINE( 406)							if ((name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null()) != -1)) {
HXLINE( 406)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 407)								if ((name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null()) != -1)) {
HXLINE( 407)									return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 408)									if ((name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null()) != -1)) {
HXLINE( 408)										return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            									}
            									else {
HXLINE( 409)										if ((name.indexOf(HX_("mfi",f0,0e,53,00),null()) != -1)) {
...
HXLINE( 418)		{
HXLINE( 418)			int _g = 0;
HXDLIN( 418)			int _g1 = this->_gamepads->length;
...
static hx::StorageInfo FlxGamepadManager_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(FlxGamepadManager_obj,numActiveGamepads),HX_("numActiveGamepads",7e,81,36,4b)},
...
static ::String FlxGamepadManager_obj_sMemberFields[] = {
	...
	HX_("numActiveGamepads",7e,81,36,4b),
