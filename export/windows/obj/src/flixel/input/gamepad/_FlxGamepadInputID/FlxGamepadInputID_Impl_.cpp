...
HXLINE( 115)			return ::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::fromStringMap->get_int(s);
            		}
            		else {
HXLINE( 115)			return -1;
            		}
...
HXDLIN( 121)		return ::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::toStringMap->get_string(this1);
            	}
...
HXDLIN(  53)			_g->set(HX_("A",41,00,00,00),0);
HXDLIN(  53)			_g->set(HX_("B",42,00,00,00),1);
HXDLIN(  53)			_g->set(HX_("X",58,00,00,00),2);
HXDLIN(  53)			_g->set(HX_("Y",59,00,00,00),3);
HXDLIN(  53)			_g->set(HX_("LEFT_SHOULDER",d8,b1,a9,01),4);
HXDLIN(  53)			_g->set(HX_("RIGHT_SHOULDER",83,9f,28,11),5);
HXDLIN(  53)			_g->set(HX_("BACK",27,a2,d1,2b),6);
HXDLIN(  53)			_g->set(HX_("START",42,ac,f9,01),7);
HXDLIN(  53)			_g->set(HX_("LEFT_STICK_CLICK",21,9d,4a,bf),8);
HXDLIN(  53)			_g->set(HX_("RIGHT_STICK_CLICK",56,4c,25,0b),9);
HXDLIN(  53)			_g->set(HX_("GUIDE",9c,f2,d9,19),10);
HXDLIN(  53)			_g->set(HX_("DPAD_UP",6b,00,87,a2),11);
HXDLIN(  53)			_g->set(HX_("DPAD_DOWN",72,1a,5b,87),12);
HXDLIN(  53)			_g->set(HX_("DPAD_LEFT",17,2a,9d,8c),13);
HXDLIN(  53)			_g->set(HX_("DPAD_RIGHT",ac,b7,f4,f3),14);
HXDLIN(  53)			_g->set(HX_("LEFT_TRIGGER_BUTTON",f1,61,33,1b),15);
HXDLIN(  53)			_g->set(HX_("RIGHT_TRIGGER_BUTTON",dc,61,f8,02),16);
HXDLIN(  53)			_g->set(HX_("LEFT_TRIGGER",a0,31,c6,eb),17);
HXDLIN(  53)			_g->set(HX_("RIGHT_TRIGGER",55,e2,81,00),18);
HXDLIN(  53)			_g->set(HX_("LEFT_ANALOG_STICK",19,49,58,a5),19);
HXDLIN(  53)			_g->set(HX_("RIGHT_ANALOG_STICK",44,e8,d6,b8),20);
HXDLIN(  53)			_g->set(HX_("DPAD",6f,6f,2f,2d),21);
HXDLIN(  53)			_g->set(HX_("TILT_PITCH",de,59,c1,1b),26);
HXDLIN(  53)			_g->set(HX_("TILT_ROLL",ff,5e,73,5e),27);
HXDLIN(  53)			_g->set(HX_("POINTER_X",f6,08,fa,28),28);
HXDLIN(  53)			_g->set(HX_("POINTER_Y",f7,08,fa,28),29);
HXDLIN(  53)			_g->set(HX_("EXTRA_0",61,a1,be,f8),30);
HXDLIN(  53)			_g->set(HX_("EXTRA_1",62,a1,be,f8),31);
HXDLIN(  53)			_g->set(HX_("EXTRA_2",63,a1,be,f8),32);
HXDLIN(  53)			_g->set(HX_("EXTRA_3",64,a1,be,f8),33);
HXDLIN(  53)			_g->set(HX_("LEFT_STICK_DIGITAL_UP",29,d8,3b,d5),34);
HXDLIN(  53)			_g->set(HX_("LEFT_STICK_DIGITAL_RIGHT",ae,ca,36,04),35);
HXDLIN(  53)			_g->set(HX_("LEFT_STICK_DIGITAL_DOWN",b0,dd,c3,72),36);
HXDLIN(  53)			_g->set(HX_("LEFT_STICK_DIGITAL_LEFT",55,ed,05,78),37);
HXDLIN(  53)			_g->set(HX_("RIGHT_STICK_DIGITAL_UP",d4,e8,30,f8),38);
HXDLIN(  53)			_g->set(HX_("RIGHT_STICK_DIGITAL_RIGHT",e3,36,d3,6c),39);
HXDLIN(  53)			_g->set(HX_("RIGHT_STICK_DIGITAL_DOWN",1b,af,9e,09),40);
HXDLIN(  53)			_g->set(HX_("RIGHT_STICK_DIGITAL_LEFT",c0,be,e0,0e),41);
HXDLIN(  53)			return _g;
            		}
...
HXDLIN(  53)			_g->set(0,HX_("A",41,00,00,00));
HXDLIN(  53)			_g->set(1,HX_("B",42,00,00,00));
HXDLIN(  53)			_g->set(2,HX_("X",58,00,00,00));
HXDLIN(  53)			_g->set(3,HX_("Y",59,00,00,00));
HXDLIN(  53)			_g->set(4,HX_("LEFT_SHOULDER",d8,b1,a9,01));
HXDLIN(  53)			_g->set(5,HX_("RIGHT_SHOULDER",83,9f,28,11));
HXDLIN(  53)			_g->set(6,HX_("BACK",27,a2,d1,2b));
HXDLIN(  53)			_g->set(7,HX_("START",42,ac,f9,01));
HXDLIN(  53)			_g->set(8,HX_("LEFT_STICK_CLICK",21,9d,4a,bf));
HXDLIN(  53)			_g->set(9,HX_("RIGHT_STICK_CLICK",56,4c,25,0b));
HXDLIN(  53)			_g->set(10,HX_("GUIDE",9c,f2,d9,19));
HXDLIN(  53)			_g->set(11,HX_("DPAD_UP",6b,00,87,a2));
HXDLIN(  53)			_g->set(12,HX_("DPAD_DOWN",72,1a,5b,87));
HXDLIN(  53)			_g->set(13,HX_("DPAD_LEFT",17,2a,9d,8c));
HXDLIN(  53)			_g->set(14,HX_("DPAD_RIGHT",ac,b7,f4,f3));
HXDLIN(  53)			_g->set(15,HX_("LEFT_TRIGGER_BUTTON",f1,61,33,1b));
HXDLIN(  53)			_g->set(16,HX_("RIGHT_TRIGGER_BUTTON",dc,61,f8,02));
HXDLIN(  53)			_g->set(17,HX_("LEFT_TRIGGER",a0,31,c6,eb));
HXDLIN(  53)			_g->set(18,HX_("RIGHT_TRIGGER",55,e2,81,00));
HXDLIN(  53)			_g->set(19,HX_("LEFT_ANALOG_STICK",19,49,58,a5));
HXDLIN(  53)			_g->set(20,HX_("RIGHT_ANALOG_STICK",44,e8,d6,b8));
HXDLIN(  53)			_g->set(21,HX_("DPAD",6f,6f,2f,2d));
HXDLIN(  53)			_g->set(26,HX_("TILT_PITCH",de,59,c1,1b));
HXDLIN(  53)			_g->set(27,HX_("TILT_ROLL",ff,5e,73,5e));
HXDLIN(  53)			_g->set(28,HX_("POINTER_X",f6,08,fa,28));
HXDLIN(  53)			_g->set(29,HX_("POINTER_Y",f7,08,fa,28));
HXDLIN(  53)			_g->set(30,HX_("EXTRA_0",61,a1,be,f8));
HXDLIN(  53)			_g->set(31,HX_("EXTRA_1",62,a1,be,f8));
HXDLIN(  53)			_g->set(32,HX_("EXTRA_2",63,a1,be,f8));
HXDLIN(  53)			_g->set(33,HX_("EXTRA_3",64,a1,be,f8));
HXDLIN(  53)			_g->set(34,HX_("LEFT_STICK_DIGITAL_UP",29,d8,3b,d5));
HXDLIN(  53)			_g->set(35,HX_("LEFT_STICK_DIGITAL_RIGHT",ae,ca,36,04));
HXDLIN(  53)			_g->set(36,HX_("LEFT_STICK_DIGITAL_DOWN",b0,dd,c3,72));
HXDLIN(  53)			_g->set(37,HX_("LEFT_STICK_DIGITAL_LEFT",55,ed,05,78));
HXDLIN(  53)			_g->set(38,HX_("RIGHT_STICK_DIGITAL_UP",d4,e8,30,f8));
HXDLIN(  53)			_g->set(39,HX_("RIGHT_STICK_DIGITAL_RIGHT",e3,36,d3,6c));
HXDLIN(  53)			_g->set(40,HX_("RIGHT_STICK_DIGITAL_DOWN",1b,af,9e,09));
HXDLIN(  53)			_g->set(41,HX_("RIGHT_STICK_DIGITAL_LEFT",c0,be,e0,0e));
HXDLIN(  53)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)
...
HXDLIN(  42)		LEFT_STICK_CLICK = 8;
            	}
{
            	HX_STACKFRAME(&_hx_pos_92ec9d1968218ffd_44_boot)
HXDLIN(  44)		RIGHT_STICK_CLICK = 9;
            	}
{
