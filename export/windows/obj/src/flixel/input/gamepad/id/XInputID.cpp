...
HXDLIN(  69)		DPAD_UP = 17;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_70_boot)
HXDLIN(  70)		DPAD_DOWN = 18;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_71_boot)
HXDLIN(  71)		DPAD_LEFT = 19;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_72_boot)
HXDLIN(  72)		DPAD_RIGHT = 20;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_559677d855d318da_74_boot)
HXDLIN(  74)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,0,1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  75)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,2,3, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  77)		LEFT_TRIGGER = 4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_78_boot)
HXDLIN(  78)		RIGHT_TRIGGER = 5;
            	}
}
