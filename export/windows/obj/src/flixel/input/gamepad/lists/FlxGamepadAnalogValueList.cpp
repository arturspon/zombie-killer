...
HXDLIN(  14)		return _this->getAnalogXAxisValue(_this->mapping->getAnalogStick(19));
            	}
...
HXDLIN(  15)		return _this->getYAxisRaw(_this->mapping->getAnalogStick(19));
            	}
...
HXDLIN(  16)		return _this->getAnalogXAxisValue(_this->mapping->getAnalogStick(20));
            	}
...
HXDLIN(  17)		return _this->getYAxisRaw(_this->mapping->getAnalogStick(20));
            	}
...
HXDLIN(  18)		return this->gamepad->getAxis(17);
            	}
...
HXDLIN(  19)		return this->gamepad->getAxis(18);
            	}
...
HXDLIN(  21)		return this->gamepad->getAxis(28);
            	}
...
HXDLIN(  22)		return this->gamepad->getAxis(29);
            	}
