...
HXLINE( 161)		this->_prevY = 0;
HXLINE( 160)		this->_prevX = 0;
HXLINE( 154)		this->_lastWheel = 0;
HXLINE( 153)		this->_lastY = 0;
HXLINE( 152)		this->_lastX = 0;
...
HXLINE( 405)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-1);
...
HXLINE( 412)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-2);
HXLINE( 413)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-3);
...
HXLINE( 197)			Graphic =  ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null());
            		}
...
HXLINE( 214)					this->_cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null()),null(),null());
            				}
            			}
            		}
HXLINE( 217)		this->_cursor->set_x(( (Float)(XOffset) ));
HXLINE( 218)		this->_cursor->set_y(( (Float)(YOffset) ));
...
HXDLIN( 439)			this->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 439)			this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
...
HXDLIN( 527)		if ((_this->current != 1)) {
HXDLIN( 527)			return (_this->current == 2);
            		}
            		else {
...
HXDLIN( 528)		return (this->_leftButton->current == 2);
            	}
...
HXDLIN( 529)		return (this->_leftButton->current == -1);
            	}
...
HXDLIN( 533)		if ((_this->current != 1)) {
HXDLIN( 533)			return (_this->current == 2);
            		}
            		else {
...
HXDLIN( 534)		return (this->_rightButton->current == 2);
            	}
...
HXDLIN( 535)		return (this->_rightButton->current == -1);
            	}
...
HXDLIN( 538)		if ((_this->current != 1)) {
HXDLIN( 538)			return (_this->current == 2);
            		}
            		else {
...
HXDLIN( 539)		return (this->_middleButton->current == 2);
            	}
...
HXDLIN( 540)		return (this->_middleButton->current == -1);
            	}
...
HXDLIN( 643)		if ((this->_lastLeftButtonState != 1)) {
HXLINE( 643)			_hx_tmp1 = (this->_lastLeftButtonState == 2);
            		}
            		else {
HXLINE( 643)			_hx_tmp1 = true;
            		}
HXDLIN( 643)		if (_hx_tmp1) {
HXLINE( 644)			if ((Record->button != 0)) {
HXLINE( 643)				_hx_tmp = (Record->button == -1);
            			}
            			else {
