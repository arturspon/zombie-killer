...
HXLINE( 253)		Float maxX = ::Math_obj::max((this->x + this->width),(Rect->x + Rect->width));
HXLINE( 254)		Float maxY = ::Math_obj::max((this->y + this->height),(Rect->y + Rect->height));
...
HXLINE( 265)		this->x = ( (Float)(::Math_obj::floor(this->x)) );
HXLINE( 266)		this->y = ( (Float)(::Math_obj::floor(this->y)) );
HXLINE( 267)		this->width = ( (Float)(::Math_obj::floor(this->width)) );
HXLINE( 268)		this->height = ( (Float)(::Math_obj::floor(this->height)) );
...
HXLINE( 277)		this->x = ( (Float)(::Math_obj::ceil(this->x)) );
HXLINE( 278)		this->y = ( (Float)(::Math_obj::ceil(this->y)) );
HXLINE( 279)		this->width = ( (Float)(::Math_obj::ceil(this->width)) );
HXLINE( 280)		this->height = ( (Float)(::Math_obj::ceil(this->height)) );
...
HXLINE( 289)		this->x = ( (Float)(::Math_obj::round(this->x)) );
HXLINE( 290)		this->y = ( (Float)(::Math_obj::round(this->y)) );
HXLINE( 291)		this->width = ( (Float)(::Math_obj::round(this->width)) );
HXLINE( 292)		this->height = ( (Float)(::Math_obj::round(this->height)) );
...
HXDLIN( 373)			_this->x = ( (Float)(0) );
HXDLIN( 373)			_this->y = ( (Float)(0) );
HXDLIN( 373)			_this->width = ( (Float)(0) );
HXDLIN( 373)			_this->height = ( (Float)(0) );
...
HXDLIN( 453)		if ((this->width != 0)) {
HXDLIN( 453)			return (this->height == 0);
            		}
            		else {
