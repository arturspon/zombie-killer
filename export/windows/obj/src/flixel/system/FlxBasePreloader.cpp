...
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_127_create,"flixel.system.FlxBasePreloader","create",0x550716ea,"flixel.system.FlxBasePreloader.create","flixel/system/FlxBasePreloader.hx",127,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_133_onInit,"flixel.system.FlxBasePreloader","onInit",0xc13cf3bd,"flixel.system.FlxBasePreloader.onInit","flixel/system/FlxBasePreloader.hx",133,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_157_onUpdate,"flixel.system.FlxBasePreloader","onUpdate",0x30e883f6,"flixel.system.FlxBasePreloader.onUpdate","flixel/system/FlxBasePreloader.hx",157,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_166_onEnterFrame,"flixel.system.FlxBasePreloader","onEnterFrame",0x1becfc62,"flixel.system.FlxBasePreloader.onEnterFrame","flixel/system/FlxBasePreloader.hx",166,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_188_destroy,"flixel.system.FlxBasePreloader","destroy",0x24486d4c,"flixel.system.FlxBasePreloader.destroy","flixel/system/FlxBasePreloader.hx",188,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_195_update,"flixel.system.FlxBasePreloader","update",0x5ffd35f7,"flixel.system.FlxBasePreloader.update","flixel/system/FlxBasePreloader.hx",195,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_202_onLoaded,"flixel.system.FlxBasePreloader","onLoaded",0x025245f2,"flixel.system.FlxBasePreloader.onLoaded","flixel/system/FlxBasePreloader.hx",202,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_218_createBitmap,"flixel.system.FlxBasePreloader","createBitmap",0x54baa679,"flixel.system.FlxBasePreloader.createBitmap","flixel/system/FlxBasePreloader.hx",218,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_242_loadBitmapData,"flixel.system.FlxBasePreloader","loadBitmapData",0x15a00d6d,"flixel.system.FlxBasePreloader.loadBitmapData","flixel/system/FlxBasePreloader.hx",242,0x863b5dde)
HX_LOCAL_STACK_FRAME(_hx_pos_dc9b83cdd7f291e2_256_checkSiteLock,"flixel.system.FlxBasePreloader","checkSiteLock",0x5092d9cc,"flixel.system.FlxBasePreloader.checkSiteLock","flixel/system/FlxBasePreloader.hx",256,0x863b5dde)
...
HXLINE(  93)		this->_destroyed = false;
...
HXLINE( 110)		this->minDisplayTime = MinDisplayTime;
HXLINE( 111)		if (hx::IsNotNull( AllowedURLs )) {
HXLINE( 112)			this->allowedURLs = AllowedURLs;
            		}
            		else {
HXLINE( 114)			this->allowedURLs = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 116)		this->_startTime = ::Date_obj::now()->getTime();
HXLINE( 120)		this->onLoaded();
            	}
...
void FlxBasePreloader_obj::create(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_127_create)
            	}
...
void FlxBasePreloader_obj::onInit(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_133_onInit)
HXLINE( 134)		this->super::onInit();
HXLINE( 136)		::openfl::Lib_obj::get_current()->stage->set_scaleMode(2);
HXLINE( 137)		::openfl::Lib_obj::get_current()->stage->align = 6;
HXLINE( 138)		this->create();
HXLINE( 139)		this->addEventListener(HX_("enterFrame",f5,03,50,02),this->onEnterFrame_dyn(),null(),null(),null());
HXLINE( 140)		this->checkSiteLock();
            	}


void FlxBasePreloader_obj::onUpdate(int bytesLoaded,int bytesTotal){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_157_onUpdate)
HXDLIN( 157)		this->super::onUpdate(bytesLoaded,bytesTotal);
            	}


void FlxBasePreloader_obj::onEnterFrame( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_166_onEnterFrame)
HXLINE( 167)		Float time = ::Date_obj::now()->getTime();
HXDLIN( 167)		Float time1 = (time - this->_startTime);
HXLINE( 168)		Float min = (this->minDisplayTime * ( (Float)(1000) ));
HXLINE( 169)		Float percent = this->_percent;
HXLINE( 170)		bool _hx_tmp;
HXDLIN( 170)		if ((min > 0)) {
HXLINE( 170)			_hx_tmp = (this->_percent > (time1 / min));
            		}
            		else {
HXLINE( 170)			_hx_tmp = false;
            		}
HXDLIN( 170)		if (_hx_tmp) {
HXLINE( 171)			percent = (time1 / min);
            		}
HXLINE( 172)		if (!(this->_destroyed)) {
HXLINE( 173)			this->update(percent);
            		}
HXLINE( 175)		bool _hx_tmp1;
HXDLIN( 175)		if (this->_loaded) {
HXLINE( 175)			if (!((min <= 0))) {
HXLINE( 175)				_hx_tmp1 = ((time1 / min) >= 1);
            			}
            			else {
...
HXLINE( 177)			this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->onEnterFrame_dyn(),null());
HXLINE( 178)			this->super::onLoaded();
HXLINE( 179)			this->destroy();
HXLINE( 180)			this->_destroyed = true;
            		}
            	}
...
void FlxBasePreloader_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_188_destroy)
            	}
...
void FlxBasePreloader_obj::update(Float Percent){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_195_update)
            	}
...
void FlxBasePreloader_obj::onLoaded(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_202_onLoaded)
HXLINE( 203)		this->_loaded = true;
HXLINE( 204)		this->_percent = ( (Float)(1) );
            	}


 ::openfl::display::Bitmap FlxBasePreloader_obj::createBitmap(hx::Class bitmapDataClass, ::Dynamic onLoad){
            	HX_GC_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_218_createBitmap)
HXLINE( 224)		 ::openfl::display::Bitmap bmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),null(),null());
HXLINE( 225)		onLoad(bmp);
HXLINE( 226)		return bmp;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBasePreloader_obj,createBitmap,return )
 ...
 ::openfl::display::BitmapData FlxBasePreloader_obj::loadBitmapData(hx::Class bitmapDataClass, ::Dynamic onLoad){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_242_loadBitmapData)
HXLINE( 246)		 ::openfl::display::BitmapData bmpData = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) );
HXLINE( 247)		onLoad(bmpData);
HXLINE( 248)		return bmpData;
            	}
...
void FlxBasePreloader_obj::checkSiteLock(){
            	HX_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_256_checkSiteLock)
            	}
