...
HXLINE(  34)		( ( ::openfl::text::TextField)(tf) )->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,Size,(Color & 16777215),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(  35)		( ( ::openfl::display::DisplayObject)(tf) )->set_alpha((( (Float)(((Color >> 24) & 255)) ) / ( (Float)(255) )));
HXLINE(  36)		( ( ::openfl::text::TextField)(tf) )->set_autoSize(1);
HXLINE(  37)		return tf;
            	}
