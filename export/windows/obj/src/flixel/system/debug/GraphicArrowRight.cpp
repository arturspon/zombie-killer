...
HX_LOCAL_STACK_FRAME(_hx_pos_d12d58443e0e0eba_51_boot,"flixel.system.debug.GraphicArrowRight","boot",0xc034ca0d,"flixel.system.debug.GraphicArrowRight.boot","flixel/system/debug/FlxDebugger.hx",51,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_d12d58443e0e0eba_51_boot)
HXDLIN(  51)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicArrowRight",dc,1c,ad,91);
            	}
}
