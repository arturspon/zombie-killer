...
HX_LOCAL_STACK_FRAME(_hx_pos_bb31c4552e01719c_42_boot,"flixel.system.debug.GraphicBitmapLog","boot",0xbe36e28b,"flixel.system.debug.GraphicBitmapLog.boot","flixel/system/debug/FlxDebugger.hx",42,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_bb31c4552e01719c_42_boot)
HXDLIN(  42)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicBitmapLog",6c,ac,7b,3e);
            	}
}
