...
HX_LOCAL_STACK_FRAME(_hx_pos_3608a2beee3554fd_45_boot,"flixel.system.debug.GraphicConsole","boot",0x8a12d3c9,"flixel.system.debug.GraphicConsole.boot","flixel/system/debug/FlxDebugger.hx",45,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_3608a2beee3554fd_45_boot)
HXDLIN(  45)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicConsole",2e,18,f0,f3);
            	}
}
