...
HX_LOCAL_STACK_FRAME(_hx_pos_8e56f9cbe4884d6a_57_boot,"flixel.system.debug.GraphicInteractive","boot",0x28c3795e,"flixel.system.debug.GraphicInteractive.boot","flixel/system/debug/FlxDebugger.hx",57,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_8e56f9cbe4884d6a_57_boot)
HXDLIN(  57)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicInteractive",39,22,20,19);
            	}
}
