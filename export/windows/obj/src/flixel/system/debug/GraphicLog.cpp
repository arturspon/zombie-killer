...
HX_LOCAL_STACK_FRAME(_hx_pos_57449aee0c72ca19_33_boot,"flixel.system.debug.GraphicLog","boot",0x306ef77c,"flixel.system.debug.GraphicLog.boot","flixel/system/debug/FlxDebugger.hx",33,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_57449aee0c72ca19_33_boot)
HXDLIN(  33)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicLog",db,89,51,9b);
            	}
}
