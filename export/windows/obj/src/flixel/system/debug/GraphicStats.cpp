...
HX_LOCAL_STACK_FRAME(_hx_pos_72648bfda28cf679_36_boot,"flixel.system.debug.GraphicStats","boot",0x22932c01,"flixel.system.debug.GraphicStats.boot","flixel/system/debug/FlxDebugger.hx",36,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_72648bfda28cf679_36_boot)
HXDLIN(  36)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicStats",36,ef,43,45);
            	}
}
