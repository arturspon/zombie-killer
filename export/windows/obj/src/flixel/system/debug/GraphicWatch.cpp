...
HX_LOCAL_STACK_FRAME(_hx_pos_6ccb06d407f389af_39_boot,"flixel.system.debug.GraphicWatch","boot",0x91b6ddd1,"flixel.system.debug.GraphicWatch.boot","flixel/system/debug/FlxDebugger.hx",39,0xd9fc0a74)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_6ccb06d407f389af_39_boot)
HXDLIN(  39)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_GraphicWatch",66,8f,5d,86);
            	}
}
