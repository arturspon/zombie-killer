...
HXLINE( 129)		this->_shadow =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,2,true,-16777216),null(),null());
HXLINE( 130)		this->_background =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,1,true,-12961222),null(),null());
HXLINE( 132)		this->textField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(2,1,null(),null());
...
HXLINE( 177)		this->maxSize->x = ( (Float)(::Std_obj::_hx_int(::Math_obj::abs(Width))) );
HXLINE( 178)		this->maxSize->y = ( (Float)(::Std_obj::_hx_int(::Math_obj::abs(Height))) );
...
HXDLIN( 235)		if ((this->maxSize->x <= 0)) {
HXLINE( 235)			_hx_tmp = this->textField->get_textWidth();
            		}
            		else {
HXLINE( 235)			_hx_tmp = ::Math_obj::abs(this->maxSize->x);
            		}
HXDLIN( 235)		this->_width = (::Std_obj::_hx_int(_hx_tmp) + 8);
HXLINE( 236)		Float _hx_tmp1;
HXDLIN( 236)		if ((this->maxSize->y <= 0)) {
HXLINE( 236)			_hx_tmp1 = this->textField->get_textHeight();
            		}
            		else {
HXLINE( 236)			_hx_tmp1 = ::Math_obj::abs(this->maxSize->y);
            		}
HXDLIN( 236)		this->_height = (::Std_obj::_hx_int(_hx_tmp1) + 8);
HXLINE( 237)		this->_background->set_scaleX(( (Float)(this->_width) ));
HXLINE( 238)		this->_background->set_scaleY(( (Float)(this->_height) ));
HXLINE( 239)		this->_shadow->set_scaleX(( (Float)(this->_width) ));
HXLINE( 240)		this->_shadow->set_y(( (Float)(this->_height) ));
HXLINE( 241)		this->textField->set_width(( (Float)(this->_width) ));
            	}
...
HXDLIN( 248)		if ((this->get_x() < 0)) {
HXLINE( 248)			_hx_tmp = ( (Float)(0) );
            		}
            		else {
...
HXDLIN( 249)		if ((this->get_y() < 0)) {
HXLINE( 249)			_hx_tmp1 = ( (Float)(0) );
            		}
            		else {
...
HXDLIN( 253)			offsetX = (( (Float)(offsetX3) ) - (offsetX4 + this->get_width()));
            		}
            		else {
HXLINE( 253)			offsetX = ( (Float)(0) );
            		}
...
HXDLIN( 254)			offsetY = (( (Float)(offsetY3) ) - (offsetY4 + this->get_height()));
            		}
            		else {
HXLINE( 254)			offsetY = ( (Float)(0) );
            		}
HXLINE( 256)		{
...
HXLINE( 264)			this->set_x((event->stageX + 10));
