...
HXDLIN(  37)		return ::lime::text::_UTF8String::UTF8String_Impl__obj::substring(_hx_tmp,0,this->getCaretIndex());
            	}
...
HXLINE(  61)		switch((int)(e->keyCode)){
...
HXDLIN(  70)				this->invokeCompletion(_hx_tmp2,(e->keyCode == 190));
...
HXLINE( 121)		{
HXLINE( 121)			int _g = 0;
HXDLIN( 121)			int _g1 = this->getCaretIndex();
HXDLIN( 121)			while((_g < _g1)){
HXLINE( 121)				_g = (_g + 1);
HXDLIN( 121)				int i = (_g - 1);
HXLINE( 122)				pos = (pos + 6);
            			}
            		}
...
HXDLIN( 159)		switch((int)(_g->_hx_getIndex())){
            			case (int)0: {
...
HXDLIN( 179)			::flixel::FlxG_obj::game->debugger->watch->remove(HX_("Entry Value",03,6d,c3,a1),::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(null()));
            		}
HXLINE( 180)		{
HXLINE( 180)			 ::flixel::_hx_system::frontEnds::WatchFrontEnd _this1 = ::flixel::FlxG_obj::watch;
HXDLIN( 180)			::flixel::FlxG_obj::game->debugger->watch->remove(HX_("Entry Type",68,5d,1b,ed),::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(null()));
            		}
...
HXLINE( 188)		return lastWord.substr(0,dotIndex);
            	}
...
HXLINE( 196)		if ((index < 0)) {
HXLINE( 197)			index = 0;
            		}
            		else {
HXLINE( 199)			index = (index + 1);
            		}
