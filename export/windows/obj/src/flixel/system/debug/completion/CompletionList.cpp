...
HXLINE(  24)		this->upperVisibleIndex = 0;
HXLINE(  23)		this->lowerVisibleIndex = 0;
...
HXLINE(  33)		this->upperVisibleIndex = (capacity - 1);
HXLINE(  34)		this->actualHeight = (capacity * 20);
...
HXDLIN(  55)		this->set_y((y - ( (Float)(this->actualHeight) )));
            	}
...
HXLINE(  74)			entry->set_y(( (Float)((20 * i)) ));
            		}
            	}
...
HXLINE(  80)		this->scrollBar =  ::flixel::_hx_system::debug::completion::CompletionListScrollBar_obj::__alloc( HX_CTX ,150,0,5,this->actualHeight);
...
HXDLIN( 188)			return (s.indexOf(filter.toLowerCase(),null()) != -1);
            		}
