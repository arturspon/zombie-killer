...
HXLINE(  76)		super::__construct(HX_("Console",37,13,27,e6), ::flixel::_hx_system::debug::GraphicConsole_obj::__alloc( HX_CTX ,0,0,null(),null()),0,0,false,null(),null(),null());
HXLINE(  77)		this->completionList = completionList;
HXLINE(  78)		completionList->setY((this->get_y() + 15));
...
HXDLIN( 100)		_hx_tmp->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,12,16777215,false,false,false,null(),null(),null(),null(),null(),null(),null()));
HXLINE( 102)		this->input->set_text(HX_("(Click here / press [Tab] to enter command. Type 'help' for help.)",f9,4e,c0,26));
HXLINE( 103)		this->input->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 104)		this->input->set_height(( (Float)((this->_height - 15)) ));
HXLINE( 105)		this->input->set_x(( (Float)(2) ));
HXLINE( 106)		this->input->set_y(( (Float)(15) ));
...
HXLINE( 122)				_hx_tmp = (e->keyCode == 9);
            			}
            			else {
...
HXLINE( 131)			_gthis->inputMouseDown = true;
            		...
            		void _hx_run( ::openfl::events::MouseEvent _1){
...
HXLINE( 113)		this->input->set_type(1);
...
HXLINE( 203)		switch((int)(e->keyCode)){
            			case (int)13: {
...
HXDLIN( 268)		_hx_tmp->setY((this->get_y() + 15));
...
HXLINE( 356)		this->input->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 357)		this->input->set_height(( (Float)((this->_height - 15)) ));
            	}
