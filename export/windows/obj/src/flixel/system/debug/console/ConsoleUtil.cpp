...
HXLINE(  50)			Input = Input.substr(0,-1);
            		}
...
HXLINE( 119)					::String name = field.substr(4,null());
HXLINE( 121)					bool _hx_tmp1;
HXDLIN( 121)					if ((fields->indexOf(name,null()) == -1)) {
HXLINE( 121)						_hx_tmp1 = (filteredFields->indexOf(name,null()) == -1);
            					}
            					else {
