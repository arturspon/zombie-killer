...
HXLINE(  36)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicCursorCross_obj::__alloc( HX_CTX ,0,0,null(),null()));
...
HXLINE(  66)		if ((this->_itemsInSelectionArea->length > 0)) {
HXLINE(  68)			this->handleItemAddition(this->_itemsInSelectionArea);
            		}
            		else {
HXLINE(  70)			bool _hx_tmp1;
HXDLIN(  70)			if (!(this->_brain->keyPressed(17))) {
