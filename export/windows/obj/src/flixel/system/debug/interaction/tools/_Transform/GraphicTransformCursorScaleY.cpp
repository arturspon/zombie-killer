...
HX_LOCAL_STACK_FRAME(_hx_pos_3b7ca870e5742c90_24_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleY","boot",0x345db30d,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleY.boot","flixel/system/debug/interaction/tools/Transform.hx",24,0xb006466c)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_3b7ca870e5742c90_24_boot)
HXDLIN(  24)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorScaleY",ab,65,6b,08);
            	}
}
