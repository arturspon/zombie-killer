...
HX_LOCAL_STACK_FRAME(_hx_pos_32c10ea2e49f80ec_18_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool","boot",0x73b83ada,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool.boot","flixel/system/debug/interaction/tools/Transform.hx",18,0xb006466c)
namespace flixel{
...
{
{
            	HX_STACKFRAME(&_hx_pos_32c10ea2e49f80ec_18_boot)
HXDLIN(  18)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformTool",fe,f8,0a,56);
            	}
}
