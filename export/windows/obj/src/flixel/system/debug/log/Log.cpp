...
HXLINE(  88)				::String line = _g3->__get(_g2);
HXDLIN(  88)				_g2 = (_g2 + 1);
...
HXLINE( 109)			{
HXLINE( 109)				int _g21 = 0;
HXDLIN( 109)				int _g31 = this->_lines->length;
HXDLIN( 109)				while((_g21 < _g31)){
HXLINE( 109)					_g21 = (_g21 + 1);
HXDLIN( 109)					int i1 = (_g21 - 1);
...
HXLINE( 124)			 ::openfl::text::TextField _g22 = this->_text;
HXDLIN( 124)			_g22->set_htmlText(::lime::text::_UTF8String::UTF8String_Impl__obj::plus(_g22->get_htmlText(),(text + HX_("<br>",b2,8d,f3,27))));
            		}
