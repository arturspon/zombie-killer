...
HXLINE(  87)		this->_activeObjectMarker = 0;
HXLINE(  86)		this->_activeObject = ::Array_obj< int >::__new(0);
HXLINE(  84)		this->_visibleObjectMarker = 0;
HXLINE(  83)		this->_visibleObject = ::Array_obj< int >::__new(0);
HXLINE(  81)		this->_drawCallsMarker = 0;
HXLINE(  80)		this->_drawCalls = ::Array_obj< int >::__new(0);
HXLINE(  78)		this->_drawMarker = 0;
HXLINE(  77)		this->_draw = ::Array_obj< int >::__new(0);
HXLINE(  75)		this->_updateMarker = 0;
HXLINE(  74)		this->_update = ::Array_obj< int >::__new(0);
HXLINE(  72)		this->_updateTimer = 0;
HXLINE(  71)		this->_lastTime = 0;
HXLINE(  69)		this->drawCallsCount = 0;
HXLINE(  68)		this->drawTime = 0;
HXLINE(  67)		this->updateTime = 0;
HXLINE(  66)		this->activeCount = 0;
HXLINE(  65)		this->visibleCount = 0;
HXLINE(  64)		this->flashPlayerFramerate = ((Float)0);
HXLINE(  55)		this->_itvTime = 0;
HXLINE(  98)		super::__construct(HX_("Stats",ff,e5,38,17), ::flixel::_hx_system::debug::GraphicStats_obj::__alloc( HX_CTX ,0,0,null(),null()),0,0,false,null(),null(),null());
HXLINE( 100)		if ((::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT == 0)) {
HXLINE( 102)			if (!(::flixel::FlxG_obj::renderTile)) {
HXLINE( 103)				::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT = 185;
            			}
            			else {
HXLINE( 105)				::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT = 200;
            			}
            		}
HXLINE( 108)		this->minSize->y = ( (Float)(::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT) );
HXLINE( 109)		this->resize(( (Float)(160) ),( (Float)(::flixel::_hx_system::debug::stats::Stats_obj::MIN_HEIGHT) ));
...
HXLINE( 123)		int gutter = 5;
HXLINE( 124)		int graphX = gutter;
HXLINE( 125)		int graphY = (::Std_obj::_hx_int(this->_header->get_height()) + gutter);
HXLINE( 126)		int graphHeight = 40;
HXLINE( 127)		int graphWidth = 140;
HXLINE( 129)		this->fpsGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__alloc( HX_CTX ,graphX,graphY,graphWidth,graphHeight,-6881536,HX_("fps",e9,c7,4d,00),null(),null());
HXLINE( 130)		this->addChild(this->fpsGraph);
HXLINE( 131)		this->fpsGraph->maxValue = ( (Float)(::flixel::FlxG_obj::drawFramerate) );
HXLINE( 132)		this->fpsGraph->minValue = ( (Float)(0) );
HXLINE( 134)		graphY = ((::Std_obj::_hx_int(this->_header->get_height()) + graphHeight) + 20);
HXLINE( 136)		this->memoryGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__alloc( HX_CTX ,graphX,graphY,graphWidth,graphHeight,-16737025,HX_("MB",55,43,00,00),null(),null());
HXLINE( 137)		this->addChild(this->memoryGraph);
HXLINE( 139)		graphY = (::Std_obj::_hx_int(this->_header->get_height()) + gutter);
HXLINE( 140)		graphX = (graphX + ((gutter + graphWidth) + 20));
HXLINE( 141)		graphWidth = (graphWidth - 10);
HXLINE( 143)		this->updateTimeGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__alloc( HX_CTX ,graphX,graphY,graphWidth,graphHeight,-2305024,HX_("ms",66,5f,00,00),35,HX_("Update",29,fa,99,bb));
HXLINE( 144)		this->updateTimeGraph->set_visible(false);
HXLINE( 145)		this->addChild(this->updateTimeGraph);
HXLINE( 147)		graphY = ((::Std_obj::_hx_int(this->_header->get_height()) + graphHeight) + 20);
HXLINE( 149)		this->drawTimeGraph =  ::flixel::_hx_system::debug::stats::StatsGraph_obj::__alloc( HX_CTX ,graphX,graphY,graphWidth,graphHeight,-5898236,HX_("ms",66,5f,00,00),35,HX_("Draw",24,58,49,2d));
HXLINE( 150)		this->drawTimeGraph->set_visible(false);
HXLINE( 151)		this->addChild(this->drawTimeGraph);
HXLINE( 153)		this->addChild((this->_leftTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(gutter,((graphHeight * 2) + 45),(int)-1426063361,11)));
HXLINE( 154)		this->addChild((this->_rightTextField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((gutter + 70),((graphHeight * 2) + 45),-1,11)));
...
HXLINE( 173)		this->_leftTextField->set_text(((HX_("Update: \nDraw:",9b,e1,5f,a0) + drawMethod) + HX_("\nQuadTrees: \nLists:",e5,f7,d0,58)));
HXLINE( 175)		this->_toggleSizeButton =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX , ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()),this->toggleSize_dyn(),null());
...
HXLINE( 256)		if ((elapsed > 250)) {
HXLINE( 258)			elapsed = 250;
            		}
...
HXLINE( 266)		if ((this->_updateTimer > 250)) {
HXLINE( 268)			this->fpsGraph->update((( (Float)(this->_frameCount) ) / (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) ))));
HXLINE( 269)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp1 = this->memoryGraph;
HXDLIN( 269)			_hx_tmp1->update(((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) )));
HXLINE( 270)			this->updateTexts();
HXLINE( 272)			this->_frameCount = 0;
HXLINE( 273)			this->_itvTime = this->_currentTime;
HXLINE( 275)			this->updateTime = 0;
HXLINE( 276)			{
HXLINE( 276)				int _g = 0;
HXDLIN( 276)				int _g1 = this->_updateMarker;
HXDLIN( 276)				while((_g < _g1)){
HXLINE( 276)					_g = (_g + 1);
HXDLIN( 276)					int i = (_g - 1);
HXLINE( 278)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 278)					_hx_tmp2->updateTime = (_hx_tmp2->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 281)			{
HXLINE( 281)				int _g2 = 0;
HXDLIN( 281)				int _g3 = this->_activeObjectMarker;
HXDLIN( 281)				while((_g2 < _g3)){
HXLINE( 281)					_g2 = (_g2 + 1);
HXDLIN( 281)					int i1 = (_g2 - 1);
HXLINE( 283)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 283)					_hx_tmp3->activeCount = (_hx_tmp3->activeCount + this->_activeObject->__get(i1));
            				}
            			}
HXLINE( 285)			this->activeCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->activeCount) ),( (Float)(this->_activeObjectMarker) )));
HXLINE( 287)			this->drawTime = 0;
HXLINE( 288)			{
HXLINE( 288)				int _g4 = 0;
HXDLIN( 288)				int _g5 = this->_drawMarker;
HXDLIN( 288)				while((_g4 < _g5)){
HXLINE( 288)					_g4 = (_g4 + 1);
HXDLIN( 288)					int i2 = (_g4 - 1);
HXLINE( 290)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 290)					_hx_tmp4->drawTime = (_hx_tmp4->drawTime + this->_draw->__get(i2));
            				}
            			}
HXLINE( 293)			{
HXLINE( 293)				int _g6 = 0;
HXDLIN( 293)				int _g7 = this->_visibleObjectMarker;
HXDLIN( 293)				while((_g6 < _g7)){
HXLINE( 293)					_g6 = (_g6 + 1);
HXDLIN( 293)					int i3 = (_g6 - 1);
HXLINE( 295)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 295)					_hx_tmp5->visibleCount = (_hx_tmp5->visibleCount + this->_visibleObject->__get(i3));
            				}
            			}
HXLINE( 297)			this->visibleCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->visibleCount) ),( (Float)(this->_visibleObjectMarker) )));
HXLINE( 299)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 301)				{
HXLINE( 301)					int _g8 = 0;
HXDLIN( 301)					int _g9 = this->_drawCallsMarker;
HXDLIN( 301)					while((_g8 < _g9)){
HXLINE( 301)						_g8 = (_g8 + 1);
HXDLIN( 301)						int i4 = (_g8 - 1);
HXLINE( 303)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 303)						_hx_tmp6->drawCallsCount = (_hx_tmp6->drawCallsCount + this->_drawCalls->__get(i4));
            					}
            				}
HXLINE( 305)				this->drawCallsCount = ::Std_obj::_hx_int(this->divide(( (Float)(this->drawCallsCount) ),( (Float)(this->_drawCallsMarker) )));
            			}
HXLINE( 308)			this->_updateMarker = 0;
HXLINE( 309)			this->_drawMarker = 0;
HXLINE( 310)			this->_activeObjectMarker = 0;
HXLINE( 311)			this->_visibleObjectMarker = 0;
HXLINE( 312)			if (::flixel::FlxG_obj::renderTile) {
HXLINE( 314)				this->_drawCallsMarker = 0;
            			}
HXLINE( 317)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 317)			_hx_tmp7->_updateTimer = (_hx_tmp7->_updateTimer - 250);
            		}
            	}
...
HXLINE( 323)		Float updTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->updateTime) ),( (Float)(this->_updateMarker) )),1);
HXLINE( 324)		Float drwTime = ::flixel::math::FlxMath_obj::roundDecimal(this->divide(( (Float)(this->drawTime) ),( (Float)(this->_drawMarker) )),1);
...
HXLINE( 339)		if ((f2 == 0)) {
HXLINE( 340)			return ( (Float)(0) );
            		}
HXLINE( 341)		return (f1 / f2);
            	}
...
HXDLIN( 349)		return (( (Float)(this->_frameCount) ) / (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) )));
            	}
...
HXDLIN( 357)		return (( (Float)((this->_currentTime - this->_itvTime)) ) / ( (Float)(1000) ));
            	}
...
HXDLIN( 365)		return ((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) ));
            	}
...
HXLINE( 377)		this->_update[this->_updateMarker++] = Time;
            	}
...
HXLINE( 389)		this->_draw[this->_drawMarker++] = Time;
            	}
...
HXLINE( 401)		this->_activeObject[this->_activeObjectMarker++] = Count;
            	}
...
HXLINE( 413)		this->_visibleObject[this->_visibleObjectMarker++] = Count;
            	}
...
HXLINE( 425)		this->_drawCalls[this->_drawCallsMarker++] = Drawcalls;
            	}
...
HXLINE( 446)		if ((this->_width == 160)) {
HXLINE( 448)			this->resize(( (Float)(320) ),( (Float)(this->_height) ));
HXLINE( 449)			{
HXLINE( 449)				 ::flixel::_hx_system::debug::stats::Stats _g = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 449)				_g->set_x((_g->get_x() - ( (Float)(160) )));
            			}
...
HXDLIN( 452)			_hx_tmp->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMinimizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}
            		else {
HXLINE( 456)			this->resize(( (Float)(160) ),( (Float)(this->_height) ));
HXLINE( 457)			{
HXLINE( 457)				 ::flixel::_hx_system::debug::stats::Stats _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 457)				_g1->set_x((_g1->get_x() + 160));
            			}
...
HXDLIN( 460)			_hx_tmp1->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}
...
HXDLIN( 472)			_hx_tmp->set_x(((( (Float)(_hx_tmp1) ) - this->_toggleSizeButton->get_width()) - ( (Float)(3) )));
HXLINE( 473)			this->_toggleSizeButton->set_y(( (Float)(3) ));
            		}
            	}
