...
HXLINE(  79)		switch((int)(e->keyCode)){
            			case (int)38: {
HXLINE(  81)				this->cycleValue(modifier,0);
            			}
            			break;
            			case (int)40: {
...
HXDLIN(  97)					if ((modifier < 0)) {
HXLINE(  97)						_hx_tmp1 = -1;
            					}
            					else {
HXLINE(  97)						_hx_tmp1 = 1;
            					}
...
HXLINE( 124)		if ((index == -1)) {
HXLINE( 125)			index = 0;
            		}
            		else {
HXLINE( 128)			index = (index + modifier);
HXLINE( 129)			index = ::Std_obj::_hx_int(( (Float)(::flixel::math::FlxMath_obj::wrap(index,0,(values->length - 1))) ));
            		}
