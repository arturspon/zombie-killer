...
HXLINE( 159)		this->resize(( (Float)(200) ),(this->entriesContainer->get_height() + 30));
HXLINE( 162)		this->set_x(( (Float)((::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows * 80)) ));
HXLINE( 163)		this->set_y(( (Float)(((::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows * 25) + 20)) ));
HXLINE( 164)		::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows++;
HXLINE( 166)		::flixel::FlxG_obj::signals->preStateSwitch->add(this->close_dyn());
            	}
...
HXLINE( 171)		::flixel::FlxG_obj::signals->preStateSwitch->remove(this->close_dyn());
...
HXDLIN(  77)		::flixel::_hx_system::debug::watch::Tracker_obj::_numTrackerWindows = 0;
            	}
...
HXDLIN(  52)		_numTrackerWindows = 0;
            	}
}
