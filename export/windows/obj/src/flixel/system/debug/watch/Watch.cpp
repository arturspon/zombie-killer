...
HXLINE(  20)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(2,15);
HXDLIN(  20)		point->_inPool = false;
HXDLIN(  20)		this->entriesContainerOffset = point;
HXLINE(  25)		super::__construct(HX_("Watch",2f,86,52,58), ::flixel::_hx_system::debug::GraphicWatch_obj::__alloc( HX_CTX ,0,0,null(),null()),0,0,true,null(),closable,null());
...
HXLINE(  32)		::flixel::FlxG_obj::signals->preStateSwitch->add(this->removeAll_dyn());
            	}
...
HXLINE(  43)			if ((data->_hx_getIndex() == 1)) {
...
HXDLIN(  57)		switch((int)(data->_hx_getIndex())){
            			case (int)0: {
