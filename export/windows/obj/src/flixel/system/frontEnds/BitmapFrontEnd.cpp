...
HXLINE(  43)		this->_lastUniqueKeyIndex = 0;
...
HXLINE(  54)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE(  70)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE(  87)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXLINE( 104)			 ::flixel::graphics::FlxGraphic obj = ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) );
...
HXDLIN( 121)		return hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(Key)) ) );
            	}
...
HXDLIN( 184)		return ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key)) );
            	}
...
HXLINE( 197)				if (hx::IsEq( ( ( ::flixel::graphics::FlxGraphic)(this->_cache->get(key1)) )->bitmap,bmd )) {
