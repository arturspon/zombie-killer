...
HXLINE(  53)		( ( ::flixel::FlxBasic)(NewCamera) )->ID = (::flixel::FlxG_obj::cameras->list->length - 1);
...
HXLINE(  70)			this->list->removeRange(index,1);
            		}
            		else {
...
HXLINE(  80)			int _g = 0;
HXDLIN(  80)			int _g1 = this->list->length;
...
HXLINE( 100)		while((this->list->length > 0)){
HXLINE( 101)			this->remove(this->list->__get(0).StaticCast<  ::flixel::FlxCamera >(),null());
            		}
HXLINE( 103)		if (hx::IsNull( NewCamera )) {
HXLINE( 104)			NewCamera =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,null());
            		}
HXLINE( 106)		::flixel::FlxG_obj::camera = ( ( ::flixel::FlxCamera)(this->add(NewCamera)) );
HXLINE( 107)		NewCamera->ID = 0;
...
HXLINE( 208)				camera->fill((camera->bgColor & 16777215),camera->useBgAlphaBlending,(( (Float)(((camera->bgColor >> 24) & 255)) ) / ( (Float)(255) )),null());
            			}
            		}
            	}
