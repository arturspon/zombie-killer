...
HXLINE(  97)		if ((::flixel::_hx_system::debug::watch::Tracker_obj::objectsBeingTracked->indexOf(ObjectOrClass,null()) != -1)) {
...
HXLINE( 173)			::flixel::FlxG_obj::mouse->enabled = true;
            		}
            		else {
HXLINE( 181)			::flixel::FlxG_obj::mouse->enabled = !(::flixel::FlxG_obj::game->debugger->interaction->isInUse());
            		}
HXLINE( 185)		this->visibilityChanged->dispatch();
HXLINE( 188)		return this->visible;
            	}
