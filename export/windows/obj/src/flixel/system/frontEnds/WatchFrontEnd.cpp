...
HXDLIN(  24)		::flixel::FlxG_obj::game->debugger->watch->add(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(object,field));
            	}
...
HXDLIN(  37)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(object,field));
            	}
...
HXDLIN(  64)		::flixel::FlxG_obj::game->debugger->watch->remove(displayName,::flixel::_hx_system::debug::watch::WatchEntryData_obj::QUICK(null()));
            	}
...
HXLINE(  83)			_hx_tmp = expression;
            		}
            		else {
HXLINE(  83)			_hx_tmp = displayName;
            		}
HXDLIN(  83)		::flixel::FlxG_obj::game->debugger->watch->add(_hx_tmp,::flixel::_hx_system::debug::watch::WatchEntryData_obj::EXPRESSION(expression,parsedExpr));
            	}
...
HXDLIN( 107)		::flixel::FlxG_obj::game->debugger->watch->add(HX_("Mouse Position",44,8e,3a,9d),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(( ( ::Dynamic)(hx::ClassOf< ::flixel::FlxG >()) ),HX_("mouse",25,16,65,0c)));
            	}
...
HXDLIN( 117)		::flixel::FlxG_obj::game->debugger->watch->remove(null(),::flixel::_hx_system::debug::watch::WatchEntryData_obj::FIELD(( ( ::Dynamic)(hx::ClassOf< ::flixel::FlxG >()) ),HX_("mouse",25,16,65,0c)));
            	}
