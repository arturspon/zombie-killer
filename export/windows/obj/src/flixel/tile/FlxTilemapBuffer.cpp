...
HXLINE(  48)		this->columns = 0;
HXLINE(  44)		this->rows = 0;
...
HXLINE( 106)			int newWidth = ::Std_obj::_hx_int(( (Float)((this->columns * TileWidth)) ));
HXLINE( 107)			int newHeight = ::Std_obj::_hx_int(( (Float)((this->rows * TileHeight)) ));
HXLINE( 109)			if (hx::IsNull( this->pixels )) {
HXLINE( 111)				this->pixels =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newWidth,newHeight,true,0);
HXLINE( 112)				this->_flashRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,newWidth,newHeight);
...
HXLINE( 119)					this->pixels =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newWidth,newHeight,true,0);
HXLINE( 120)					this->_flashRect->setTo(( (Float)(0) ),( (Float)(0) ),( (Float)(newWidth) ),( (Float)(newHeight) ));
...
HXLINE( 164)			FlashPoint->x = ( (Float)(::Math_obj::floor(FlashPoint->x)) );
HXLINE( 165)			FlashPoint->y = ( (Float)(::Math_obj::floor(FlashPoint->y)) );
            		}
...
HXLINE( 189)		if ((WidthInTiles < 0)) {
HXLINE( 190)			WidthInTiles = 0;
            		}
HXLINE( 192)		if (hx::IsNull( Camera )) {
HXLINE( 193)			Camera = ::flixel::FlxG_obj::camera;
            		}
HXLINE( 195)		this->columns = (::Math_obj::ceil((Camera->viewWidth / (( (Float)(TileWidth) ) * ScaleX))) + 1);
HXLINE( 197)		if ((this->columns > WidthInTiles)) {
HXLINE( 198)			this->columns = WidthInTiles;
            		}
HXLINE( 200)		this->width = ( (Float)(::Std_obj::_hx_int((( (Float)((this->columns * TileWidth)) ) * ScaleX))) );
...
HXLINE( 208)		if ((HeightInTiles < 0)) {
HXLINE( 209)			HeightInTiles = 0;
            		}
HXLINE( 211)		if (hx::IsNull( Camera )) {
HXLINE( 212)			Camera = ::flixel::FlxG_obj::camera;
            		}
HXLINE( 214)		this->rows = (::Math_obj::ceil((Camera->viewHeight / (( (Float)(TileHeight) ) * ScaleY))) + 1);
HXLINE( 216)		if ((this->rows > HeightInTiles)) {
HXLINE( 217)			this->rows = HeightInTiles;
            		}
HXLINE( 219)		this->height = ( (Float)(::Std_obj::_hx_int((( (Float)((this->rows * TileHeight)) ) * ScaleY))) );
...
HXLINE( 232)			return ( (bool)(this->pixelPerfectRender) );
            		}
