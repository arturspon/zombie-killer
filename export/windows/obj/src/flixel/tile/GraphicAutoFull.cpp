...
HX_LOCAL_STACK_FRAME(_hx_pos_4cc2402574bdb662_37_boot,"flixel.tile.GraphicAutoFull","boot",0x0e9a6708,"flixel.tile.GraphicAutoFull.boot","flixel/tile/FlxTilemap.hx",37,0x448feb74)
namespace flixel{
namespace tile{
...
{
{
            	HX_STACKFRAME(&_hx_pos_4cc2402574bdb662_37_boot)
HXDLIN(  37)		resourceName = HX_("__ASSET__:bitmap_flixel_tile_GraphicAutoFull",52,c6,87,bb);
            	}
}
