...
HXDLIN(  53)		int r = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 16) & 255) - ((Color1 >> 16) & 255))) ) * Factor) + ((Color1 >> 16) & 255)));
HXDLIN(  53)		int g = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 8) & 255) - ((Color1 >> 8) & 255))) ) * Factor) + ((Color1 >> 8) & 255)));
HXDLIN(  53)		int b = ::Std_obj::_hx_int(((( (Float)(((Color2 & 255) - (Color1 & 255))) ) * Factor) + (Color1 & 255)));
HXDLIN(  53)		int a = ::Std_obj::_hx_int(((( (Float)((((Color2 >> 24) & 255) - ((Color1 >> 24) & 255))) ) * Factor) + ((Color1 >> 24) & 255)));
HXDLIN(  53)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN(  53)		{
HXLINE(  53)			color = (color & -16711681);
HXDLIN(  53)			int color1;
HXDLIN(  53)			if ((r > 255)) {
HXLINE(  53)				color1 = 255;
            			}
            			else {
HXLINE(  53)				if ((r < 0)) {
HXLINE(  53)					color1 = 0;
...
HXDLIN(  53)			color = (color | (color1 << 16));
            		}
HXDLIN(  53)		{
HXLINE(  53)			color = (color & -65281);
HXDLIN(  53)			int color2;
HXDLIN(  53)			if ((g > 255)) {
HXLINE(  53)				color2 = 255;
            			}
            			else {
HXLINE(  53)				if ((g < 0)) {
HXLINE(  53)					color2 = 0;
...
HXDLIN(  53)			color = (color | (color2 << 8));
            		}
HXDLIN(  53)		{
HXLINE(  53)			color = (color & -256);
HXDLIN(  53)			int color3;
HXDLIN(  53)			if ((b > 255)) {
HXLINE(  53)				color3 = 255;
            			}
            			else {
HXLINE(  53)				if ((b < 0)) {
HXLINE(  53)					color3 = 0;
...
HXDLIN(  53)			color = (color | color3);
            		}
HXDLIN(  53)		{
HXLINE(  53)			color = (color & 16777215);
HXDLIN(  53)			int color4;
HXDLIN(  53)			if ((a > 255)) {
HXLINE(  53)				color4 = 255;
            			}
            			else {
HXLINE(  53)				if ((a < 0)) {
HXLINE(  53)					color4 = 0;
