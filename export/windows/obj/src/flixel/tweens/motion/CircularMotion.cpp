...
HXLINE(  41)		this->angle = (this->_angleStart = ((Angle * ::Math_obj::PI) / ( (Float)(-180) )));
...
HXDLIN(  42)		this->_angleFinish = ((::Math_obj::PI * ( (Float)(2) )) * ( (Float)(_hx_tmp) ));
HXLINE(  44)		if (UseDuration) {
HXLINE(  46)			this->duration = DurationOrSpeed;
            		}
            		else {
HXLINE(  50)			this->duration = ((this->_radius * (::Math_obj::PI * ( (Float)(2) ))) / DurationOrSpeed);
            		}
...
HXLINE(  60)		this->angle = (this->_angleStart + (this->_angleFinish * this->scale));
HXLINE(  61)		this->x = (this->_centerX + (::Math_obj::cos(this->angle) * this->_radius));
HXLINE(  62)		this->y = (this->_centerY + (::Math_obj::sin(this->angle) * this->_radius));
...
HXDLIN(  71)		return (this->_radius * (::Math_obj::PI * ( (Float)(2) )));
            	}
