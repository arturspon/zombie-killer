...
HXLINE(  52)		this->y = ((((((this->scale * this->scale) * this->scale) * ((this->_toY + (( (Float)(3) ) * (this->_aY - this->_bY))) - this->_fromY)) + (((( (Float)(3) ) * this->scale) * this->scale) * ((this->_fromY - (( (Float)(2) ) * this->_aY)) + this->_bY))) + ((( (Float)(3) ) * this->scale) * (this->_aY - this->_fromY))) + this->_fromY);
