...
HXLINE(  38)		this->_distance = ( (Float)(-1) );
...
HXLINE(  52)			this->duration = (this->get_distance() / DurationOrSpeed);
            		}
...
HXLINE(  63)		this->x = ((((this->_fromX * (( (Float)(1) ) - this->scale)) * (( (Float)(1) ) - this->scale)) + (((this->_controlX * ( (Float)(2) )) * (( (Float)(1) ) - this->scale)) * this->scale)) + ((this->_toX * this->scale) * this->scale));
HXLINE(  64)		this->y = ((((this->_fromY * (( (Float)(1) ) - this->scale)) * (( (Float)(1) ) - this->scale)) + (((this->_controlY * ( (Float)(2) )) * (( (Float)(1) ) - this->scale)) * this->scale)) + ((this->_toY * this->scale) * this->scale));
...
HXLINE(  73)		if ((this->_distance >= 0)) {
HXLINE(  74)			return this->_distance;
            		}
HXLINE(  76)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  76)		point->_inPool = false;
HXDLIN(  76)		 ::flixel::math::FlxPoint p1 = point;
HXLINE(  77)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  77)		point1->_inPool = false;
HXDLIN(  77)		 ::flixel::math::FlxPoint p2 = point1;
HXLINE(  78)		p1->set_x(((this->x - (( (Float)(2) ) * this->_controlX)) + this->_toX));
HXLINE(  79)		p1->set_y(((this->y - (( (Float)(2) ) * this->_controlY)) + this->_toY));
HXLINE(  80)		p2->set_x(((( (Float)(2) ) * this->_controlX) - (( (Float)(2) ) * this->x)));
HXLINE(  81)		p2->set_y(((( (Float)(2) ) * this->_controlY) - (( (Float)(2) ) * this->y)));
HXLINE(  82)		Float a = (( (Float)(4) ) * ((p1->x * p1->x) + (p1->y * p1->y)));
HXDLIN(  82)		Float b = (( (Float)(4) ) * ((p1->x * p2->x) + (p1->y * p2->y)));
HXDLIN(  82)		Float c = ((p2->x * p2->x) + (p2->y * p2->y));
HXDLIN(  82)		Float abc = (( (Float)(2) ) * ::Math_obj::sqrt(((a + b) + c)));
HXDLIN(  82)		Float a2 = ::Math_obj::sqrt(a);
HXDLIN(  82)		Float a32 = ((( (Float)(2) ) * a) * a2);
HXDLIN(  82)		Float c2 = (( (Float)(2) ) * ::Math_obj::sqrt(c));
HXDLIN(  82)		Float ba = (b / a2);
HXLINE(  91)		p1->put();
HXLINE(  92)		p2->put();
HXLINE(  94)		return ((((a32 * abc) + ((a2 * b) * (abc - c2))) + ((((( (Float)(4) ) * c) * a) - (b * b)) * ::Math_obj::log(((((( (Float)(2) ) * a2) + ba) + abc) / (ba + c2))))) / (( (Float)(4) ) * a32));
            	}
