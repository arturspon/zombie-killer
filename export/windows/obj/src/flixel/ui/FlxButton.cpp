...
HXDLIN(  58)				_g = (_g + 1);
HXLINE(  59)				point->set((point->x - ( (Float)(1) )),(point->y + 3));
            			}
            		}
HXLINE(  61)		if (hx::IsNotNull( Text )) {
HXLINE(  61)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->y),80,Text,null(),null()));
HXDLIN(  61)			this->label->setFormat(null(),8,3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  61)			this->label->set_alpha(this->labelAlphas->__get(this->status));
...
HXDLIN(  73)			_hx_tmp->set_fieldWidth(( (Float)((this->label->frameWidth = ::Std_obj::_hx_int(_hx_tmp1))) ));
HXLINE(  74)			 ::flixel::text::FlxText _hx_tmp2 = this->label;
HXDLIN(  74)			_hx_tmp2->set_size(::Std_obj::_hx_int(( (Float)(this->label->_defaultFormat->size) )));
            		}
            	}
...
HXLINE(  82)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->y),80,Text,null(),null()));
HXLINE(  83)			this->label->setFormat(null(),8,3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  84)			this->label->set_alpha(this->labelAlphas->__get(this->status));
...
HXLINE(  98)				this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxPoint >()->y),80,Text,null(),null()));
HXDLIN(  98)				this->label->setFormat(null(),8,3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  98)				this->label->set_alpha(this->labelAlphas->__get(this->status));
