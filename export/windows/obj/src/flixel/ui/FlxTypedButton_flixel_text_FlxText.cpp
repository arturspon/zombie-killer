...
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_549_onOutHandler,"flixel.ui.FlxTypedButton_flixel_text_FlxText","onOutHandler",0x8a95b0c6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onOutHandler","flixel/ui/FlxButton.hx",549,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_557_set_label,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_label",0xb45e3b8c,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_label","flixel/ui/FlxButton.hx",557,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_574_set_status,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_status",0xda949e9a,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_status","flixel/ui/FlxButton.hx",574,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_581_set_alpha,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_alpha",0x6645d4f6,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_alpha","flixel/ui/FlxButton.hx",581,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_588_set_x,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_x",0x2df28210,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_x","flixel/ui/FlxButton.hx",588,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_595_set_y,"flixel.ui.FlxTypedButton_flixel_text_FlxText","set_y",0x2df28211,"flixel.ui.FlxTypedButton_flixel_text_FlxText.set_y","flixel/ui/FlxButton.hx",595,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_603_get_justReleased,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justReleased",0x234d62fd,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justReleased","flixel/ui/FlxButton.hx",603,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_608_get_released,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_released",0x17b1c6b1,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_released","flixel/ui/FlxButton.hx",608,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_613_get_pressed,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_pressed",0x60818f2e,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_pressed","flixel/ui/FlxButton.hx",613,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_618_get_justPressed,"flixel.ui.FlxTypedButton_flixel_text_FlxText","get_justPressed",0x5f690062,"flixel.ui.FlxTypedButton_flixel_text_FlxText.get_justPressed","flixel/ui/FlxButton.hx",618,0xc64cf442)
namespace flixel{
namespace ui{
...
HXLINE( 123)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 123)		point->_inPool = false;
HXDLIN( 123)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 123)		point1->_inPool = false;
HXDLIN( 123)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,1);
HXDLIN( 123)		point2->_inPool = false;
HXDLIN( 123)		this->labelOffsets = ::Array_obj< ::Dynamic>::__new(3)->init(0,point)->init(1,point1)->init(2,point2);
...
HXLINE( 227)		this->input =  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,0);
            	}
...
HXLINE( 234)		this->setupAnimation(HX_("normal",27,72,69,30),0);
HXLINE( 235)		this->setupAnimation(HX_("highlight",34,56,00,ed),1);
HXLINE( 236)		this->setupAnimation(HX_("pressed",a2,d2,e6,39),2);
            	}
...
HXDLIN( 241)		this->loadGraphic(HX_("flixel/images/ui/button.png",44,ee,2f,34),true,80,20,null(),null());
            	}
...
HXLINE( 247)		frameIndex = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(frameIndex) ),( (Float)((this->animation->_sprite->numFrames - 1)) )));
...
HXDLIN( 304)		this->animation->play(this->statusAnimations->__get(this->status),null(),null(),null());
            	}
...
HXDLIN( 399)					::Array< int > _g11 = this->mouseButtons;
HXDLIN( 399)					while((_g2 < _g11->length)){
HXLINE( 399)						int buttonID = _g11->__get(_g2);
...
HXLINE( 434)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 476)			Float _hx_tmp;
HXDLIN( 476)			if (this->pixelPerfectPosition) {
HXLINE( 476)				_hx_tmp = ( (Float)(::Math_obj::floor(this->x)) );
            			}
            			else {
HXLINE( 476)				_hx_tmp = this->x;
            			}
HXDLIN( 476)			this->_spriteLabel->set_x((_hx_tmp + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxPoint >()->x));
HXLINE( 477)			Float _hx_tmp1;
HXDLIN( 477)			if (this->pixelPerfectPosition) {
HXLINE( 477)				_hx_tmp1 = ( (Float)(::Math_obj::floor(this->y)) );
            			}
            			else {
HXLINE( 477)				_hx_tmp1 = this->y;
            			}
HXDLIN( 477)			this->_spriteLabel->set_y((_hx_tmp1 + this->labelOffsets->__get(this->status).StaticCast<  ::flixel::math::FlxPoint >()->y));
            		}
            	}
...
HXLINE( 485)			this->_spriteLabel->set_alpha((this->alpha * this->labelAlphas->__get(this->status)));
            		}
            	}
...
HXDLIN( 496)			_hx_tmp = (this->status == 2);
            		}
            		else {
...
HXLINE( 534)		if (!(::flixel::FlxG_obj::mouse->enabled)) {
HXLINE( 536)			this->set_status(0);
HXLINE( 537)			return;
            		}
HXLINE( 540)		this->set_status(1);
HXLINE( 542)		{
HXLINE( 542)			 ::flixel::ui::_FlxButton::FlxButtonEvent _this = this->onOver;
HXDLIN( 542)			if (hx::IsNotNull( _this->callback )) {
HXLINE( 542)				_this->callback();
            			}
HXDLIN( 542)			if (hx::IsNotNull( _this->sound )) {
HXLINE( 542)				_this->sound->play(true,null(),null());
            			}
            		}
            	}
...
void FlxTypedButton_flixel_text_FlxText_obj::onOutHandler(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_549_onOutHandler)
HXLINE( 550)		this->set_status(0);
HXLINE( 551)		this->input->release();
HXLINE( 553)		{
HXLINE( 553)			 ::flixel::ui::_FlxButton::FlxButtonEvent _this = this->onOut;
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTypedButton_flixel_text_FlxText_obj,onOutHandler,(void))
 ...
 ::flixel::text::FlxText FlxTypedButton_flixel_text_FlxText_obj::set_label( ::flixel::text::FlxText Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_557_set_label)
HXLINE( 558)		if (hx::IsNotNull( Value )) {
HXLINE( 561)			Value->scrollFactor->put();
HXLINE( 562)			Value->scrollFactor = this->scrollFactor;
            		}
HXLINE( 565)		this->label = Value;
HXLINE( 566)		this->_spriteLabel = this->label;
HXLINE( 568)		this->updateLabelPosition();
...
int FlxTypedButton_flixel_text_FlxText_obj::set_status(int Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_574_set_status)
HXLINE( 575)		this->status = Value;
HXLINE( 576)		this->updateLabelAlpha();
HXLINE( 577)		return this->status;
            	}
...
Float FlxTypedButton_flixel_text_FlxText_obj::set_alpha(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_581_set_alpha)
HXLINE( 582)		this->super::set_alpha(Value);
HXLINE( 583)		this->updateLabelAlpha();
HXLINE( 584)		return this->alpha;
            	}


Float FlxTypedButton_flixel_text_FlxText_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_588_set_x)
HXLINE( 589)		this->super::set_x(Value);
HXLINE( 590)		this->updateLabelPosition();
HXLINE( 591)		return this->x;
            	}


Float FlxTypedButton_flixel_text_FlxText_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_595_set_y)
HXLINE( 596)		this->super::set_y(Value);
HXLINE( 597)		this->updateLabelPosition();
HXLINE( 598)		return this->y;
            	}


bool FlxTypedButton_flixel_text_FlxText_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_603_get_justReleased)
HXDLIN( 603)		return (this->input->current == -1);
            	}
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_released(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_608_get_released)
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_613_get_pressed)
HXDLIN( 613)		 ::flixel::input::FlxInput _this = this->input;
HXDLIN( 613)		if ((_this->current != 1)) {
HXDLIN( 613)			return (_this->current == 2);
            		}
            		else {
...
bool FlxTypedButton_flixel_text_FlxText_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_618_get_justPressed)
HXDLIN( 618)		return (this->input->current == 2);
            	}
