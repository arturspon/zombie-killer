...
HX_DEFINE_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_644_new,"flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",644,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_656_destroy,"flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",656,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_668_fire,"flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",668,0xc64cf442)
namespace flixel{
namespace ui{
namespace _FlxButton{

void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::_hx_system::FlxSound sound){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_644_new)
HXLINE( 645)		this->callback = Callback;
HXLINE( 648)		this->sound = sound;
            	}
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_656_destroy)
HXLINE( 657)		this->callback = null();
HXLINE( 660)		this->sound = ( ( ::flixel::_hx_system::FlxSound)(::flixel::util::FlxDestroyUtil_obj::destroy(this->sound)) );
            	}
...
void FlxButtonEvent_obj::fire(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_668_fire)
HXLINE( 669)		if (hx::IsNotNull( this->callback )) {
HXLINE( 670)			this->callback();
            		}
HXLINE( 673)		if (hx::IsNotNull( this->sound )) {
HXLINE( 674)			this->sound->play(true,null(),null());
            		}
            	}
