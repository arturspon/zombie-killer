...
HXLINE(  70)				::flixel::util::FlxBitmapDataPool_obj::_rect->x = ( (Float)(0) );
HXLINE(  71)				::flixel::util::FlxBitmapDataPool_obj::_rect->y = ( (Float)(0) );
HXLINE(  72)				::flixel::util::FlxBitmapDataPool_obj::_rect->width = ( (Float)(w) );
HXLINE(  73)				::flixel::util::FlxBitmapDataPool_obj::_rect->height = ( (Float)(h) );
HXLINE(  74)				res->fillRect(::flixel::util::FlxBitmapDataPool_obj::_rect,( (int)(fillColor) ));
            			}
            		}
            		else {
HXLINE(  79)			int res1;
HXDLIN(  79)			if (hx::IsNotNull( fillColor )) {
HXLINE(  79)				res1 = ( (int)(fillColor) );
            			}
            			else {
HXLINE(  79)				res1 = -1;
            			}
...
HXLINE( 130)		::flixel::util::FlxBitmapDataPool_obj::length = 0;
