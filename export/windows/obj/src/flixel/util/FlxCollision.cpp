...
HXDLIN(  67)			Float lengthA = ::Math_obj::sqrt(((this5->x * this5->x) + (this5->y * this5->y)));
...
HXDLIN(  73)			Float lengthB = ::Math_obj::sqrt(((this6->x * this6->x) + (this6->y * this6->y)));
...
HXLINE( 179)					_hx_tmp3 = (alphaB >= AlphaTolerance);
            				}
            				else {
...
HXDLIN( 189)			int _g3 = (overlapPixels >> 1);
HXDLIN( 189)			while((_g2 < _g3)){
HXLINE( 189)				_g2 = (_g2 + 1);
HXDLIN( 189)				int i1 = (_g2 - 1);
HXLINE( 191)				alphaIdx = ((i1 << 3) + 4);
...
HXLINE( 196)					_hx_tmp4 = (alphaB >= AlphaTolerance);
            				}
            				else {
...
HXLINE( 225)		if (!(::flixel::math::FlxMath_obj::pointInCoordinates(( (Float)(PointX) ),( (Float)(PointY) ),( (Float)(_hx_tmp) ),( (Float)(_hx_tmp1) ),( (Float)(_hx_tmp2) ),( (Float)(::Std_obj::_hx_int(Target->get_height())) )))) {
...
HXLINE( 239)		int pixelAlpha = ((::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(test->getPixel32(::Math_obj::floor((( (Float)(PointX) ) - Target->x)),::Math_obj::floor((( (Float)(PointY) ) - Target->y)))) >> 24) & 255);
HXLINE( 241)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 243)			pixelAlpha = ::Std_obj::_hx_int((( (Float)(pixelAlpha) ) * Target->alpha));
            		}
...
HXLINE( 268)			left =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor((Camera->x - ( (Float)(Thickness) ))),::Math_obj::floor((Camera->y + Thickness)),Thickness,(Camera->height - (Thickness * 2)));
HXLINE( 269)			right =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor((Camera->x + Camera->width)),::Math_obj::floor((Camera->y + Thickness)),Thickness,(Camera->height - (Thickness * 2)));
HXLINE( 270)			top =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor((Camera->x - ( (Float)(Thickness) ))),::Math_obj::floor((Camera->y - ( (Float)(Thickness) ))),(Camera->width + (Thickness * 2)),Thickness);
HXLINE( 271)			bottom =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor((Camera->x - ( (Float)(Thickness) ))),Camera->height,(Camera->width + (Thickness * 2)),Thickness);
HXLINE( 273)			if (AdjustWorldBounds) {
HXLINE( 275)				 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 275)				_this->x = (Camera->x - ( (Float)(Thickness) ));
HXDLIN( 275)				_this->y = (Camera->y - ( (Float)(Thickness) ));
HXDLIN( 275)				_this->width = ( (Float)((Camera->width + (Thickness * 2))) );
HXDLIN( 275)				_this->height = ( (Float)((Camera->height + (Thickness * 2))) );
            			}
            		}
            		else {
HXLINE( 280)			left =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor(Camera->x),::Math_obj::floor((Camera->y + Thickness)),Thickness,(Camera->height - (Thickness * 2)));
HXLINE( 281)			right =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,::Math_obj::floor(((Camera->x + Camera->width) - ( (Float)(Thickness) ))),::Math_obj::floor((Camera->y + Thickness)),Thickness,(Camera->height - (Thickness * 2)));
...
HXDLIN( 287)				_this1->width = ( (Float)(Camera->width) );
HXDLIN( 287)				_this1->height = ( (Float)(Camera->height) );
            			}
            		}
