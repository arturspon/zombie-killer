...
HXLINE(  21)		transform->redOffset = ( (Float)(red) );
HXLINE(  22)		transform->greenOffset = ( (Float)(green) );
HXLINE(  23)		transform->blueOffset = ( (Float)(blue) );
HXLINE(  24)		transform->alphaOffset = ( (Float)(alpha) );
...
HXDLIN(  34)		if ((transform->redMultiplier == 1)) {
HXDLIN(  34)			_hx_tmp = (transform->greenMultiplier != 1);
            		}
            		else {
HXDLIN(  34)			_hx_tmp = true;
            		}
HXDLIN(  34)		if (!(_hx_tmp)) {
HXDLIN(  34)			return (transform->blueMultiplier != 1);
            		}
            		else {
...
HXDLIN(  42)			return (transform->alphaMultiplier != 1);
            		}
            		else {
...
HXDLIN(  50)		if ((transform->redOffset == 0)) {
HXDLIN(  50)			_hx_tmp = (transform->greenOffset != 0);
            		}
            		else {
HXDLIN(  50)			_hx_tmp = true;
            		}
HXDLIN(  50)		if (!(_hx_tmp)) {
HXDLIN(  50)			return (transform->blueOffset != 0);
            		}
            		else {
...
HXDLIN(  58)			return (transform->alphaOffset != 0);
            		}
            		else {
