...
HXLINE(  30)		Float rot = (( (Float)(rotation) ) * (::Math_obj::PI / ( (Float)(180) )));
...
HXDLIN(  33)		gradientMatrix->createGradientBox(( (Float)(width) ),(_hx_tmp / _hx_tmp1),rot,0,0);
HXLINE(  36)		::Array< Float > alpha = ::Array_obj< Float >::__new();
HXLINE(  38)		{
HXLINE(  38)			int _g = 0;
HXDLIN(  38)			int _g1 = colors->length;
HXDLIN(  38)			while((_g < _g1)){
HXLINE(  38)				_g = (_g + 1);
HXDLIN(  38)				int ai = (_g - 1);
HXLINE(  40)				alpha->push((( (Float)(((colors->__get(ai) >> 24) & 255)) ) / ( (Float)(255) )));
            			}
            		}
HXLINE(  43)		::Array< int > ratio = ::Array_obj< int >::__new();
HXLINE(  45)		if ((colors->length == 2)) {
HXLINE(  47)			ratio[0] = 0;
HXLINE(  48)			ratio[1] = 255;
            		}
            		else {
HXLINE(  53)			int spread = ::Std_obj::_hx_int((( (Float)(255) ) / ( (Float)((colors->length - 1)) )));
HXLINE(  55)			ratio->push(0);
HXLINE(  57)			{
HXLINE(  57)				int _g2 = 1;
HXDLIN(  57)				int _g3 = (colors->length - 1);
HXDLIN(  57)				while((_g2 < _g3)){
HXLINE(  57)					_g2 = (_g2 + 1);
HXDLIN(  57)					int ri = (_g2 - 1);
HXLINE(  59)					ratio->push((ri * spread));
            				}
            			}
HXLINE(  62)			ratio->push(255);
            		}
...
HXLINE(  74)		{
HXLINE(  74)			int _g = 0;
HXDLIN(  74)			int _g1 = data->height;
HXDLIN(  74)			while((_g < _g1)){
HXLINE(  74)				_g = (_g + 1);
HXDLIN(  74)				int y = (_g - 1);
HXLINE(  76)				result->push(data->getPixel32(0,y));
            			}
            		}
...
HXLINE( 118)			interpolationMethod = 1;
            		}
            		else {
HXLINE( 118)			interpolationMethod = 0;
            		}
HXLINE( 120)		shape->get_graphics()->beginGradientFill(0,colors,( (::Array< Float >)(gradient->__Field(HX_("alpha",5e,a7,96,21),hx::paccDynamic)) ),( (::Array< int >)(gradient->__Field(HX_("ratio",0b,35,24,e4),hx::paccDynamic)) ),( ( ::openfl::geom::Matrix)(gradient->__Field(HX_("matrix",41,36,c8,bb),hx::paccDynamic)) ),0,interpolationMethod,0);
HXLINE( 123)		 ::openfl::display::Graphics _hx_tmp2 = shape->get_graphics();
HXDLIN( 123)		int _hx_int = width;
HXDLIN( 123)		Float _hx_tmp3;
HXDLIN( 123)		if ((_hx_int < 0)) {
...
HXDLIN( 123)		if ((int2 < 0)) {
HXLINE( 123)			_hx_tmp5 = (((Float)4294967296.0) + int2);
            		}
            		else {
HXLINE( 123)			_hx_tmp5 = (int2 + ((Float)0.0));
            		}
HXDLIN( 123)		_hx_tmp2->drawRect(( (Float)(0) ),( (Float)(0) ),_hx_tmp3,(_hx_tmp4 / _hx_tmp5));
HXLINE( 125)		 ::openfl::display::BitmapData data =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,0);
HXLINE( 127)		if ((chunkSize == 1)) {
HXLINE( 129)			data->draw(shape,null(),null(),null(),null(),null());
            		}
            		else {
HXLINE( 133)			int int3 = height;
HXDLIN( 133)			Float tempBitmap;
HXDLIN( 133)			if ((int3 < 0)) {
...
HXDLIN( 133)			if ((int4 < 0)) {
HXLINE( 133)				tempBitmap1 = (((Float)4294967296.0) + int4);
            			}
            			else {
HXLINE( 133)				tempBitmap1 = (int4 + ((Float)0.0));
            			}
HXDLIN( 133)			 ::openfl::display::Bitmap tempBitmap2 =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,::Std_obj::_hx_int((tempBitmap / tempBitmap1)),true,0),null(),null());
...
HXLINE( 209)		 ::openfl::geom::Rectangle _hx_tmp =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,source->width,source->height);
