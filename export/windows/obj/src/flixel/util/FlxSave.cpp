...
HXDLIN( 125)		if (hx::IsEq( result,0 )) {
...
HXLINE( 155)		switch((int)(Result->_hx_getIndex())){
            			case (int)1: {
HXLINE( 158)				::flixel::FlxG_obj::log->advanced(HX_("FlxSave is requesting extra storage space.",65,ed,43,59),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            			}
            			break;
            			case (int)2: {
HXLINE( 160)				::flixel::FlxG_obj::log->advanced(HX_("There was a problem flushing\nthe shared object data from FlxSave.",0d,4e,e5,ad),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            			}
            			break;
            			default:{
            			}
...
HXLINE( 165)			this->_onComplete(hx::IsEq( Result,::flixel::util::FlxSaveStatus_obj::SUCCESS_dyn() ));
            		}
