...
HXLINE( 116)		if ((Loops < 0)) {
HXLINE( 117)			Loops = (Loops * -1);
            		}
HXLINE( 119)		this->loops = Loops;
HXLINE( 120)		this->onComplete = OnComplete;
HXLINE( 121)		this->_timeCounter = ( (Float)(0) );
HXLINE( 122)		this->_loopsCounter = 0;
...
HXDLIN( 209)		if ((this->time > 0)) {
HXDLIN( 209)			return (this->_timeCounter / this->time);
            		}
            		else {
