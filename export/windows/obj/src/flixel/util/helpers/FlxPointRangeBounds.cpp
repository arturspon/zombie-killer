...
HXDLIN(  41)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  41)		point1->_inPool = false;
HXDLIN(  41)		this->start =  ::flixel::util::helpers::FlxBounds_obj::__alloc( HX_CTX ,point,point1);
HXLINE(  42)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  42)		point2->_inPool = false;
HXDLIN(  42)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  63)			_hx_tmp = ( (Float)(startMinY) );
            		}
...
HXLINE(  64)			_hx_tmp1 = ( (Float)(startMaxX) );
            		}
...
HXLINE(  65)			_hx_tmp2 = ( (Float)(startMaxY) );
            		}
...
HXLINE(  66)			_hx_tmp3 = ( (Float)(endMinX) );
            		}
...
HXLINE(  67)			_hx_tmp4 = ( (Float)(endMinY) );
            		}
...
HXLINE(  68)			_hx_tmp5 = ( (Float)(endMaxX) );
            		}
...
HXLINE(  69)			_hx_tmp6 = ( (Float)(endMaxY) );
            		}
...
HXLINE( 106)		this->start->min = ::flixel::util::FlxDestroyUtil_obj::put(this->start->min);
HXLINE( 107)		this->start->max = ::flixel::util::FlxDestroyUtil_obj::put(this->start->max);
HXLINE( 108)		this->end->min = ::flixel::util::FlxDestroyUtil_obj::put(this->end->min);
HXLINE( 109)		this->end->max = ::flixel::util::FlxDestroyUtil_obj::put(this->end->max);
            	}
