...
HX_DEFINE_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_85_new,"haxe.ds.GenericStack_hscript_Token","new",0xda5f4ac8,"haxe.ds.GenericStack_hscript_Token.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",85,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_92_add,"haxe.ds.GenericStack_hscript_Token","add",0xda556c89,"haxe.ds.GenericStack_hscript_Token.add","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",92,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_101_first,"haxe.ds.GenericStack_hscript_Token","first",0x104a5c98,"haxe.ds.GenericStack_hscript_Token.first","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",101,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_109_pop,"haxe.ds.GenericStack_hscript_Token","pop",0xda60d7f9,"haxe.ds.GenericStack_hscript_Token.pop","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",109,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_123_isEmpty,"haxe.ds.GenericStack_hscript_Token","isEmpty",0x0c5cacab,"haxe.ds.GenericStack_hscript_Token.isEmpty","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",123,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_135_remove,"haxe.ds.GenericStack_hscript_Token","remove",0xac2392dc,"haxe.ds.GenericStack_hscript_Token.remove","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",135,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_158_iterator,"haxe.ds.GenericStack_hscript_Token","iterator",0x90d21686,"haxe.ds.GenericStack_hscript_Token.iterator","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",158,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_7be483caf7e3e5a8_184_toString,"haxe.ds.GenericStack_hscript_Token","toString",0x35a69d44,"haxe.ds.GenericStack_hscript_Token.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",184,0x6d04e29d)
namespace haxe{
namespace ds{

void GenericStack_hscript_Token_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_85_new)
            	}
...
void GenericStack_hscript_Token_obj::add( ::hscript::Token item){
            	HX_GC_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_92_add)
HXDLIN(  92)		this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,this->head);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,add,(void))
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::first(){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_101_first)
HXDLIN( 101)		if (hx::IsNull( this->head )) {
HXDLIN( 101)			return null();
            		}
            		else {
HXDLIN( 101)			return this->head->elt;
            		}
HXDLIN( 101)		return null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GenericStack_hscript_Token_obj,first,return )
 ...
 ::hscript::Token GenericStack_hscript_Token_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_109_pop)
HXLINE( 110)		 ::haxe::ds::GenericCell_hscript_Token k = this->head;
HXLINE( 111)		if (hx::IsNull( k )) {
HXLINE( 112)			return null();
            		}
            		else {
HXLINE( 114)			this->head = k->next;
HXLINE( 115)			return k->elt;
            		}
...
bool GenericStack_hscript_Token_obj::isEmpty(){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_123_isEmpty)
HXDLIN( 123)		return hx::IsNull( this->head );
            	}
...
bool GenericStack_hscript_Token_obj::remove( ::hscript::Token v){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_135_remove)
HXLINE( 136)		 ::haxe::ds::GenericCell_hscript_Token prev = null();
HXLINE( 137)		 ::haxe::ds::GenericCell_hscript_Token l = this->head;
HXLINE( 138)		while(hx::IsNotNull( l )){
HXLINE( 139)			if (hx::IsEq( l->elt,v )) {
HXLINE( 140)				if (hx::IsNull( prev )) {
HXLINE( 141)					this->head = l->next;
            				}
            				else {
HXLINE( 143)					prev->next = l->next;
            				}
...
HXLINE( 147)			l = l->next;
            		...
            		_hx_goto_5:;
HXLINE( 149)		return hx::IsNotNull( l );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(GenericStack_hscript_Token_obj,remove,return )
 ...
 ::Dynamic GenericStack_hscript_Token_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_158_iterator)
HXDLIN( 158)		return  ::haxe::ds::_GenericStack::GenericStackIterator_hscript_Token_obj::__alloc( HX_CTX ,this->head);
            	}
...
::String GenericStack_hscript_Token_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_7be483caf7e3e5a8_184_toString)
HXLINE( 185)		::Array< ::Dynamic> a = ::Array_obj< ::Dynamic>::__new();
HXLINE( 186)		 ::haxe::ds::GenericCell_hscript_Token l = this->head;
HXLINE( 187)		while(hx::IsNotNull( l )){
HXLINE( 188)			a->push(l->elt);
HXLINE( 189)			l = l->next;
            		}
HXLINE( 191)		return ((HX_("{",7b,00,00,00) + a->join(HX_(",",2c,00,00,00))) + HX_("}",7d,00,00,00));
            	}
