...
HX_LOCAL_STACK_FRAME(_hx_pos_9db68959bd93ff76_100_pop,"haxe.ds.List","pop",0x82bfb218,"haxe.ds.List.pop","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",100,0xda78f210)
HX_LOCAL_STACK_FRAME(_hx_pos_9db68959bd93ff76_124_clear,"haxe.ds.List","clear",0xf96935d4,"haxe.ds.List.clear","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",124,0xda78f210)
HX_LOCAL_STACK_FRAME(_hx_pos_9db68959bd93ff76_138_remove,"haxe.ds.List","remove",0x3f86961d,"haxe.ds.List.remove","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",138,0xda78f210)
HX_LOCAL_STACK_FRAME(_hx_pos_9db68959bd93ff76_162_iterator,"haxe.ds.List","iterator",0x056d2c07,"haxe.ds.List.iterator","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",162,0xda78f210)
namespace haxe{
namespace ds{
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,add,(void))
 ...
 ::Dynamic List_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_9db68959bd93ff76_100_pop)
...
void List_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_9db68959bd93ff76_124_clear)
...
bool List_obj::remove( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_9db68959bd93ff76_138_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,remove,return )
 ...
 ::haxe::ds::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_9db68959bd93ff76_162_iterator)
