...
HX_DEFINE_STACK_FRAME(_hx_pos_a547912459d988d9_236_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",236,0x9022da28)
namespace haxe{
namespace ds{
...
HXLINE( 237)		this->left = l;
HXLINE( 238)		this->key = k;
HXLINE( 239)		this->value = v;
HXLINE( 240)		this->right = r;
HXLINE( 241)		if ((h == -1)) {
HXLINE( 242)			int _hx_tmp;
HXDLIN( 242)			 ::haxe::ds::TreeNode _this = this->left;
...
HXDLIN( 242)			 ::haxe::ds::TreeNode _this1 = this->right;
...
HXLINE( 242)				 ::haxe::ds::TreeNode _this2 = this->left;
...
HXLINE( 242)				 ::haxe::ds::TreeNode _this3 = this->right;
...
HXDLIN( 242)			this->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 244)			this->_height = h;
            		}
            	}
