...
HX_DEFINE_STACK_FRAME(_hx_pos_b58058c37d2b0776_54_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",54,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_b58058c37d2b0776_51_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",51,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_b58058c37d2b0776_52_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",52,0x6d04e29d)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_STACKFRAME(&_hx_pos_b58058c37d2b0776_54_new)
...
bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_b58058c37d2b0776_51_hasNext)
HXDLIN(  51)		return hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_b58058c37d2b0776_52_next)
HXDLIN(  52)		 ::Dynamic result = this->current->elt;
