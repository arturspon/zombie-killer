...
HX_DEFINE_STACK_FRAME(_hx_pos_9de8feef4ce25038_54_new,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","new",0xbf5d5a94,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",54,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_9de8feef4ce25038_51_hasNext,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","hasNext",0xccb359a1,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",51,0x6d04e29d)
HX_LOCAL_STACK_FRAME(_hx_pos_9de8feef4ce25038_52_next,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token","next",0xb251e83f,"haxe.ds._GenericStack.GenericStackIterator_hscript_Token.next","C:\\HaxeToolkit\\haxe\\std/haxe/ds/GenericStack.hx",52,0x6d04e29d)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_hscript_Token_obj::__construct( ::haxe::ds::GenericCell_hscript_Token head){
            	HX_STACKFRAME(&_hx_pos_9de8feef4ce25038_54_new)
HXDLIN(  54)		this->current = head;
            	}
...
bool GenericStackIterator_hscript_Token_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_9de8feef4ce25038_51_hasNext)
HXDLIN(  51)		return hx::IsNotNull( this->current );
            	}


 ::hscript::Token GenericStackIterator_hscript_Token_obj::next(){
            	HX_STACKFRAME(&_hx_pos_9de8feef4ce25038_52_next)
HXDLIN(  52)		 ::hscript::Token result = this->current->elt;
HXDLIN(  52)		this->current = this->current->next;
HXDLIN(  52)		return result;
            	}
