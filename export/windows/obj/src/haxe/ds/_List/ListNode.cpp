...
HX_DEFINE_STACK_FRAME(_hx_pos_21607b221ac769d1_263_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","C:\\HaxeToolkit\\haxe\\std/haxe/ds/List.hx",263,0xda78f210)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_21607b221ac769d1_263_new)
