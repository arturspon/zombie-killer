...
HX_DEFINE_STACK_FRAME(_hx_pos_bc1e3a125215c6c2_76_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",76,0xbc28dcd7)
HX_LOCAL_STACK_FRAME(_hx_pos_bc1e3a125215c6c2_97_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",97,0xbc28dcd7)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_bc1e3a125215c6c2_76_new)
HXLINE(  77)		this->xml = xml;
HXLINE(  78)		this->message = message;
HXLINE(  79)		this->position = position;
HXLINE(  80)		this->lineNumber = 1;
HXLINE(  81)		this->positionAtLine = 0;
HXLINE(  83)		{
HXLINE(  83)			int _g = 0;
HXDLIN(  83)			int _g1 = position;
HXDLIN(  83)			while((_g < _g1)){
HXLINE(  83)				_g = (_g + 1);
HXDLIN(  83)				int i = (_g - 1);
HXLINE(  85)				int c = xml.cca(i);
HXLINE(  86)				if ((c == 10)) {
HXLINE(  87)					this->lineNumber++;
HXLINE(  88)					this->positionAtLine = 0;
            				}
            				else {
HXLINE(  90)					if ((c != 13)) {
HXLINE(  90)						this->positionAtLine++;
            					}
            				}
            			}
            		}
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_bc1e3a125215c6c2_97_toString)
HXDLIN(  97)		::String _hx_tmp = (::Type_obj::getClassName(::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this))) + HX_(": ",a6,32,00,00));
HXDLIN(  97)		return (((((_hx_tmp + this->message) + HX_(" at line ",df,96,71,22)) + this->lineNumber) + HX_(" char ",6a,28,1f,11)) + this->positionAtLine);
            	}
