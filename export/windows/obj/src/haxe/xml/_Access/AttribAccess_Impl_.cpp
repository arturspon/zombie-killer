...
HX_LOCAL_STACK_FRAME(_hx_pos_7943a11702a17d51_41_resolve,"haxe.xml._Access.AttribAccess_Impl_","resolve",0xf06df4f6,"haxe.xml._Access.AttribAccess_Impl_.resolve","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Access.hx",41,0xd9eced32)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_7943a11702a17d51_41_resolve)
HXLINE(  42)		if ((this1->nodeType == ::Xml_obj::Document)) {
HXLINE(  43)			HX_STACK_DO_THROW((HX_("Cannot access document attribute ",ca,30,fe,c0) + name));
            		}
HXLINE(  44)		::String v = this1->get(name);
HXLINE(  45)		if (hx::IsNull( v )) {
HXLINE(  46)			if ((this1->nodeType != ::Xml_obj::Element)) {
HXLINE(  46)				HX_STACK_DO_THROW((HX_("Bad node type, expected Element but found ",d8,90,8b,bb) + this1->nodeType));
            			}
HXDLIN(  46)			HX_STACK_DO_THROW(((this1->nodeName + HX_(" is missing attribute ",54,31,39,75)) + name));
            		}
HXLINE(  47)		return v;
            	}
