...
HX_LOCAL_STACK_FRAME(_hx_pos_3fd8a350ddd9293e_63_resolve,"haxe.xml._Access.HasAttribAccess_Impl_","resolve",0x7da9559c,"haxe.xml._Access.HasAttribAccess_Impl_.resolve","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Access.hx",63,0xd9eced32)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasAttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_3fd8a350ddd9293e_63_resolve)
HXLINE(  64)		if ((this1->nodeType == ::Xml_obj::Document)) {
HXLINE(  65)			HX_STACK_DO_THROW((HX_("Cannot access document attribute ",ca,30,fe,c0) + name));
            		}
