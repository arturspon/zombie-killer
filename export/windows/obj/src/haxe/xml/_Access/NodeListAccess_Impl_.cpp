...
HX_LOCAL_STACK_FRAME(_hx_pos_06d539aa63d14cc6_83_resolve,"haxe.xml._Access.NodeListAccess_Impl_","resolve",0x07a0eeac,"haxe.xml._Access.NodeListAccess_Impl_.resolve","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Access.hx",83,0xd9eced32)
namespace haxe{
namespace xml{
namespace _Access{
...
::Array< ::Dynamic> NodeListAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_06d539aa63d14cc6_83_resolve)
HXLINE(  84)		::Array< ::Dynamic> l = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  85)		{
HXLINE(  85)			 ::Dynamic x = this1->elementsNamed(name);
HXDLIN(  85)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  85)				 ::Xml x1 = ( ( ::Xml)(x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  86)				bool _hx_tmp;
HXDLIN(  86)				if ((x1->nodeType != ::Xml_obj::Document)) {
HXLINE(  86)					_hx_tmp = (x1->nodeType != ::Xml_obj::Element);
            				}
            				else {
HXLINE(  86)					_hx_tmp = false;
            				}
HXDLIN(  86)				if (_hx_tmp) {
HXLINE(  86)					HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + x1->nodeType));
            				}
HXDLIN(  86)				 ::Xml this2 = x1;
HXDLIN(  86)				l->push(this2);
            			}
            		}
HXLINE(  87)		return l;
            	}
