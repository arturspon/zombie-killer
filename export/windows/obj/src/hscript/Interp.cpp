...
HXDLIN(  90)			return (( (Float)(_hx_tmp1) ) - ( (Float)(me->expr(e21)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  91)			return (( (Float)(_hx_tmp2) ) * ( (Float)(me->expr(e22)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  99)			return hx::UShr(( (int)(_hx_tmp10) ),( (int)(me->expr(e210)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 109)			return  ::IntIterator_obj::__alloc( HX_CTX ,( (int)(_hx_tmp17) ),( (int)(me->expr(e219)) ));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 125)		switch((int)(e1->_hx_getIndex())){
            			case (int)1: {
HXLINE( 126)				::String id = e1->_hx_getString(0);
HXDLIN( 126)				{
HXLINE( 127)					 ::Dynamic l = this->locals->get(id);
HXLINE( 128)					if (hx::IsNull( l )) {
HXLINE( 129)						this->variables->set(id,v);
            					}
            					else {
...
HXLINE( 138)						::haxe::IMap_obj::set( hx::interface_check(arr,0x09c2bd39),index1,v);
            					}
            					else {
...
HXLINE( 173)						 ::Dynamic v3 = ::haxe::IMap_obj::get( hx::interface_check(arr,0x09c2bd39),index1);
HXDLIN( 173)						v = fop(v3,this->expr(e2));
HXLINE( 174)						::haxe::IMap_obj::set( hx::interface_check(arr,0x09c2bd39),index1,v);
            					}
            					else {
...
HXDLIN( 191)		switch((int)(e->_hx_getIndex())){
            			case (int)1: {
...
HXLINE( 194)					v = this->variables->get(id);
            				}
            				else {
...
HXLINE( 197)						this->variables->set(id,v);
            					}
            					else {
...
HXLINE( 199)						this->variables->set(id,(v + delta));
            					}
            					else {
...
HXLINE( 214)					int v2 = ( (int)(::haxe::IMap_obj::get( hx::interface_check(arr,0x09c2bd39),index1)) );
HXLINE( 215)					if (prefix) {
HXLINE( 216)						v2 = (v2 + delta);
HXLINE( 217)						::haxe::IMap_obj::set( hx::interface_check(arr,0x09c2bd39),index1,v2);
            					}
            					else {
HXLINE( 220)						::haxe::IMap_obj::set( hx::interface_check(arr,0x09c2bd39),index1,(v2 + delta));
            					}
...
HXDLIN( 285)		if (rethrow) {
HXDLIN( 285)			HX_STACK_DO_THROW(e);
            		}
            		else {
HXDLIN( 285)			HX_STACK_DO_THROW(e);
            		}
...
HXDLIN( 307)		 ::hscript::Interp _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 312)		switch((int)(e->_hx_getIndex())){
            			case (int)0: {
HXLINE( 313)				 ::hscript::Const c = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 314)				switch((int)(c->_hx_getIndex())){
            					case (int)0: {
...
HXDLIN( 326)					( ( ::haxe::ds::StringMap)(this1) )->set(n, ::Dynamic(hx::Anon_obj::Create(1)
...
HXLINE( 340)				 ::Dynamic fop = this->binops->get(op);
...
HXLINE( 350)					return this->increment(e6,prefix,1);
...
HXLINE( 352)					return this->increment(e6,prefix,-1);
...
HXLINE( 367)				if ((e8->_hx_getIndex() == 5)) {
...
HXLINE( 412)						int pos = 0;
HXLINE( 413)						{
HXLINE( 413)							int _g11 = 0;
HXDLIN( 413)							while((_g11 < params1->length)){
HXLINE( 413)								 ::Dynamic p2 = params1->__get(_g11);
HXDLIN( 413)								_g11 = (_g11 + 1);
HXLINE( 414)								if (( (bool)(p2->__Field(HX_("opt",33,9c,54,00),hx::paccDynamic)) )) {
HXLINE( 415)									if ((extraParams > 0)) {
HXLINE( 416)										pos = (pos + 1);
HXDLIN( 416)										args2->push(args1->__get((pos - 1)));
HXLINE( 417)										extraParams = (extraParams - 1);
            									}
            									else {
...
HXLINE( 421)									pos = (pos + 1);
HXDLIN( 421)									args2->push(args1->__get((pos - 1)));
            								}
            							}
            						}
...
HXDLIN( 427)						int _g21 = params1->length;
HXDLIN( 427)						while((_g12 < _g21)){
HXLINE( 427)							_g12 = (_g12 + 1);
HXDLIN( 427)							int i = (_g12 - 1);
HXLINE( 428)							me->locals->set(( (::String)(params1->__get(i)->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)) ), ::Dynamic(hx::Anon_obj::Create(1)
...
HXLINE( 401)							minParams = (minParams + 1);
            						}
            					}
            				}
...
HXLINE( 450)					if ((this->depth == 0)) {
HXLINE( 452)						this->variables->set(name,f4);
            					}
            					else {
HXLINE( 455)						::Array< ::Dynamic> _hx_tmp1 = this->declared;
HXDLIN( 455)						 ::Dynamic _hx_tmp2 = this->locals->get(name);
...
HXLINE( 457)						this->locals->set(name,ref);
...
HXLINE( 508)					return ::haxe::IMap_obj::get( hx::interface_check(arr,0x09c2bd39),index1);
            				}
            				else {
...
HXDLIN( 463)				if ((arr1->length > 0)) {
HXLINE( 463)					 ::hscript::Expr _g3 = arr1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)					bool _hx_tmp5;
HXDLIN( 463)					if ((_g3->_hx_getIndex() == 6)) {
HXLINE( 463)						_hx_tmp5 = (_g3->_hx_getString(0) == HX_("=>",61,35,00,00));
            					}
            					else {
HXLINE( 463)						_hx_tmp5 = false;
            					}
...
HXDLIN( 470)						while((_g13 < arr1->length)){
HXLINE( 470)							 ::hscript::Expr e18 = arr1->__get(_g13).StaticCast<  ::hscript::Expr >();
HXDLIN( 470)							_g13 = (_g13 + 1);
HXLINE( 471)							bool _hx_tmp6;
HXDLIN( 471)							if ((e18->_hx_getIndex() == 6)) {
HXLINE( 471)								_hx_tmp6 = (e18->_hx_getString(0) == HX_("=>",61,35,00,00));
            							}
            							else {
HXLINE( 471)								_hx_tmp6 = false;
            							}
...
HXLINE( 492)					{
HXLINE( 492)						int _g22 = 0;
HXDLIN( 492)						int _g31 = keys->get_length();
HXDLIN( 492)						while((_g22 < _g31)){
HXLINE( 492)							_g22 = (_g22 + 1);
HXDLIN( 492)							int n1 = (_g22 - 1);
HXLINE( 493)							::haxe::IMap_obj::set( hx::interface_check(map,0x09c2bd39),keys->__get(n1),values->__get(n1));
            						}
            					}
...
HXDLIN( 515)					while((_g4 < params2->length)){
HXLINE( 515)						 ::hscript::Expr e20 = params2->__get(_g4).StaticCast<  ::hscript::Expr >();
HXDLIN( 515)						_g4 = (_g4 + 1);
...
HXLINE( 537)						::Array< ::Dynamic> _hx_tmp7 = this->declared;
HXDLIN( 537)						_hx_tmp7->push( ::Dynamic(hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("n",6e,00,00,00),n2)
            							->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n2))));
HXLINE( 538)						this->locals->set(n2, ::Dynamic(hx::Anon_obj::Create(1)
...
HXLINE( 545)				{
HXLINE( 545)					int _g5 = 0;
HXDLIN( 545)					while((_g5 < fl->length)){
HXLINE( 545)						 ::Dynamic f5 = fl->__get(_g5);
HXDLIN( 545)						_g5 = (_g5 + 1);
...
HXLINE( 553)				{
HXLINE( 553)					int _g6 = 0;
HXDLIN( 553)					while((_g6 < cases->length)){
HXLINE( 553)						 ::Dynamic c1 = cases->__get(_g6);
HXDLIN( 553)						_g6 = (_g6 + 1);
HXLINE( 554)						{
HXLINE( 554)							int _g7 = 0;
HXDLIN( 554)							::Array< ::Dynamic> _g15 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) );
HXDLIN( 554)							while((_g7 < _g15->length)){
HXLINE( 554)								 ::hscript::Expr v5 = _g15->__get(_g7).StaticCast<  ::hscript::Expr >();
HXDLIN( 554)								_g7 = (_g7 + 1);
...
HXLINE( 579)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 581)					switch((int)(err->_hx_getIndex())){
            						case (int)0: {
...
HXLINE( 596)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 598)					switch((int)(err->_hx_getIndex())){
            						case (int)0: {
...
HXDLIN( 614)		if (hx::IsNotNull( v->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic) )) {
HXLINE( 614)			_hx_tmp = hx::IsNull( v->__Field(HX_("next",f3,84,02,49),hx::paccDynamic) );
            		}
            		else {
...
HXLINE( 625)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 627)					switch((int)(err->_hx_getIndex())){
            						case (int)0: {
...
HXDLIN( 638)		return ::Std_obj::is(o,hx::ClassOf< ::haxe::IMap >());
            	}
...
HXDLIN( 642)		return ::haxe::IMap_obj::get( hx::interface_check(map,0x09c2bd39),key);
            	}
...
HXDLIN( 646)		::haxe::IMap_obj::set( hx::interface_check(map,0x09c2bd39),key,value);
            	}
...
HXDLIN( 672)		return this->call(o,this->get(o,f),args);
            	}
...
HXDLIN( 676)		return ::Reflect_obj::callMethod(o,f,args);
            	}
