...
HXDLIN(  54)								while((_g6 < _g11->length)){
HXLINE(  54)									 ::hscript::Expr v = _g11->__get(_g6).StaticCast<  ::hscript::Expr >();
HXDLIN(  54)									_g6 = (_g6 + 1);
HXDLIN(  54)									f(v);
            								}
            							}
...
HXLINE(  58)						int _g7 = 0;
HXDLIN(  58)						while((_g7 < args1->length)){
HXLINE(  58)							 ::hscript::Expr a1 = args1->__get(_g7).StaticCast<  ::hscript::Expr >();
HXDLIN(  58)							_g7 = (_g7 + 1);
HXDLIN(  58)							f(a1);
            						}
            					}
