...
HX_DEFINE_STACK_FRAME(_hx_pos_85b2380ad7974f28_34_new,"sys.thread.Thread","new",0x1beab85f,"sys.thread.Thread.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",34,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_85b2380ad7974f28_54___compare,"sys.thread.Thread","__compare",0x3ed6dac4,"sys.thread.Thread.__compare","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",54,0x5ec2eeb7)
HX_LOCAL_STACK_FRAME(_hx_pos_85b2380ad7974f28_46_create,"sys.thread.Thread","create",0x9b10485d,"sys.thread.Thread.create","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Thread.hx",46,0x5ec2eeb7)
namespace sys{
namespace thread{

void Thread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_85b2380ad7974f28_34_new)
...
int Thread_obj::__compare( ::sys::thread::Thread t){
            	HX_STACKFRAME(&_hx_pos_85b2380ad7974f28_54___compare)
...
HX_DEFINE_DYNAMIC_FUNC1(Thread_obj,__compare,return )
 ...
 ::sys::thread::Thread Thread_obj::create( ::Dynamic callb){
            	HX_GC_STACKFRAME(&_hx_pos_85b2380ad7974f28_46_create)
